<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Category.aspx.vb" Inherits="eAdmin.Category"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table class="alltable" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD class="header" colSpan="5"><FONT size="1"><asp:label id="lblTitle" runat="server" CssClass="header"></asp:label></FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="tablecol" noWrap width="5%">&nbsp;<STRONG>UNSPSC Code (Segment)</STRONG>&nbsp;:</TD>
					<TD class="tablecol" noWrap width="15%"><asp:textbox id="txtItemId" runat="server" CssClass="txtbox" Width="100px"></asp:textbox></TD>
					<TD class="tablecol" noWrap width="5%">&nbsp;<STRONG>UNSPSC Description</STRONG>&nbsp;:</TD>
				...
				<TR>
					<TD class="emptycol" colSpan="5">&nbsp;You can either search by UNSPSC Code or any 
				...
				<tr>
					<td colSpan="5"><iewc:treeview id="tvCategory" runat="server" DefaultStyle="font-size: 8pt;font-family: Verdana;background:white;color:black"
							HoverStyle="background:transparent;color:black;font-weight:bold" SelectedStyle="background:white;color:black;font-weight:bold" autopostback="true" ShowToolTip="False"></iewc:treeview></td>
				</tr>
				<TR>
