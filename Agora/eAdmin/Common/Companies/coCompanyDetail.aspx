<%@ Page Language="vb" AutoEventWireup="false" Codebehind="coCompanyDetail.aspx.vb" Inherits="eAdmin.coCompanyDetail" %>
				...
				<TR>
					<TD>
						<TABLE class="alltable" id="Table9" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="tablecol" style="HEIGHT: 18px" width="200">&nbsp;<STRONG>Resident Type&nbsp;</STRONG>:</TD>
								<TD class="tablecol" style="HEIGHT: 24px">&nbsp;<asp:dropdownlist id="ddlResident" CssClass="ddl" Width="120px" Runat="server">
										<asp:ListItem Value="Y">Resident</asp:ListItem>
										<asp:ListItem Value="N">Non-Resident</asp:ListItem>
									</asp:dropdownlist>
									<asp:textbox id="Textbox1" style="DISPLAY: none" runat="server"></asp:textbox></TD>
							</TR>
							<%--End--%>
				...
				<TR>
					<TD>
						<TABLE class="alltable" id="Table11" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="tablecol" style="HEIGHT: 18px">&nbsp;<STRONG>SST Registration No. </STRONG>:</TD>
