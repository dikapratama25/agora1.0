...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objAdm.getTaxCodeInfo(txtTaxCode.Text)
    ...
    Private Sub cmd_clear_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdClear.Click
        ...
        Else
            ...
            ddlAddCountry.SelectedValue = ViewState("oldCountry")
        End If
    ...
    Sub view(ByVal selected As String)
        ...
        If selected = "add" Then
            Me.lbl_add_mod.Text = "add"
            intmsgno = objAdm.AddTaxCodeInfo(txtAddTaxCode.Text, txtAddDesc.Text, ddlAddCountry.SelectedValue, ddlAddTaxType.SelectedValue, ddlAddRate.SelectedValue, "add")
        ElseIf selected = "mod" Then
            Me.lbl_add_mod.Text = "modify"
            intmsgno = objAdm.AddTaxCodeInfo(txtAddTaxCode.Text, txtAddDesc.Text, ddlAddCountry.SelectedValue, ddlAddTaxType.SelectedValue, ddlAddRate.SelectedValue, "mod", hidIndex.Value)
        End If
    ...
    Private Sub cmdModify_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdModify.Click
        ...
        For Each dgItem In dtgTax.Items
            ...
            If chk.Checked Then
                ...
                ddlAddCountry.SelectedValue = dgItem.Cells(EnumTax.icCountryCode).Text
                ...
                ViewState("oldCountry") = dgItem.Cells(EnumTax.icCountryCode).Text
    ...
    Private Sub cmdDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        intMsg = objAdmin.delTaxCodeInfo(dtNewTax)
        If intMsg = -99 Then
