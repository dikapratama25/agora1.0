<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MenuAdd.aspx.vb" Inherits="eAdmin.MenuAdd" %>
	...
	<BODY MS_POSITIONING="GridLayout">
		...
		<%Response.Write(Session("MenuAdd_tabs"))%>
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0">
				<TR>
					<TD class="header">Menu Details&nbsp;Maintenance</TD>
				</TR>
				<TR>
					<TD align="center">
						<div align="left"><asp:label id="lblAction" runat="server"  CssClass="lblInfo"
						Text="<b>=></b> Step 1: Add a new module.<br>Step 2: Add a new node under a module.<br>Step 3: Assign menu access right to a fixed role."
						></asp:label>
                        </div>
					</TD>
				</TR>
				...
				<tr class="tablecol">
					<TD width="160"><STRONG>&nbsp;Menu&nbsp;ID</STRONG><span class="errorMsg">*</span>&nbsp; 
						:</TD>
					<TD width="160"><asp:textbox id="txtMenuId" runat="server" Enabled="False" CssClass="txtbox" MaxLength="30"
				...
				<tr class="tablecol">
					...
					<td></td>
					<%--TD style="HEIGHT: 2px"><asp:requiredfieldvalidator id="rfv_txtMenuImg" runat="server" ControlToValidate="txtMenuImg" ErrorMessage="Image is required"
							Display="None"></asp:requiredfieldvalidator></TD--%>
			...
			<div id="tblButton" runat="server">
				<table class="alltable" id="tbltable4" cellSpacing="0" cellPadding="0" border="0">
					<TR>
						<TD colSpan="2"><asp:button id="cmdSave" runat="server" CssClass="button" Text="Save"></asp:button>&nbsp;
						<asp:button id="cmdDelete" runat="server" CssClass="button" Text="Delete" CausesValidation="False"></asp:button>&nbsp;<INPUT class="button" id="cmdReset" type="button" value="Clear" name="cmdReset" runat="server"></TD>
					</TR>
				</table>
			</div>
