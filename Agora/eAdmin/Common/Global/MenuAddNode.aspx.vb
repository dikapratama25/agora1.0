...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents ddlMenuParent As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                txtMenuImg.Enabled = False
                lblAction.Text = "Edit node details and click save"
        ...
        Else
            ...
            intLastParent = Val(ddlMenuParent.SelectedValue)
            intLastLvl = objMenu.GetLastLevel(intLastParent)
            txtMenuLevel.Text = intLastParent & "," & (intLastLvl + 1)
        ...
        If ViewState("Mode") = "add" Then
            Session("MenuAdd_tabs") = "<div class=""t_entity""><ul>" & _
                      "<li><div class=""space""></div></li>" & _
                                           ...
                                           "<li><div class=""space""></div></li>" & _
                                          "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("Global", "MenuAddNode.aspx", "mode=add") & """><span>Add New Node</span></a></li>" & _
                                           "<li><div class=""space""></div></li>" & _
    ...
    Sub Populate()
        ...
        objMS.FillParent(ddlMenuParent, ConfigurationSettings.AppSettings("eProcurePath"))
    ...
    Private Sub UpdateMenu()
        ...
        dtr("MenuParent") = ddlMenuParent.Text
        dtr("MenuURL") = txtMenuURL.Text
        dtr("MenuImgExp") = "" 'DBNull.Value
        dtr("MenuTips") = "" 'DBNull.Value
        dtr("MenuGroup") = "ehub"
        dtr("MenuTarget") = "body"
        dtr("MenuLastNode") = "" 'DBNull.Value
        dtr("MenuIdx") = ddlMenuParent.Text
