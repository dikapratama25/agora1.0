...
jQuery.extend({
	...
	makeArray: function( array ) {
		...
		if( array != null ){
			var i = array.length;
			//the window, strings and  also have 'length'
...
/*
 * A number of helper  used for managing events.
...
jQuery.event = {
	...
	add: function(elem, types, handler, data) {
		...
		jQuery.each(types.split(/\s+/), function(index, type) {
			...
			// Get the current list of  bound to this event
	...
	trigger: function(type, data, elem, donative, extra) {
		...
		// Handle triggering a single element
			...
			// Extra  don't get the custom event object
			if ( event )
				data.shift();
...
jQuery.fn.extend({
	...
	toggle: function( fn ) {
		...
		// link all the   so any of them can unbind this click handler
		while( i < args.length )
...
// Attach a bunch of  for handling common AJAX events
