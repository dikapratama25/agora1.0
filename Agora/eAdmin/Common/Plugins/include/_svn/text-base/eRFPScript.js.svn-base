...
<!--
	...
	function validateUploadFile(fileType, fle) {
		...
		if (strFile != '')	{							
			...
			switch (fileType) {
				case 'doc':
					if ((ch=="doc") || (ch=="xls") || (ch=="zip") || (ch=="pdf") || (ch=="txt") || (ch=="rtf")) {
						return true;
					} else {
						return false;
					}
				...
				case 'img':
					...
					break;
				case '':
					if ((ch=="doc") || (ch=="xls") || (ch=="zip") || (ch=="pdf") || (ch=="txt") || (ch=="rtf") || (ch=="gif") || (ch=="jpg") || (ch=="jpeg")) {
						return true;
					} else {
						return false;
					}
