	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD class="tablecol" width="20%" nowrap><asp:label id="Label3" runat="server">&nbsp;<STRONG>Department/Branch
							</STRONG>:
						</asp:label>&nbsp;</TD>
					<TD class="TableInput" width="80%">
						<asp:RadioButton id="optCom" runat="server" Text="All  Dept/Branch" GroupName="optComVen" AutoPostBack="True"></asp:RadioButton>
						<asp:RadioButton id="optSelectOne" runat="server" Text=" " GroupName="optComVen" AutoPostBack="True"></asp:RadioButton>
						<asp:dropdownlist id="cboCompany" runat="server" Width="376px" CssClass="txtbox"></asp:dropdownlist>
					</TD>
				</TR>
				</TR>
				<TR>
					<TD class="tablecol" width="20%" nowrap style="HEIGHT: 1px">&nbsp;<STRONG>Month</STRONG><asp:label id="Label4" runat="server" CssClass="errormsg">*</asp:label><STRONG>&nbsp;</STRONG>:<STRONG>
						</STRONG>
					</TD>
					<TD class="TableInput" width="80%" style="HEIGHT: 1px">&nbsp;
