...
Public Class UserInforModificationLog_051017
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "UserInforModificationLog-051017.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUserInforModificationLog_051017
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UserInforModificationLog_051017 = New UserInforModificationLog_051017
        rpt.Site = Me.Site
        Return rpt
    End Function
