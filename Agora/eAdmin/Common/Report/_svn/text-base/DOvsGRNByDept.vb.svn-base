...
Public Class DOvsGRNByDept
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_doVsGrnDayParam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDOvsGRNByDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DOvsGRNByDept = New DOvsGRNByDept
        rpt.Site = Me.Site
        Return rpt
    End Function
