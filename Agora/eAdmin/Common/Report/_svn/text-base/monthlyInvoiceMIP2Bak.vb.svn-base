...
Public Class monthlyInvoiceMIP2Bak
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "monthlyInvoiceMIP2Bak.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmonthlyInvoiceMIP2Bak
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As monthlyInvoiceMIP2Bak = New monthlyInvoiceMIP2Bak
        rpt.Site = Me.Site
        Return rpt
    End Function
