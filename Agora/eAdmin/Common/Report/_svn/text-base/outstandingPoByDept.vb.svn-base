...
Public Class outstandingPoByDept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "outstandingPoByDept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedoutstandingPoByDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outstandingPoByDept = New outstandingPoByDept
        rpt.Site = Me.Site
        Return rpt
    End Function
