...
Public Class pmeExpensesDetail2
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_companyIDParam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedpmeExpensesDetail2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pmeExpensesDetail2 = New pmeExpensesDetail2
        rpt.Site = Me.Site
        Return rpt
    End Function
