...
Public Class outstandInvoiceByDept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "outstandInvoiceByDept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedoutstandInvoiceByDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outstandInvoiceByDept = New outstandInvoiceByDept
        rpt.Site = Me.Site
        Return rpt
    End Function
