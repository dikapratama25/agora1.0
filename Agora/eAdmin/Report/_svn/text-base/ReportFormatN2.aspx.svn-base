<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportFormatN2.aspx.vb" Inherits="eAdmin.ReportFormatN2" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					...
					<TD class="TableInput" style="HEIGHT: 17px" colSpan="1">&nbsp;<asp:dropdownlist id="cboReportType" runat="server" CssClass="txtbox" Width="128px">
