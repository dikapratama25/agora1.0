...
Public Class UserInforModificationLog
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "UserInforModificationLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUserInforModificationLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UserInforModificationLog = New UserInforModificationLog
        rpt.Site = Me.Site
        Return rpt
    End Function
