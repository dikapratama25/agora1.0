...
Public Class outstandPOFrSupplSeh2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "outstandPOFrSupplSeh2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedoutstandPOFrSupplSeh2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outstandPOFrSupplSeh2 = New outstandPOFrSupplSeh2
        rpt.Site = Me.Site
        Return rpt
    End Function
