...
Public Class userDetailModificationAudit_051017
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "userDetailModificationAudit-051017.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_companyUserParam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CacheduserDetailModificationAudit_051017
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As userDetailModificationAudit_051017 = New userDetailModificationAudit_051017
        rpt.Site = Me.Site
        Return rpt
    End Function
