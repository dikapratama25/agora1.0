...
Public Class perfectOrderFulfillment
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "perfectOrderFulfillment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_perfectDays() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedperfectOrderFulfillment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As perfectOrderFulfillment = New perfectOrderFulfillment
        rpt.Site = Me.Site
        Return rpt
    End Function
