<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ApprovedVendor.aspx.vb" Inherits="eProcure.ApprovedVendor" %>
				...
				<tr>
					<td><asp:datagrid id="dtgVDetail" runat="server" AutoGenerateColumns="False" AllowSorting="True" OnSortCommand="SortVendorDetail_Click">
							<Columns>
								...
								<asp:BoundColumn DataField="CM_TAX_REG_NO" SortExpression="CM_TAX_REG_NO" HeaderText="SST Registration No.">
									<HeaderStyle Width="8%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:TemplateColumn SortExpression="CV_GST_RATE" HeaderText="SST Rate">
									<HeaderStyle Width="8%"></HeaderStyle>
									<ItemTemplate>
								...
								<asp:TemplateColumn SortExpression="CV_GST_TAX_CODE" HeaderText="SST Tax Code (Purchase)">
									<HeaderStyle Width="8%"></HeaderStyle>
									<ItemTemplate>
