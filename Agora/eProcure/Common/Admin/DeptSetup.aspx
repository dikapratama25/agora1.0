<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DeptSetup.aspx.vb" Inherits="eProcure.DeptSetup" %>
					...
					<TD><asp:datagrid id="dtgDept" runat="server" OnSortCommand="SortCommand_Click" DataKeyField="CDM_DEPT_INDEX">
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="CDM_APPROVAL_GRP_INDEX" SortExpression="CDM_APPROVAL_GRP_INDEX"
									HeaderText="Approval Group"></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="Approval Group(Resident)" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblResidentGroups" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Approval Group (Non Resident)" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNonResidentGroups" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateColumn>

								<%--<asp:BoundColumn Visible="False" DataField="CDM_IPP_APPROVAL_GRP_INDEX" SortExpression="CDM_IPP_APPROVAL_GRP_INDEX"
									HeaderText="IPP Approval Index"></asp:BoundColumn>--%>																
							</Columns>
						</asp:datagrid></TD>
				</TR>
				<TR>
