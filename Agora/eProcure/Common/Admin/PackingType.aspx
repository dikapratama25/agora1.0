<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PackingType.aspx.vb" Inherits="eProcure.PackingType" %>
...
<html>
	<head>
		...
		function selectAll()
		{
			SelectAllG("dtgPack_ctl02_chkAll","chkSelection");
		}
				
		function checkChild(id)
		{
			checkChildG(id,"dtgPack_ctl02_chkAll","chkSelection");
		}
		...
		<form id="Form1" method="post" runat="server">
			...
			<tr>
			    <td class="tablecol">
					    ...
					    <asp:dropdownlist id="ddl_Select" runat="server" Width="170px" style="margin-bottom:1px;" CssClass="ddl" AutoPostBack="true" >
							...
							<asp:ListItem Value="2" Selected="True">Packing Type</asp:ListItem>
			...
			<tr>
				<td >
					...
					Text="Fill in the search criteria and click Search button to list the relevant packing type. Click the Add button to add new packing type."></asp:label>
				...
				<tr>
					<td class="header" colspan="3" width="100%"></td>
							...
							<tr class="tablecol" id="trGrpType" runat="server">
								<td class="tablecol" width="12%">&nbsp;<strong>Packing Code </strong>:</td>
								<td class="tablecol" width="20%"><asp:textbox id="textPackCode" runat="server" MaxLength="10" CssClass="txtbox" width="150px" ></asp:textbox></td>							
								<td class="tablecol" width="12%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Packing Name </strong>:</td>
								<td class="tablecol" width="20%" ><asp:textbox id="textPackName" runat="server" MaxLength="50" CssClass="txtbox" width="150px" ></asp:textbox></td>
			...
			<div id="Hide_Add2" style="DISPLAY: none" runat="server">
				<table class="alltable" id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
					...
					<tr class="tablecol">
						<td width="12%" style="height: 24px">&nbsp;<strong>Packing Code</strong><asp:label id="Label1" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:</td>
						<td width="20%" style="height: 24px"><asp:textbox id="txt_add_PackCode" runat="server" MaxLength="10" width="150px" CssClass="txtbox"></asp:textbox></td>
						<td width="12%" style="height: 24px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Packing Name</strong><asp:label id="Label2" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:</td>
						<td width="20%" style="height: 24px"><asp:textbox id="txt_add_PackName" runat="server" MaxLength="50" width="150px" CssClass="txtbox"></asp:textbox></td>
						<td align="right">	
					...
					<tr>
						<td colspan="3" class="emptycol" style="height: 19px"><asp:label id="Label3" runat="server" CssClass="errormsg">*</asp:label>&nbsp;indicates 
							required field<asp:requiredfieldvalidator id="validate_Pack_code" runat="server" ControlToValidate="txt_add_PackCode" ErrorMessage="Packing Code is required."
								Display="None"></asp:requiredfieldvalidator><asp:requiredfieldvalidator id="validate_Pack_name" runat="server" ControlToValidate="txt_add_PackName" ErrorMessage="Packing Name is required."
			...
			<table class="alltable" id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="emptycol" style="width: 1192px">
						<p><asp:datagrid id="dtgPack" runat="server" OnPageIndexChanged="dtgPack_Page" AllowSorting="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="CPT_PACK_CODE" SortExpression="CPT_PACK_CODE"  readonly="True"  HeaderText="Packing Code">
										<HeaderStyle Width="35%"></HeaderStyle>
									</asp:BoundColumn>	
									<asp:BoundColumn Visible="False" DataField="CPT_PACK_INDEX"></asp:BoundColumn>
									<asp:BoundColumn Visible="False" DataField="CPT_COY_ID"></asp:BoundColumn>
									<asp:BoundColumn DataField="CPT_PACK_NAME" HeaderText="Packing Name" SortExpression="CPT_PACK_NAME">
										<HeaderStyle Width="35%"></HeaderStyle>
									</asp:BoundColumn>							
								</Columns>
							</asp:datagrid></p>
