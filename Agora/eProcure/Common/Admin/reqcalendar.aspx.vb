    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not (Page.IsPostBack) Then
            ...
            For ii_ddl = 0 To jj_ddl
                ddl_month.Items.Insert(ii_ddl, New ListItem(ii_ddl))
            Next
            ddl_year.SelectedItem.Text = Now.Year
            ddl_month.SelectedItem.Text = Now.Month
        End If

        Me.Calendar1.TodaysDate = " " & DateTime.Now.Day & " & / & " & ddl_month.SelectedItem.Text & " & /&" & ddl_year.SelectedItem.Text & ""
