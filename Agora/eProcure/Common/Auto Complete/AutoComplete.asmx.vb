...
Public Class AutoComplete
    ...
    <WebMethod()> _
    Public Function GetVendor(ByVal prefixText As String, _
                                  ByVal count As Integer) As String()

        Dim objDb As New EAD.DBCom(ConfigurationManager.AppSettings("eProcurePath"))
        Dim tDS As DataSet = objDb.FillDs("SELECT CM_COY_NAME FROM company_mstr, Company_Vendor WHERE CM_COY_NAME LIKE '%" & prefixText & "%' AND CV_S_COY_ID=CM_COY_ID and CV_B_COY_ID='" & HttpContext.Current.Session("CompanyId") & "' AND CM_STATUS = 'A' ")
