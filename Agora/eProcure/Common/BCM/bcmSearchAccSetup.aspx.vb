...
Public Class bcmSearchAccSetup
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        If intPageRecordCnt > 0 Then
            resetDatagridPageIndex(dgDept, dvViewDept)
        ...
        viewstate("PageCount") = dgDept.PageCount
        'ShowStats()
    End Function
    ...
    Private Sub dgDept_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgDept.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            'Jules 2018.11.07 - Encode deptname to cater for department names containing "&"
            lnkDeptName.NavigateUrl = dDispatcher.direct("BCM", "bcmAccSetup.aspx", "pageid=" & strPageId & "&deptindex=" & dv("CDM_DEPT_INDEX") & "&deptname=" & Server.UrlEncode(dv("CDM_DEPT_NAME")))
