<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BillingApprovalList.aspx.vb" Inherits="eProcure.BillingApprovalList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html>
<head>
    <title>IPP Approval List</title>
			...
			<TABLE class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0">								
				...
				<TR>
	                <TD class="emptycol" colspan="5">
		                ...
		                Text="Fill in the search criteria and click Search button to list the relevant IPP Document. Click the No. to go to IPP document approval page.">
		                </asp:label>
	                </TD>
                </TR>
                <tr>
			    ...
			    <TD class="emptycol">
			        <asp:datagrid id="dtgIPP" runat="server" OnSortCommand="SortCommand_Click">
					    <Columns>
			                ...
			                <asp:BoundColumn DataField="BM_SUBMIT_DATE" SortExpression="BM_SUBMIT_DATE" HeaderText="Submitted Date">
				            <HeaderStyle Width="10%"></HeaderStyle>
			                </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="BM_INVOICE_TOTAL" SortExpression="BM_INVOICE_TOTAL" HeaderText="Payment Amount">
                            <HeaderStyle Width="10%" />
                            </asp:BoundColumn>	
                            <asp:BoundColumn DataField="BM_INVOICE_INDEX" SortExpression="BM_INVOICE_INDEX" HeaderText="INDEX">                                                            
                            </asp:BoundColumn>		
