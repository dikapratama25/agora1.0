<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BillingApprovalSetup.aspx.vb" Inherits="eProcure.BillingApprovalSetup" %>
	...
	<body onload="" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table1" width="100%" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR vAlign="top">
					<TD class="tablecol" align="left" width="20%" nowrap>&nbsp;<STRONG>Document No.</STRONG>&nbsp;:</TD>
					<TD class="TableInput" width="80%"><asp:label id="lblIPP" runat="server" Width="290px"></asp:label></TD>
				</TR>
				<TR vAlign="top">
				...
				<tr>
					<td colSpan="2"><asp:datagrid id="dtgAO" runat="server" OnPageIndexChanged="dtgAO_Page" AutoGenerateColumns="False">
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="AGA_AO"  readonly="true"   HeaderText="Main Verifier/Approver"></asp:BoundColumn>
								<asp:BoundColumn DataField="AO_NAME"  readonly="true"   HeaderText="Main Verifier/Approver">
									<HeaderStyle Width="25%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="AGA_A_AO"  readonly="true"   HeaderText="Alternative Verifier/Approver"></asp:BoundColumn>
								<asp:BoundColumn DataField="AAO_NAME"  readonly="true"   HeaderText="Alternative Verifier/Approver">
									<HeaderStyle Width="55%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="AGA_TYPE"  readonly="true"   HeaderText="Type">
									<HeaderStyle Width="5%"></HeaderStyle>
								</asp:BoundColumn>
