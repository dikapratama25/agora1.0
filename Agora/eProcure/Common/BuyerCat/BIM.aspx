<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BIM.aspx.vb" Inherits="eProcure.BIM" %>
		...
		<form id="Form1" method="post" runat="server">		
			<table class="alltable" id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr valign="top">
					        ...
					        <td class="tablecol" align="left" style="width: 218px" >
				...
				<tr valign="top">			
					        ...
					        <tr valign="top">
					         <td class="tablecol" align="left">&nbsp;<strong><asp:Label ID="Label18" runat="server" Text="Account Code :"></asp:Label></strong>
			                    ...
			                    <td class="TableInput" style="width: 218px" ><asp:dropdownlist id="ddlAccCode" width="100%" runat="server" CssClass="ddl" ></asp:dropdownlist><%--<asp:textbox id="txtAccCode" width="100%"  runat="server" CssClass="txtbox" MaxLength="30" ></asp:textbox>--%>
					        	</td>
 								 <td class="TableInput"></td>
			       ...
			       <tr>
                       ...
                       <td class="tablecol"></td>
                       <td class="tablecol">
                            <strong>&nbsp;<asp:Label ID="lblGST" runat="server" Text="SST/VAT" Width="50px"></asp:Label></strong></td>
