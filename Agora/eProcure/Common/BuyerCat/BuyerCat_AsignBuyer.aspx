<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BuyerCat_AsignBuyer.aspx.vb" Inherits="eProcure.BuyerCat_AsignBuyer" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <%  Response.Write(Session("w_BuyerCatBuyer_tabs"))%>
			...
			<TR>
	                <TD colSpan="6">
		                <asp:label id="lblAction" runat="server"  CssClass="lblInfo"
		                        Text="Step 1: Create user defined Purchase Catalogue.<br>Step 2: Assign item master to Purchaser Catalogue.<br><b>=></b>Step 3: Assign purchaser to Purchaser Catalogue."
		                ></asp:label>
			...
			<TR>
	                <TD colSpan="6">
		                <asp:label id="Label1" runat="server"  CssClass="lblInfo"
		                        Text="Please select Purchaser Catalogue."
		                ></asp:label>
			...
			<TABLE class="alltable" cellSpacing="0" cellPadding="0">
				<TR id="trhid" runat="server">
					<TD align="center" >
						...
						Text="a) To assign Purchasers to the Purchaser Catalogue, choose the name from 'Available Purchasers' and click Assign button.<br>b) To remove/unassigned purchaser from the Purchaser Catalogue, choose the 'Selected Purchasers' and click Remove button."></asp:label>
                        </div>
					</TD>
				</TR>
				<TR>
