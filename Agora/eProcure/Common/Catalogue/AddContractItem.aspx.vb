...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'If viewstate("caller") = "cat" Then
        '    lnkBack.NavigateUrl = "AddCatalogue.aspx?index=" & viewstate("index") & "&type=" & viewstate("type") & "&mode=mod&code=" & viewstate("code") & "&pageid=" & strPageId
        'Else
        '    lnkBack.NavigateUrl = "ContractCatalogue.aspx?index=" & viewstate("index") & "&type=" & viewstate("type") & "&comp=V&mode=mod&code=" & viewstate("code") & "&pageid=" & strPageId
        'End If
    End Sub
    ...
    Private Function Bindgrid() As String
        ...
        ds = objCat.getConCatItemList(ViewState("index"), txtVendorItemCode.Text, txtDesc.Text, strCommodity, aryItemType)
    ...
    '    Response.Redirect("ContractPrice.aspx?index=" & viewstate("index") & "&code=" & Server.UrlEncode(viewstate("code")) & "&mode=add&type=" & viewstate("type") & "&pageid=" & strPageId)
    'End Sub
    ...
    Private Sub dtgCatalogue_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgCatalogue.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            If ViewState("strGstRegNo") <> "" Then
                ...
                objGlobal.FillGST(ddl_GSTRate, False, ViewState("ContractVCoyId"))
    ...
    Private Function validateDatagrid(ByRef strMsg As String) As Boolean
        ...
        Dim ddl_GSTRate, ddl_GSTCode As DropDownList
        ...
        For Each dgItem In dtgCatalogue.Items
            ...
            If ViewState("GSTCOD") = True Then
                If chkSelection.Checked And (ddl_GSTRate.SelectedValue = "" Or ddl_GSTCode.SelectedValue = "") Then
                    strMsg &= "<li>SST Rate & SST Tax Code is/are required.<ul type='disc'></ul></li>"
                    txtGSTQ.Text = "?"
        ...
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            If ViewState("strGstRegNo") <> "" Then
                If IsDBNull(dv("CDI_GST_RATE")) Then
                    objGlobal.FillGST(ddl_GSTRate1, , ViewState("ContractVCoyId"))
                    lbl_GSTRate1.Text = ddl_GSTRate1.SelectedValue
                ...
                If ddl_GSTCode1.SelectedValue = "N/A" Then
        ...
        For Each dgItem In dtgCatalogueMod.Items
            ...
            If ViewState("GSTCOD") = True Then
                If ddl_GSTRate1.SelectedValue = "" Then
                    strMsg &= "<li>SST Rate is required.<ul type='disc'></ul></li>"
                    txtGSTQ1.Text = "?"
