<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConCat_AssignMultiUser.aspx.vb" Inherits="eProcure.ConCat_AssignMultiUser" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <%  Response.Write(Session("w_ConCat_tabs"))%>
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0" width="100%">
                ...
                <TR>
                    <TD colSpan="6">
                        <asp:label id="lblAction" runat="server"  CssClass="lblInfo" Text="Step 1: Create, delete or modify Contract Catalogue.<br>Step 2: Assign item master to Contract Catalogue.<br><b>=></b>Step 3: Assign User to Contract Catalogue."></asp:label>
                    </TD>
                </TR>
                <tr>
            ...
            <div id="Div_XX" style="DISPLAY: inline" runat="server">
                <TABLE class="alltable" cellSpacing="0" cellPadding="0" border="0">
                    <TR>
                        <TD class="TableCol" style="WIDTH: 314px">&nbsp;<STRONG>&nbsp;Available Catalogue </STRONG>:</TD>
                        <TD class="TableCol" style="WIDTH: 81px"></TD>
                        <TD class="TableCol" style="width: 353px"><STRONG>Selected Catalogue </STRONG>:</TD>
                    </TR>
                    <TR>
			...
			<TABLE class="alltable" cellSpacing="0" cellPadding="0">
				<TR id="trhid" runat="server">
					<TD align="center" >
						<div align="left"><asp:label id="Label4" runat="server"  CssClass="lblInfo" Text="a) To assign Purchasers to the Contract Catalogue, choose the name from 'Available Purchasers' and click Assign button.<br>b) To remove/unassigned purchaser from the Contract Catalogue, choose the 'Selected Purchasers' and click Remove button."></asp:label></div>
					</TD>
				</TR>
				<TR>
