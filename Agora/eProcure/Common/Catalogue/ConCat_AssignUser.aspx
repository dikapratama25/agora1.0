<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConCat_AssignUser.aspx.vb" Inherits="eProcure.ConCat_AssignUser" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <%  Response.Write(Session("w_ConCat_tabs"))%>
		    ...
		    <tr>
		        <td style="width: 8%" align="left"><strong><asp:Label ID="Label24" runat="server" Text="View By:" ></asp:Label></strong></td>
				<td colSpan="5" align="left">					    
                    <asp:radiobuttonlist ID="rd1" RepeatDirection="Horizontal" runat="server" AutoPostBack="true"> 
                    <asp:ListItem Value="CC" Selected="True">Contract Catalogue</asp:ListItem>
						<asp:ListItem Value="PU">Purchasers</asp:ListItem>
			...
			<TR>
                <TD colSpan="6">
	                <asp:label id="lblSelect" runat="server"  CssClass="lblInfo"
	                        Text="Please select Contract Catalogue."></asp:label>
                </TD>
            </TR>
           <tr>
				<TD class="linespacing2" colSpan="6"></TD>
			...
			<TR>
            <TD colSpan="6" class="tableheader">&nbsp;Search Criteria</TD>
            ...
            <div id="Div_BB" style="DISPLAY: None" runat="server">
                <TABLE class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0" >
				    <TR>
					    <TD class="tablecol" nowrap style="height: 25px">&nbsp;<STRONG>Purchaser</STRONG> :&nbsp;<asp:DropDownList ID="cboBuyer" runat="server" CssClass="txtbox" Width="322px" AutoPostBack="True"></asp:DropDownList>&nbsp;&nbsp;</TD>
				    </TR>
		        </table>
                <TABLE class="alltable" cellSpacing="0" cellPadding="0" border="0">
                    <TR>
                        <TD class="TableCol" style="WIDTH: 314px">&nbsp;<STRONG>&nbsp;Available Contract Catalogue </STRONG>:</TD>
                        <TD class="TableCol" style="WIDTH: 81px"></TD>
                        <TD class="TableCol" style="width: 353px"><STRONG>Selected Contract Catalogue </STRONG>:</TD>
                    </TR>
                    <TR>
                        <TD class="TableCol" style="WIDTH: 314px">&nbsp;
	                        <asp:listbox id="lstBox3" runat="server" Width="300px" SelectionMode="Multiple" cssClass="listbox"></asp:listbox></TD>
                        <TD class="TableCol" style="WIDTH: 81px" >
                ...
                <TABLE class="alltable" cellSpacing="0" cellPadding="0" border="0">
                    ...
                    <TR>
                        <TD><asp:button id="cmdsave2" runat="server" CssClass="button" Text="Save"></asp:button>&nbsp;<asp:button id="cmdReset2" runat="server" CssClass="button" Text="Reset"></asp:button></TD>
                    </TR>
                    <tr>
                        <TD class="linespacing2" colSpan="6"></TD>
                    </TR>
			...
			<TABLE class="alltable" cellSpacing="0" cellPadding="0">
				<TR id="trhid" runat="server">
					<TD align="center" >
						<div align="left"><asp:label id="lbl1" runat="server"  CssClass="lblInfo"
