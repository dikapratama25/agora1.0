...
Public Class ContractCatalogue
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents cmdExtCon As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If strCompanyType.ToUpper = "BUYER" Or strCompanyType.ToUpper = "BOTH" Then
            ...
            If Not IsPostBack Then
                ...
                cmdExtCon.Attributes.Add("onclick", "return CheckAtLeastOne('chkSelection');")
            End If
        Else
        ...
        If dtgCatalogue.Items.Count > 0 Then
            ...
            cmdExtCon.Enabled = True
        Else
            cmdViewCon.Enabled = False
            cmdExtCon.Enabled = False
        End If
    ...
    Private Sub cmdExtCon_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdExtCon.Click
        Dim dgItem As DataGridItem
        Dim chkItem As CheckBox
        Dim dtMaster As New DataTable
        ...
        'ViewState("CatalogueList") = dtMaster
        ...
        Dim strscript As New System.Text.StringBuilder
        strscript.Append("<script language=""javascript"">")
        'strFileName = dDispatcher.direct("Catalogue", "ExtCatalogue.aspx", "index=" & CType(dgItem.FindControl("lblIndex"), Label).Text & "&pageid=" & strPageId)
        strFileName = dDispatcher.direct("Catalogue", "ExtCatalogue.aspx", "index=" & strCat & "&pageid=" & strPageId)
        'strFileName = Replace(Server.UrlEncode(strFileName), "'", "%27")
        strscript.Append("PopWindowCat('" & strFileName & "');")
        strscript.Append("</script>")
        RegisterStartupScript("script13", strscript.ToString())
        '    End If
        'Next
