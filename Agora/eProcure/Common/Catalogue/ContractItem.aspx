<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContractItem.aspx.vb" Inherits="eProcure.ContractItem" %>
	...
	<body class="body" ms_positioning="GridLayout">
		...
		<%  Response.Write(Session("w_ConCat_tabs"))%>
			<table class="alltable" id="Table1" cellspacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr><td class="rowspacing" style="width: 641px"></td></tr>
				<tr>
					<td class="tableheader" colspan="6">Search Criteria</td>
				</tr>
				<tr>
					<td class="tablecol" colspan="6" style="height: 25px; width: 850px;"><strong><asp:label id="lblCodeLabel" runat="server" Text="Contract Ref. No. " CssClass="lbl"></asp:label></strong>:&nbsp; &nbsp;&nbsp;&nbsp;<asp:dropdownlist id="ddlCode" runat="server" Width="300px" CssClass="ddl" AutoPostBack="True"></asp:dropdownlist></td>
				</tr>				
				<tr><td class="rowspacing" style="width: 641px"></td></tr>
				<tr>
					<td class="EmptyCol" colspan="6">
					    <asp:datagrid id="dtgCatalogue" runat="server" AutoGenerateColumns="False" OnSortCommand="SortCommand_Click">
							<Columns>
								...
								<asp:BoundColumn DataField="GSTRATE" SortExpression="GSTRATE" ReadOnly="True" HeaderText="SST Rate">
									<HeaderStyle Width="7%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="CDI_GST_TAX_CODE" SortExpression="CDI_GST_TAX_CODE" ReadOnly="True" HeaderText="SST Tax Code (Purchase)">
									<HeaderStyle Width="7%"></HeaderStyle>
								</asp:BoundColumn>
