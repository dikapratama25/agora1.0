<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreditNoteListing.aspx.vb"
    Inherits="eProcure.CreditNoteListing" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        ...
        <table class="alltable" id="Table1" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                <td colspan="4">
                    <asp:Label ID="lblAction" runat="server" CssClass="lblInfo" Text="Fill in the search criteria and click Search button to list the relevant Credit Note."></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tableCOL" align="left" width="10%">
                    &nbsp;<strong><asp:Label ID="Label1" runat="server" Text="Credit Note No. :"></asp:Label></strong></td>
                <td class="TableInput" width="20%">
                    <asp:TextBox ID="txtCNNo" runat="server" CssClass="TXTBOX"></asp:TextBox></td>
                <td class="tableCOL" align="left" width="10%">
                    <strong>
                    ...
                    <table class="AllTable" id="Table2" cellspacing="0" cellpadding="0" border="0" runat="server"
                        ...
                        <tr class="tablecol">
                            ...
                            <%--Jules 2015.02.23 Agora Stage 2--%>
                                <asp:CheckBox ID="chk_Acknowledged" runat="server" Text="Acknowledged"></asp:CheckBox></td>                            
            ...
            <tr>
                <td>                 
                    ...
                    <tr>
                        <td colspan="5">
                            <asp:DataGrid ID="dtg_CNList" runat="server" OnPageIndexChanged="dtg_CNList_Page"
                                AllowSorting="True" AutoGenerateColumns="False" OnSortCommand="SortCommand_Click">
                                <Columns>
                                    <asp:BoundColumn SortExpression="CNM_CN_NO" HeaderText="Credit Note Number">
                                        <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn SortExpression="CNM_CREATED_DATE" HeaderText="Creation Date">
                                        <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn SortExpression="CNM_INV_NO" HeaderText="Invoice Number">
                                        <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn DataField="CNM_CURRENCY_CODE" SortExpression="CNM_CURRENCY_CODE"
                                        HeaderText="Currency">
                                        <HeaderStyle HorizontalAlign="Left" Width="8%"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn SortExpression="CNM_CN_TOTAL" HeaderText="Amount">
                                        <HeaderStyle HorizontalAlign="Left" Width="12%"></HeaderStyle>
