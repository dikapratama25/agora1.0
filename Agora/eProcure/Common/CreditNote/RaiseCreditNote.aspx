<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RaiseCreditNote.aspx.vb" Inherits="eProcure.RaiseCreditNote" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>RaiseCreditNote</title>
...
//alert(tax);
	    ...
	    function calculateAllIndividualTotal()
		{
			...
			for (iInd=0; iInd < Form1.hidTotalClientId.value; iInd++)
			{
			    ...
			    calculateTotal("dtg_CreditNoteDetail_" + sCurrentClientId+"_txtQty","dtg_CreditNoteDetail_" + sCurrentClientId+"_txtPrice","dtg_CreditNoteDetail_" + sCurrentClientId+"_txtAmount","dtg_CreditNoteDetail_" + sCurrentClientId+"_txtGST","dtg_CreditNoteDetail_" + sCurrentClientId+"_txtGSTValue");
    	...
    	function calculateGrandTotal()
	    {
		    ...
		    for (i=0; i < Form1.hidTotalClientId.value; i++)
		    {
		        ...
		        dtg_CreditNoteDetail = eval("Form1.dtg_CreditNoteDetail_" + sCurrentClientId+"_txtAmount.value");
		        dtg_CreditNoteDetail = dtg_CreditNoteDetail.replace(",","");
				dtg_CreditNoteDetail = dtg_CreditNoteDetail.replace(",","");
//		        selectedIndex = eval("Form1.dtg_CreditNoteDetail_" + sCurrentClientId+"_ddlGSTRate.selectedIndex");
//		        dTaxVal = eval("Form1.dtg_CreditNoteDetail_" + sCurrentClientId+"_ddlGSTRate.options[selectedIndex].text");
//		        
...
//    		        }	        
//    		    }
                dTaxVal = eval("Form1.dtg_CreditNoteDetail_" + sCurrentClientId+"_txtGST.value");

		        var temp = parseFloat(dtg_CreditNoteDetail.replace(",",""));
		    ...
		    Form1.hidGrandTotal.value = addCommas(sGrandtotal.toFixed(2), 2);
		    //'Jules 2015.02.16 - Agora Stage 2
		    Form1.hidCNTotal.value = sGrandtotal.toFixed(2);  		 
    		checkAmount();
	    }
	    
	    function checkAmount()
	    {
	        var balance = Form1.hidInvAmt.value - Form1.hidRelatedCNTotal.value;
	        var currentCN = document.getElementById('sGrandTotal').innerHTML;
	        if (currentCN > 0)
	        {
//	            if (balance < currentCN)
//	            {
//    	            alert('Total Credit Note amount must be less than the selected invoice total amount minus total related credit note amount.'); 
//	            }
	        }
	    }
...
<body ms_positioning="GridLayout" runat="server" id="body1">
    <form id="Form1" method="post" runat="server">
        ...
        <table class="alltable" id="Table1" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr>
                <td>
                    <asp:Label ID="lblAction" runat="server" CssClass="lblInfo" Text="Fill in the relevant info and click the Submit button to submit the credit note to the selected buyer."></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <table class="AllTable" id="Table2" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr class="tablecol">
                            <td class="tableinput" width="17%">
                                &nbsp;<strong>Credit Note Number</strong>&nbsp;:</td>
                                <td class="tableinput" width="30%">
                                    <asp:Label ID="lblCreditNoteNum" runat="server" Text="To Be Allocated By System"></asp:Label>
                                </td>
                        ...
                        <tr class="tablecol">
                            <td class="tableinput" width="17%">
                                ...
                                <td class="tableinput">
                                    <asp:Label ID="lblCreditNoteDate" runat="server" Text=""></asp:Label>
                                </td>
                                <td class="tableinput" width="20%">
                                    <strong>Date</strong>&nbsp;:
                                </td>
                        ...
                        <tr class="tablecol">
                            ...
                            <td class="tableinput" colspan="2">
                                <table class="AllTable" id="Table4" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr class="tablecol">
                                        <td class="tableinput">
                                            <strong>Related Credit Note</strong>&nbsp;:
                                        </td>
                                        <td>
                                            <asp:Label ID="lblRelatedCreditNote" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr class="tablecol">
                                        <td class="tableinput">
                                            <strong>Total Related Credit Note Amount</strong>&nbsp;:
                                        </td>
                                        <td>
                                            <asp:Label ID="lblRelatedCreditNoteAmt" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr class="tablecol">
                                        <td class="tableinput">
                    ...
                    <table class="AllTable" id="Table5" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td class="emptycol">
                                <asp:DataGrid ID="dtg_CreditNoteDetail" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn SortExpression="Amount" HeaderText="Amount">
                                            ...
                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtAmount" CssClass="numerictxtbox" Width="100%" MaxLength="9" runat="server" contentEditable="false"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn HeaderText="SST Amount">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGSTValue" CssClass="numerictxtbox" Width="100%" MaxLength="9"
                                                    runat="server"  contentEditable="false"></asp:TextBox>
				        ...
				        <tr>
				            <td>				                		               
                                ...
                                <input id="hidGrandTotal" runat="server" name="hidGrandTotal" style="width: 22px" type="hidden"/>
                                <input id="hidInvAmt" runat="server" name="hidInvAmt" style="width: 22px" type="hidden"/>
                                <input id="hidRelatedCNTotal" runat="server" name="hidRelatedCNTotal" style="width: 22px" type="hidden"/>
                                <%--Jules 2015.02.16 - Agora Stage 2--%>
                                <input id="hidCNTotal" runat="server" name="hidCNTotal" style="width: 22px" type="hidden"/>
				            </td>
				        </tr>
				        <tr>
