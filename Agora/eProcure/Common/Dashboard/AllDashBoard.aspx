<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AllDashBoard.aspx.vb" Inherits="eProcure.AllDashBoard" %>
...
<body style="width:95%;">
   ...
   <%-- Purchasing Manager--%>
        ...
        <div id="divOutBillDoc" style="display:none;" runat="server">
        <div class="db_wrapper">
            <div class="db_tbl_hd">
                <asp:Label ID="OutBillDoc" runat="server"></asp:Label>
            </div>
            <asp:DataGrid ID="dtgOutBillDoc" runat="server" OnSortCommand="SortCommandOutBillDoc_Click">
                <Columns>
				    <asp:TemplateColumn SortExpression="BM_INVOICE_NO" HeaderText="Document No.">
					    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
					    <ItemStyle HorizontalAlign="Left"></ItemStyle>
					    <ItemTemplate>
						    <asp:HyperLink Runat="server" ID="lnkBillNo"></asp:HyperLink>
					    </ItemTemplate>
				    </asp:TemplateColumn>
				    <asp:BoundColumn HeaderText="Customer" DataField="BM_S_COY_NAME" SortExpression="BM_S_COY_NAME">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn> 
                    <asp:BoundColumn HeaderText="Payment Amount" DataField="BM_INVOICE_TOTAL" SortExpression="BM_INVOICE_TOTAL">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>  
				    <asp:BoundColumn HeaderText="Creation Date" DataField="BM_CREATED_ON" SortExpression="BM_CREATED_ON">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>           
                    <asp:BoundColumn HeaderText="Submitted Date" DataField="BM_SUBMIT_DATE" SortExpression="BM_SUBMIT_DATE">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn HeaderText="Status" DataField="STATUS_DESC" SortExpression="STATUS_DESC">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>                                                               
                </Columns>
        ...
        <div id="divPendingBillApproval" style="display:none;" runat="server">
        <div class="db_wrapper">
            <div class="db_tbl_hd">
                <asp:Label ID="PendingBillApproval" runat="server"></asp:Label>
            </div>
            <asp:DataGrid ID="dtgPendingBillApproval" runat="server" OnSortCommand="SortCommandPendingBillApproval_Click">
                <Columns>
				    <asp:TemplateColumn SortExpression="BM_INVOICE_NO" HeaderText="Document No.">
					    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
					    <ItemStyle HorizontalAlign="Left"></ItemStyle>
				    ...
				    <asp:BoundColumn HeaderText="Document Type" DataField="BM_INVOICE_TYPE" SortExpression="BM_INVOICE_TYPE">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
				    <asp:BoundColumn HeaderText="Customer" DataField="BM_S_COY_NAME" SortExpression="BM_S_COY_NAME">
        ...
        <div id="divFOIncomingDN" style="display:none;" runat="server">
        <div class="db_wrapper">
            <div class="db_tbl_hd">
                <asp:Label ID="FOIncomingDN" runat="server"></asp:Label>
            </div>
            <asp:DataGrid ID="dtgFOIncomingDN" runat="server" OnSortCommand="SortCommandFOIncomingDN_Click">
                <Columns>
                    <asp:TemplateColumn SortExpression="Debit Note Number" HeaderText="Debit Note Number">
						<HeaderStyle HorizontalAlign="Left" Width="14%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Left"></ItemStyle>
						<ItemTemplate>
                    ...
                    <%--<asp:BoundColumn DataField="DNM_DN_NO" HeaderText="DNM_DN_NO" SortExpression="DNM_DN_NO" Visible="False">
                    </asp:BoundColumn> --%>
                    <asp:BoundColumn HeaderText="Debit Note Date" DataField="DNM_DN_DATE" SortExpression="DNM_DN_DATE">
                        <HeaderStyle HorizontalAlign="Left" Width="14%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn HeaderText="Vendor Name" DataField="CM_COY_NAME">
                        <HeaderStyle HorizontalAlign="Left" Width="50%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="DNM_CURRENCY_CODE" HeaderText="Currency" SortExpression="DNM_CURRENCY_CODE">
                        <HeaderStyle HorizontalAlign="Left" Width="10%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="Amount" HeaderText="Amount" SortExpression="Amount">
        ...
        <div id="divFMIncomingPendingDN" style="display:none;" runat="server">
        <div class="db_wrapper">
            <div class="db_tbl_hd">
                <asp:Label ID="FMIncomingPendingDN" runat="server"></asp:Label>
            </div>
            <asp:DataGrid ID="dtgFMIncomingPendingDN" runat="server" OnSortCommand="SortCommandFMIncomingPendingDN_Click">
                <Columns>
                    <asp:TemplateColumn SortExpression="Debit Note Number" HeaderText="Debit Note Number">
						<HeaderStyle HorizontalAlign="Left" Width="14%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Left"></ItemStyle>
        ...
        <div id="divFMPendingAckCN" style="display:none;" runat="server">
        <div class="db_wrapper">
            <div class="db_tbl_hd">
                <asp:Label ID="FMPendingAckCN" runat="server"></asp:Label>
            </div>
            <asp:DataGrid ID="dtgFMPendingAckCN" runat="server" OnSortCommand="SortCommandFMPendingAckCN_Click">
                <Columns>
                    <asp:TemplateColumn SortExpression="Credit Note Number" HeaderText="Credit Note Number">
						<HeaderStyle HorizontalAlign="Left" Width="14%"></HeaderStyle>
						<ItemStyle HorizontalAlign="Left"></ItemStyle>
						<ItemTemplate>
                    ...
                    <asp:BoundColumn HeaderText="Credit Note Date" DataField="CNM_CN_DATE" SortExpression="CNM_CN_DATE">
                        <HeaderStyle HorizontalAlign="Left" Width="14%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn HeaderText="Vendor Name" DataField="CM_COY_NAME">
                    ...
                    <asp:BoundColumn DataField="CNM_CURRENCY_CODE" HeaderText="Currency" SortExpression="CNM_CURRENCY_CODE">
                        <HeaderStyle HorizontalAlign="Left" Width="10%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="Amount" HeaderText="Amount" SortExpression="Amount">
