<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DebitNoteVerified.aspx.vb" Inherits="eProcure.DebitNoteVerified" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>DebitNoteVerified</title>
...
<body>
    ...
    <%  Response.Write(Session("w_DnVer_tabs"))%>
				...
				<tr>
					<td class="emptycol" colspan="5"><asp:datagrid id="dtgDebitNote" runat="server" OnSortCommand="SortCommand_Click">
							<Columns>
								...
								<asp:TemplateColumn SortExpression="DNM_PAYMENT_TERM" HeaderText="Payment Method">
									<ItemStyle Width="15%" HorizontalAlign="Left"></ItemStyle>
									<ItemTemplate>
										<asp:DropDownList id="cboPay" CssClass="ddl" Runat="server" width="100%"></asp:DropDownList>
										<asp:Label Runat="server" ID="lblPay" Visible="false"></asp:Label>
									</ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
								</asp:TemplateColumn>
								<asp:BoundColumn DataField="DNM_DN_INDEX" HeaderText="INDEX" Visible="false">
								</asp:BoundColumn>
							</Columns>
						</asp:datagrid></td>
				</tr>				
