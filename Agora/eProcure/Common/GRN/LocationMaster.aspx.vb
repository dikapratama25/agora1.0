...
#End Region
    ...
    Private Function ConstructTable()
        ...
        For i = 0 To count - 1
            ...
            If arySetLocation(i)(3) <> Request.QueryString("item") Then
                Continue For
            End If
            'If ((i Mod 2) = 0) Then
    ...
    Private Function BuildRow()
        ...
        If Session("arySetLocation") Is Nothing Then 'Empty
            If LDesc <> "" Then
                arySetLocation.Add(New String() {LDesc, SubLDesc, (Request.QueryString("rqty") - IIf(Common.parseNull(Request.QueryString("rjqty")) = "", 0, Request.QueryString("rjqty"))), Request.QueryString("item"), "Save", "", "", "", Request.QueryString("itemrow")})
            End If
            For i = 0 To ViewState("Row") - 1
                arySetLocation.Add(New String() {Request.Form("cboLocation" & i), Request.Form("cboSubLocation" & i), Request.Form("txtQty" & i), Request.QueryString("item"), "Save", "", "", "", Request.QueryString("itemrow")})
            Next
            Session("arySetLocation") = arySetLocation
        Else ' Session Not Empty 1.Reload   2.After Add Line
            ...
            Else ' If found then update the Default QTY
                ReCal()
                For i = 0 To arySetLocation.Count - 1
                    If arySetLocation(i)(3) = Request.QueryString("item") And arySetLocation(i)(0) = LDesc And arySetLocation(i)(1) = SubLDesc Then
