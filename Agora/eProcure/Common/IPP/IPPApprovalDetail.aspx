<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IPPApprovalDetail.aspx.vb" Inherits="eProcure.IPPApprovalDetail" %>
...
<head runat="server">
    ...
    <meta content="Microsoft Visual Studio.NET 7.0" name="GENERATOR"/>
		...
		<script runat="server">
            ...
            Dim edit As String = dDispatcher.direct("IPP", "IPPEntryPop.aspx", "") 'Zulham 26072018 - PAMB
        </script>
         <% Response.Write(css)%>
         ...
         else
         {
            ...
            if ($("#lblPaymentMethod").val() !== 'Nostro Expenses')
            {
         ...
         $("#txtExchangeRate").keyup(function(){
             ...
             else
             {
                //$("#cmdPreview").attr("disabled","");
                //Zulham 01042015 Case 8603
                //alert($("#txtPaymentMethod").val());
                if ($("#txtPaymentMethod").val() !== 'Nostro Expenses')
                {
                    $("#cmdPreview").attr("disabled","");
                }
             }
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="AllTable">
				...
				<tr>
	                <td class="emptycol" colspan="6">
		                <asp:label id="lblAction" runat="server"  CssClass="lblInfo"
		                        Text="Click the Approve button to approve the E2P Document or Reject button to reject the E2P Document."
		                ></asp:label>
            ...
            <tr>
                <td class="TableCol" style="width: 20%">
                    <strong>&nbsp;&nbsp;<asp:Label ID="Label25" runat="server" Text=" Master Document :" Width="110px"></asp:Label></strong></td>
            ...
            <tr>
               ...
               <asp:Label ID="lblDocDueDate" runat="server"></asp:Label>               
                ...
                <%--Zulham 17/02/2016 - IPP Stage 4 Phase 2--%>
                 ...
                 <td colspan="2" class="TableCol" style="width: 180px;">
                  ...
                  <asp:hiddenfield ID="txtPaymentMethod" runat="server"></asp:hiddenfield>
                 </td>--%>
             ...
             <tr>
            <td class="TableCol" style="width: 20%">                   
                    <strong>&nbsp;<asp:Label ID="Label23" runat="server" Text=" Credit Term :"></asp:Label></strong></td>                
               <td class="TableCol" style="width: 25%">
            ...
            <tr>
                 <td class="TableCol" style="width: 20%">
                 <strong>&nbsp;<asp:Label ID="Label14" runat="server" Text=" PSD Sent Date :"></asp:Label></strong>
                   </td>
                <td class="TableCol" style="width: 25%">
              ...
              <tr>
                ...
                <%--<td class="TableCol" style="width: 15%">
                <strong><asp:Label ID="Label17" runat="server" Text=" Payment Date :"></asp:Label></strong>
                 </td>
                 <td colspan="2" class="TableCol" style="width: 180px;">
            ...
            <tr>
                ...
                <%--<td class="TableCol" style="width: 15%">
                <strong><asp:Label ID="Label19" runat="server" Text=" Payment Advice No :"></asp:Label></strong>
                   </td>
                <td colspan="2" class="TableCol" style="width: 180px;">
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="TableCol" style="width: 20%">
                    <strong>&nbsp;<asp:Label ID="Label11" runat="server" Text=" Vendor Address :"></asp:Label></strong></td>
                <td class="TableCol" rowspan="10" style="width: 25%" valign="top">
                    <asp:Label ID="lblVendorAddr" runat="server"></asp:Label></td>
                     <td class="TableCol" rowspan="9" style="width: 1%">&nbsp;</td>
            ...
            <td class="TableCol" rowspan="10" valign="top" style="width: 15%">
                ...
                <td class="TableCol" rowspan="10" valign="top" style="width: 8%">
                 ...
                 <td class="TableCol" rowspan="10" colspan="1">
                 ...
                 <tr>	                    			   
			         <td class="EmptyCol">
				                <asp:datagrid id="dtgDocDetail" runat="server" OnPageIndexChanged="dtgDocDetail_Page" CssClass="Grid" AutoGenerateColumns="False">
							        <Columns>	
                                        <%--Zulham 26072018 - PAMB--%>
                                        <asp:TemplateColumn HeaderText="Action"  ItemStyle-Width="2%">						                
							            <ItemStyle />
							                <ItemTemplate>
								        ...
								        <asp:TemplateColumn  HeaderText="SST Amount">
									      ...
									      <ItemStyle HorizontalAlign="Right"></ItemStyle>
								            <ItemTemplate>
								                <asp:textbox runat="server" ID="lblGSTAmount" Width="55px" CssClass="numerictxtbox" AutoPostBack="true"/>
								            </ItemTemplate>
								        </asp:TemplateColumn>
							            ...
							            <asp:TemplateColumn HeaderText="Exchange Rate">
									        ...
									        <ItemStyle HorizontalAlign="Right"></ItemStyle>
									        <ItemTemplate>
										        <asp:TextBox id="txtLineExchangeRate" runat="server"  Width="45px" MaxLength="5" CssClass="numerictxtbox"></asp:TextBox>										
									        </ItemTemplate>
								        </asp:TemplateColumn>		
							        </Columns>
							    </asp:datagrid>						   				
            ...
            <table class="AllTable" cellpadding="0" cellspacing="0" width="100%">
			    ...
			    <tr id="TRExchangeRate" visible ="false" runat="server">
		            ...
		            <td width= "85%" >
		                ...
		                <asp:textbox id="txtExchangeRate" runat="server" CssClass="txtbox" enabled="false"></asp:textbox>
		            </td>
			    </tr>
                <tr>
	                <td width= "15%" align="left" style="height: 19px; ">
                        ...
                        <%--Zulham 06082018 - PAMB--%>
                        <asp:label id="Label10" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:
	                </td>
		            <td width= "85%" >
			    ...
			    <tr id="trRejectRouteTo" runat="server">		
			        <td>
			         <strong><asp:Label ID="Label20" runat="server" Text="Reject(Route To) :"></asp:Label></strong>
			        </td>
		        	<td class="emptycol"  colspan="7">
                         <asp:RadioButtonList ID="rbtnRouteTo" runat="server" RepeatDirection="Horizontal"  Width="200px" AutoPostBack="True">
                         <asp:ListItem Value="O" Selected="True">Others</asp:ListItem>                                           
                         <asp:ListItem Value="F">PSD Received Date</asp:ListItem>
                          </asp:RadioButtonList>
                     </td>			        
			    </tr>
			    </table>    
			    <table class="AllTable" cellpadding="0" cellspacing="0" width="100%">
			   <tr id="trIBG2RENTAS" runat="server">		
			        <td width= "15%">
			         <strong><asp:Label ID="Label22" runat="server" Text="Convert to RENTAS :"></asp:Label></strong>
			        </td>
		        	<td >
                         <asp:CheckBox ID="chkConvert2RENTAS" runat="server" Text="Yes">                       
                          </asp:CheckBox>                         
                     </td>	
            
                   <td>
                    <asp:Label ID="lblBeneficialDetails" runat="server" Text="Beneficial Details"></asp:Label>
                    <asp:label id="Label24" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:
                          <asp:textbox id="txtBeneficialDetails" runat="server" CssClass="txtbox2" style="width: 200px" ></asp:textbox>
                   </td>
			    </tr>
			    <tr>
					<td class="linespacing1" colspan="7"></td>
		        ...
		        <tr id="trButton" runat="server">
				    <td colspan="4">
				        <asp:button id="cmdAppIPP" runat="server" CssClass="button" Text="Approve"></asp:button>
