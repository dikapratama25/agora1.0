<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IPPFVPendingFYFA.aspx.vb" Inherits="eProcure.IPPFVPendingFYFA" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Finance Verifier Pending FYFA List</title>
	...
	<body MS_POSITIONING="GridLayout">
		...
		<%--		<TR id="tdAO" style="VISIBILITY: visible" runat="server">
                ...
                <TD class="tablecol"  width="25%" align="right">
				...
				<TR>
					<TD class="emptycol">
						<TABLE class="AllTable" id="tblSearchResult" width="100%" cellSpacing="0" cellPadding="0"
							...
							<TR>
								<TD class="emptycol"><asp:datagrid id="dtgIPPFVPendingFYFAList" runat="server" OnSortCommand="SortCommand_Click" DataKeyField="IM_INVOICE_INDEX">
										<Columns>
