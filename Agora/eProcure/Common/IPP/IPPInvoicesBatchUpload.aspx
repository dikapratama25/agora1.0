<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IPPInvoicesBatchUpload.aspx.vb" Inherits="eProcure.IPPInvoicesBatchUpload" %>
<!DOCTYPE HTML PUBLIC "-//W3C//Dtd HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Invoice Batch Upload</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table style="display:none" class="alltable" id="Table5" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="header"><asp:label id="Label3" runat="server" CssClass="header">Batch Upload of multiple invoices</asp:label></td>
				</tr>
		...
		<table class="alltable" id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="tableheader" colspan="3">&nbsp;<asp:label id="lblHeader" runat="server">Multi Invoices Upload</asp:label></td>							
				</tr>
				...
				<tr>
					<td class="emptycol" colspan="2">Download Multi GL Upload template - 
						<asp:linkbutton id="cmdDownloadTemplate" Runat="server">MultipleInvoices.xls [720KB]</asp:linkbutton>
					</td>
				</tr>	
