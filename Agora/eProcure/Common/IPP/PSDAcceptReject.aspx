<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PSDAcceptReject.aspx.vb" Inherits="eProcure.PSDAcceptReject" %>
...
<body>
    ...
    <div>
        <table id="table1" cellpadding="0" cellspacing="0" class="AllTable">        
            ...
            <tr>
                <td class="EmptyCol">
                    <asp:Label ID="Label9" runat="server" CssClass="lblInfo" Text="Select the PSD Sent Date and the IPP documents. Click Save to save the record."></asp:Label>                    
                </td>
            </tr>
         </table>
         <table id="Table2" class="AllTable" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="3" class="TableCol">
                    <asp:CheckBoxList id="chkStatus" runat="server" RepeatDirection="Horizontal" CssClass="chklist">
                        <asp:ListItem Value="10">Draft</asp:ListItem>
                        <asp:ListItem Value="11,12">Submitted</asp:ListItem>
                        <asp:ListItem Value="18">IPP Verified</asp:ListItem>
                        <asp:ListItem Value="17">PSD Sent</asp:ListItem>
                        <asp:ListItem Value="11">PSD Received</asp:ListItem>
                     </asp:CheckBoxList>
                     <asp:CheckBoxList id="chkStatus2" runat="server" RepeatDirection="Horizontal" CssClass="chklist">
                        <asp:ListItem Value="12">Finance Verified</asp:ListItem>
