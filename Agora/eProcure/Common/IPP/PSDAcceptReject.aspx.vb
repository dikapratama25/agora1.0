...
Partial Public Class PSDAcceptReject
    ...
    Protected Overrides Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Session("urlreferer") = "PSDAcceptReject"
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        For i = 0 To chkStatus.Items.Count - 1
            If chkStatus.Items(i).Selected Then
                docstatus &= chkStatus.Items(i).Value & ","
            End If
        Next

        For i = 0 To chkStatus2.Items.Count - 1
            If chkStatus2.Items(i).Selected Then
                docstatus &= chkStatus2.Items(i).Value & ","
            End If
        Next
        ...
        If docstatus.IndexOf("11") <> -1 Then
            docstatus = docstatus.Replace("11", "11,19")
        End If

        ds = objIPP.PopulateIPPList(docno, doctype, docstatus, docsdt, docedt, strVen, Session("urlreferer"))
    ...
    Private Sub dtgIPPList_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgIPPList.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Select Case e.Item.Cells(EnumIPP.Status).Text
                ...
                Case 14
                    e.Item.Cells(EnumIPP.DocNo).Text = "<A href=""" & dDispatcher.direct("IPP", "IPPDocument.aspx", "Frm=PSDAcceptRejList&index=" & dv("IM_INVOICE_INDEX") & "&DocumentNo=" & Server.UrlEncode(dv("IM_INVOICE_NO"))) & """ ><font color=#0000ff>" & Common.parseNull(dv("IM_INVOICE_NO")) & "</font></A>"
                Case Else
                    e.Item.Cells(EnumIPP.DocNo).Text = "<A href=""" & dDispatcher.direct("IPP", "IPPDocument.aspx", "Frm=PSDAcceptRejList&index=" & dv("IM_INVOICE_INDEX") & "&DocumentNo=" & Server.UrlEncode(dv("IM_INVOICE_NO"))) & """ ><font color=#0000ff>" & Common.parseNull(dv("IM_INVOICE_NO")) & "</font></A>"
            End Select
    ...
    Private Sub cmdClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClear.Click
        ...
        Dim chkbox, chkbox2 As ListItem
        For Each chkbox In chkStatus.Items
            chkbox.Selected = False
        Next
        For Each chkbox2 In chkStatus2.Items
