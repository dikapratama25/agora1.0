<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PSDRecv.aspx.vb" Inherits="eProcure.PSDRecv" %>
...
<body>
    ...
    <div>
        <table id="table1" cellpadding="0" cellspacing="0" class="AllTable">        
            ...
            <tr>
                <td class="EmptyCol">
                    <asp:Label ID="Label9" runat="server" CssClass="lblInfo" Text="Select the PSD Received Date and the E2P documents. Click Save to save the record."></asp:Label>                    
                </td>
            </tr>
         </table>
         <table id="Table2" class="AllTable" cellpadding="0" cellspacing="0">
            ...
            <table id="table3" cellpadding="0" cellspacing="0" class="AllTable" width="45%" runat="server">
             <tr>
                ...
                <tr>
                    <td class="TableCol" style="width:23%; height: 24px;">
                        PSD Receive Date :</td>
						...
						<asp:datagrid id="dtgIPPList" runat="server" OnSortCommand="SortCommand_Click">
							<Columns>
								...
								<asp:BoundColumn DataField="IM_DOC_DATE" SortExpression="IM_DOC_DATE" HeaderText="Document Date">
								    ...
								    <asp:BoundColumn DataField="im_created_by" SortExpression="im_created_by" HeaderText="Created By" Visible="True">
                            <HeaderStyle Width="10%" />                                        
                        </asp:BoundColumn>  
								<asp:BoundColumn DataField="im_prcs_recv" SortExpression="im_prcs_recv" HeaderText="PSD Received Date" DataFormatString="{0:dd/MM/yyyy}">
									    <HeaderStyle Width="10%"></HeaderStyle>
								</asp:BoundColumn>    
        ...
        <table class="AllTable" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td class="emptycol" style="height: 24px">
                    ...
                    <ASP:BUTTON runat="SERVER" ID="cmdMassPickRecord" Text="Received" CausesValidation="False" CssClass="Button" />
                    <ASP:BUTTON runat="SERVER" ID="cmdSave" Text="-" Visible="False" CssClass="Button" />
                </td> 
            </tr>
        </table>
    </div>
