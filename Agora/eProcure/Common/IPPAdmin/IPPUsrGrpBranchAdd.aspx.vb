...
Public Class IPPUsrGrpBranchAdd
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objIPP.getIPPUserGroupBranchList(Common.Parse(HttpContext.Current.Session("CompanyID")), Common.Parse(txtBranchCode.Text), Common.Parse(txtBranchName.Text), ViewState("UserGroup"))
        ...
        Try
            ...
            For Each dgItem In dgUser.Items
                ...
                If chkItem.Checked Then
                    strDeptCode = dgItem.Cells(1).Text
                    strCoyID = dgItem.Cells(3).Text
                    strSQL = "INSERT INTO ipp_usrgrp_branch (IUB_GRP_INDEX,IUB_BRANCH_CODE,IUB_BR_COY_ID) " & _
                        "VALUES('" & ViewState("UserGroup") & "','" & Common.Parse(strDeptCode) & "','" & Common.Parse(strCoyID) & "') "
    ...
    Sub PopulateTypeAhead()
        ...
        Dim typeahead1 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=Branch2&frm=IPPUsrGrpBranchAdd&idx=" & ViewState("UserGroup") & "&btn=BranchCode")
        Dim typeahead2 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=Branch2&frm=IPPUsrGrpBranchAdd&idx=" & ViewState("UserGroup") & "&btn=BranchName")


        content &= "$(""#txtBranchCode"").autocomplete(""" & typeahead1 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
         "});" & vbCrLf & _
        "$(""#txtBranchName"").autocomplete(""" & typeahead2 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
        "});" & vbCrLf
      ...
      "<!--" & vbCrLf & _
        ...
        Session("typeaheadIPPBranchAdd") = typeahead
    End Sub
