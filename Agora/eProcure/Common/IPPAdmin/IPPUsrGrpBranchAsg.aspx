<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IPPUsrGrpBranchAsg.aspx.vb" Inherits="eProcure.IPPUsrGrpBranchAsg" smartNavigation="False" %>
...
<HTML>
	<HEAD>
		...
		<% Response.Write(Session("WheelScript"))%>
		 <% Response.write(Session("typeaheadIPPBranchAsg")) %>
        ...
        <%  Response.Write(Session("w_SearchUser_tabs"))%>
            ...
            <tr>
				...
				<td class="EmptyCol" colspan="4">
					...
					Text="Step 1: Create, delete or modify User Group.<br /><b>=></b> Step 2: Assign Branch to the User Group.<br>Step 3: Assign Cost Center to the User Group.<br>Step 4: Assign User to the User Group."></asp:label>
					...
					<td class="emptycol" colspan="2">
						<table class="alltable" id="Table4" cellspacing="0" cellpadding="0" border="0" width="100%">--%>
							...
							<tr>
								...
								<td  class="tablecol"><asp:textbox id="txtBranchCode" runat="server"  CssClass="txtbox"></asp:textbox>	
								</td>							
			...
			<br/>
				<tr>
					<td class="emptycol" colspan="2"><asp:datagrid id="dgUser" runat="server">
							<Columns>
								...
								<asp:BoundColumn DataField="IUB_BRANCH_CODE" SortExpression="IUB_BRANCH_CODE" HeaderText="Branch Code" ItemStyle-VerticalAlign="Top">
									<HeaderStyle Width="13%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="cbm_branch_name" SortExpression="cbm_branch_name" HeaderText="Description" ItemStyle-VerticalAlign="Top">
									<HeaderStyle Width="13%"></HeaderStyle>
								</asp:BoundColumn>
							...
							<asp:BoundColumn DataField="IUB_BR_COY_ID" SortExpression="IUB_BR_COY_ID" HeaderText="Company ID" ItemStyle-VerticalAlign="Top">
									<HeaderStyle Width="13%"></HeaderStyle>
								</asp:BoundColumn>
							...
							<%--		<ItemStyle HorizontalAlign="Left"></ItemStyle>
	                          ...
	                          <asp:BoundColumn Visible="False" DataField="CBM_BRANCH_INDEX"></asp:BoundColumn>
				...
				<tr runat="server" style="height: 25px">
					<td align="center" >
						...
						Text="# For Deletion: If no Branch Code/User Group is specified, the selected Branch Code will be removed from the all User Group."></asp:label>
                        </div>
					</td>
				</tr>
