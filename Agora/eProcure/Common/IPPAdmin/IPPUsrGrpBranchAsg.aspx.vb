...
Public Class IPPUsrGrpBranchAsg
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objIPP.GetIPPUserGroupBranch(Common.Parse(Common.parseNull(hid1.Value)), Common.Parse(Common.parseNull(hid2.Value)))
    ...
    Private Sub dgUser_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgUser.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Dim lblUserGroup As Label = e.Item.Cells(4).FindControl("lblUserGroup")

            Dim lblBranchCodeDesc As Label = e.Item.Cells(2).FindControl("lblBranchCodeDesc")

            Dim val As String = e.Item.Cells(5).Text

            ds = objIPP.GetIPPUserGroupBranch2(Common.Parse(Common.parseNull(hid1.Value)), Common.Parse(Common.parseNull(val)))
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Else
            ...
            strFileName = dDispatcher.direct("IPPAdmin", "IPPUsrGrpBranchAdd.aspx", "pageid=" & strPageId & "&grpno=" & hid1.Value)
    ...
    Private Sub cmdDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        For Each dgItem In dgUser.Items
            ...
            If chkItem.Checked Then
                ...
                If objIPP.DelIPPUserGroupBranch(hid1.Value, dgItem.Cells(1).Text, dgItem.Cells(4).Text) = False Then
                    Exit For
                End If
    ...
    Private Sub GenerateTab()
        ...
        Session("w_SearchUser_tabs") = "<div class=""t_entity""><ul>" & _
               "<li><div class=""space""></div></li>" & _
                 "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("IPPAdmin", "IPPUserGroup.aspx", "pageid=" & strPageId) & """><span>User Group</span></a></li>" & _
                 "<li><div class=""space""></div></li>" & _
                 "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("IPPAdmin", "IPPUsrGrpBranchAsg.aspx", "pageid=" & strPageId) & """><span>Branch Assignment</span></a></li>" & _
                 "<li><div class=""space""></div></li>" & _
                 "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("IPPAdmin", "IPPUsrGrpCostCenterAsg.aspx", "pageid=" & strPageId) & """><span>Cost Center Assignment</span></a></li>" & _
                 "<li><div class=""space""></div></li>" & _
                 "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("IPPAdmin", "IPPUsrGrpUserAsg.aspx", "pageid=" & strPageId) & """><span>User Assignment</span></a></li>" & _
                 "<li><div class=""space""></div></li>" & _
                 "</ul><div></div></div>"
    End Sub
    Sub PopulateTypeAhead()
        ...
        Dim typeahead1 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=UserGroup&frm=IPPUsrGrpBranchAsg")
        'Dim typeahead2 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=Branch2&frm=IPPUsrGrpBranchAsg")
        ...
        '     "});" & vbCrLf & _
        '"$(""#txtBranchCode"").blur(function() {" & vbCrLf & _
        '"var hidBranch = document.getElementById(""hid2"").value;" & vbCrLf & _
        '"if(hidBranch == """")" & vbCrLf & _
        '"{" & vbCrLf & _
        '"$(""#txtBranchCode"").val("""");" & vbCrLf & _
        ' "}" & vbCrLf & _
        '"});" & vbCrLf
      ...
      "<!--" & vbCrLf & _
        ...
        Session("typeaheadIPPBranchAsg") = typeahead
    End Sub
