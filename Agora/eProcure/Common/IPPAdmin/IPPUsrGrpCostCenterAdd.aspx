<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IPPUsrGrpCostCenterAdd.aspx.vb" Inherits="eProcure.IPPUsrGrpCostCenterAdd" smartNavigation="False" %>
...
<HTML>
	<HEAD>
		...
		<% Response.Write(Session("WheelScript"))%>
		 <% Response.write(Session("typeaheadIPPCCAdd")) %>
		...
		function Reset(){
			...
			oform.txtCCCode.value="";
			oform.txtCCDesc.value="";
		}
			...
			<table class="alltable" id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">         
	            <tr>
					<td class="header"><strong>
                        <asp:Label ID="lbltitle" runat="server" Text="Assign Cost Center"></asp:Label></strong></td>
				</tr>	       
				<%--<tr>
					<td class="emptycol" colspan="2">
						<table class="alltable" id="Table4" cellspacing="0" cellpadding="0" border="0" width="100%">--%>
							<tr>
								<td class="tableheader" colspan="3">&nbsp;Select Cost Center</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="tablecol">&nbsp;<strong>Cost Center Code</strong>&nbsp;:&nbsp;
									<asp:textbox id="txtCCCode" runat="server"  CssClass="txtbox"></asp:textbox></td>								
									<td class="tablecol" >&nbsp;<strong>Description</strong>&nbsp;&nbsp;&nbsp;:&nbsp;
									<asp:textbox id="txtCCDesc" runat="server"  CssClass="txtbox"></asp:textbox></td>
				...
				<tr>
					...
					<asp:datagrid id="dgUser" runat="server">
							<Columns>
								...
								<asp:BoundColumn DataField="CC_CC_CODE" SortExpression="CC_CC_CODE" HeaderText="Cost Center">
