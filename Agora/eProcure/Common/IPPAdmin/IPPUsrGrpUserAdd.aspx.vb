...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objIPP.getIPPUserGroupUserList(Common.Parse(HttpContext.Current.Session("CompanyID")), Common.Parse(txtUserID.Text), Common.Parse(txtUserName.Text), Common.Parse(txtUserDeptID.Text), ViewState("UserGroup"))
        ...
        Try
            ...
            For Each dgItem In dgUser.Items
                ...
                If chkItem.Checked Then
                    strUserID = dgItem.Cells(1).Text
                    strSQL = "INSERT INTO ipp_usrgrp_user (IUU_GRP_INDEX,IUU_USER_ID) " & _
                        "VALUES('" & ViewState("UserGroup") & "','" & Common.Parse(strUserID) & "') "
    ...
    Sub PopulateTypeAhead()
        ...
        Dim typeahead1 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=User&frm=IPPUsrGrpUserAdd&idx=" & ViewState("UserGroup") & "&btn=UserID")
        Dim typeahead2 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=User&frm=IPPUsrGrpUserAdd&idx=" & ViewState("UserGroup") & "&btn=UserName")
        Dim typeahead3 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=User&frm=IPPUsrGrpUserAdd&idx=" & ViewState("UserGroup") & "&btn=UserBranchCode")


        content &= "$(""#txtUserID"").autocomplete(""" & typeahead1 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
         "});" & vbCrLf & _
        "$(""#txtUserName"").autocomplete(""" & typeahead2 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
          "});" & vbCrLf & _
        "$(""#txtUserDeptID"").autocomplete(""" & typeahead3 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
        "});" & vbCrLf
      ...
      "<!--" & vbCrLf & _
        ...
        Session("typeaheadIPPUserAdd") = typeahead
    End Sub
