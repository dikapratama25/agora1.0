<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IPPUsrGrpUserAsg.aspx.vb" Inherits="eProcure.IPPUsrGrpUserAsg" smartNavigation="False" %>
...
<HTML>
	<HEAD>
		...
		<% Response.Write(Session("WheelScript"))%>
		 <% Response.write(Session("typeaheadIPPUserAsg")) %>
        ...
        <%  Response.Write(Session("w_SearchUser_tabs"))%>
            ...
            <tr>
				...
				<td class="EmptyCol" colspan="5" >
					...
					Text="Step 1: Create, delete or modify User Group.<br/> Step 2: Assign Branch to the User Group.<br/> Step 3: Assign Cost Center to the User Group.<br/><b>=></b>Step 4: Assign User to the User Group."></asp:label>
					...
					<td class="emptycol" colspan="2">
						<table class="alltable" id="Table4" cellspacing="0" cellpadding="0" border="0" width="100%">--%>
							...
							<tr>
								...
								<td class="tablecol" colspan="4"><asp:textbox id="txtUserGroup" runat="server" CssClass="txtbox"></asp:textbox></td>
							</tr>
							<tr>
			...
			<br/>
				<tr>
					<td class="emptycol" colspan="2"><asp:datagrid id="dgUser" runat="server">
							<Columns>
								...
								<asp:BoundColumn DataField="IUU_USER_ID" SortExpression="IUU_USER_ID" HeaderText="User ID"  ItemStyle-VerticalAlign="Top">
									<HeaderStyle Width="13%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="UM_USER_NAME" SortExpression="UM_USER_NAME" HeaderText="User Name"  ItemStyle-VerticalAlign="Top">
									<HeaderStyle Width="13%"></HeaderStyle>
								</asp:BoundColumn>
				...
				<tr runat="server" style="height: 25px">
					<td align="center" >
						...
						Text="# For Deletion: If no User ID/User Group is specified, the selected User ID will be removed from the all User Group."></asp:label>
                        </div>
					</td>
				</tr>
