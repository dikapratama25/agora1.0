...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objIPP.GetIPPUserGroupUser(Common.Parse(Common.parseNull(hid1.Value)), Common.Parse(Common.parseNull(hid2.Value)), Common.Parse(Common.parseNull(txtUserName.Text)))
    ...
    Private Sub dgUser_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgUser.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Dim lblUserGroup As Label = e.Item.Cells(2).FindControl("lblUserGroup")
            Dim val As String = e.Item.Cells(4).Text

            ds = objIPP.GetIPPUserGroupUser2(Common.Parse(Common.parseNull(hid1.Value)), Common.Parse(Common.parseNull(val)))
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Else
            ...
            strFileName = dDispatcher.direct("IPPAdmin", "IPPUsrGrpUserAdd.aspx", "pageid=" & strPageId & "&grpno=" & hid1.Value)
    ...
    Private Sub cmdDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        For Each dgItem In dgUser.Items
            ...
            If chkItem.Checked Then
                ...
                If objIPP.DelIPPUserGroupUser(hid1.Value, dgItem.Cells(1).Text) = False Then
                    Exit For
                End If
        ...
        If Session("CompanyID").ToString.ToUpper = "PAMB" Then
            Session("w_SearchUser_tabs") = "<div class=""t_entity""><ul>" &
               "<li><div class=""space""></div></li>" &
                 ...
                 "<li><div class=""space""></div></li>" &
                 "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("IPPAdmin", "IPPUsrGrpUserAsg.aspx", "pageid=" & strPageId) & """><span>User Assignment</span></a></li>" &
                 "<li><div class=""space""></div></li>" &
                 "</ul><div></div></div>"
        Else
            Session("w_SearchUser_tabs") = "<div class=""t_entity""><ul>" &
    ...
    Sub PopulateTypeAhead()
        ...
        Dim typeahead1 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=UserGroup&frm=IPPUsrGrpUserAsg")
        Dim typeahead2 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=User&frm=IPPUsrGrpUserAsg")
        Dim typeahead3 As String = dDispatcher.direct("Initial", "TypeAhead.aspx", "from=User&frm=IPPUsrGrpUserAsg&btn=UserName")
        ...
        "$(""#txtUserGroup"").val("""");" & vbCrLf & _
         "}" & vbCrLf & _
        "});" & vbCrLf & _
        "$(""#txtUserID"").autocomplete(""" & typeahead2 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
        "}).result(function(event, data, formatted) {" & vbCrLf & _
            ...
            "$(""#hid2"").val(data[1]);" & vbCrLf & _
             "});" & vbCrLf & _
        "$(""#txtUserID"").blur(function() {" & vbCrLf & _
        "var hidUserID = document.getElementById(""hid2"").value;" & vbCrLf & _
        "if(hidUserID == """")" & vbCrLf & _
        "{" & vbCrLf & _
        "$(""#txtUserID"").val("""");" & vbCrLf & _
         "}" & vbCrLf & _
        "});" & vbCrLf & _
        "$(""#txtUserName"").autocomplete(""" & typeahead3 & """, {" & vbCrLf & _
        "width: 200," & vbCrLf & _
        "scroll: true," & vbCrLf & _
        "selectFirst: false" & vbCrLf & _
             "});" & vbCrLf & _
        "$(""#txtUserName"").blur(function() {" & vbCrLf & _
        "var hidUserName = document.getElementById(""hid2"").value;" & vbCrLf & _
        "if(hidUserName == """")" & vbCrLf & _
        "{" & vbCrLf & _
        "$(""#txtUserName"").val("""");" & vbCrLf & _
         "}" & vbCrLf & _
        "});" & vbCrLf
      ...
      "<!--" & vbCrLf & _
        ...
        Session("typeaheadIPPUserAsg") = typeahead
    End Sub
