...
#End Region
    ...
    Private Sub cmdSend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSend.Click
        ...
        m.MailTo = ConfigurationManager.AppSettings("EmailToHubAdmin")
        m.Subject = "Error found in eHub"
        m.Body = Session("ErrMsg") & Session("innerExceptionMsg")
        m.SendMail()
        Common.NetMsgbox(Me, "Email has been send.", "../Dashboard/AllDashBoard.aspx")
    End Sub
End Class
