<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Header.aspx.vb" Inherits="eProcure.Header" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		...
		<div style="height:140px; width:100%;" class="hd_bg">
            <div style="width:230px; float: left; margin: 2px 10px;">
                <asp:image id="Image1" runat="server" height="140" width="177" style="margin:0px;"></asp:image>
