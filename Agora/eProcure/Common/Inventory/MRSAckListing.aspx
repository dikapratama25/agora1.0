...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MRSAckListing.aspx.vb" Inherits="eProcure.MRSAckListing" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>MRSAckListing</title>
		...
		<script runat="server">
            ...
            Dim IssueStartCalendar As String = "<A style=""CURSOR: hand"" onclick=""window.open('" & dDispatcher.direct("Calendar", "viewCalendar.aspx", "TextBox=txt_issuestartdate") & "','cal','width=190,height=165,left=270,top=180');""><IMG src=" & dDispatcher.direct("Plugins/Images", "i_calendar2.gif") & "></A>"
            Dim IssueEndCalendar As String = "<A onclick=""window.open('" & dDispatcher.direct("Calendar", "viewCalendar.aspx", "TextBox=txt_issueenddate") & "','cal','width=190,height=165,left=270,top=180')""><IMG style=""CURSOR: hand"" src=" & dDispatcher.direct("Plugins/Images", "i_calendar2.gif") & "></A>"
		...
		<!--		
		    $(document).ready(function(){
                $('#cmdMassAck').click(function() {
                    ...
                    {  
                        document.getElementById("cmdMassAck").style.display= "none";
                        return true;
                    }             
                });   
            });
		    ...
		    function Reset(){
                ...
                oform.txt_issuestartdate.value=oform.hidIssueDateS.value;
                oform.txt_issueenddate.value=oform.hidIssueDateE.value;
		    }
...
<body class="body">
    ...
    <%  Response.Write(Session("w_MRSAckListing_tabs"))%>
        <table class="alltable" id="Tab1" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
                <td class="emptycol"  colspan="4">
	                <asp:label id="lblAction" runat="server"  CssClass="lblInfo"
	                        Text="Fill in the search criteria and click Search button to list the relevant MRS."
	                ></asp:label>
		    ...
		    <tr>
				...
				<td class="tableCOL">
				    <asp:textbox id="txt_startdate" width ="100px" runat="server" CssClass="txtbox" contentEditable="false" ></asp:textbox><% Response.Write(StartCalendar)%>
				    <asp:requiredfieldvalidator id="rfv_txt_startdate" runat="server" ErrorMessage="Start Date is required."
				...
				<td class="tableCOL">
				    ...
				    <asp:requiredfieldvalidator id="rfv_txt_enddate" runat="server" ErrorMessage="End Date is required."
			...
			<tr>
				<td class="tableCOL" style="width: 156px"><strong>Issued Start Date :</strong></td>
				<td class="tableCOL">
				    <asp:textbox id="txt_issuestartdate" width ="100px" runat="server" CssClass="txtbox" contentEditable="false" ></asp:textbox><% Response.Write(IssueStartCalendar)%></td>
				<td class="tableCOL"><strong>Issued End Date :</strong>
				<input id="hidIssueDateS" style="width: 32px; HEIGHT: 22px" type="hidden" size="1" name="hidIssueDateS"
							runat="server"/></td>
				<td class="tableCOL">
				    <asp:textbox id="txt_issueenddate" width ="100px" runat="server" CssClass="txtbox" contentEditable="false" ></asp:textbox><% Response.Write(IssueEndCalendar)%>
					<asp:comparevalidator id="CompareValidator2" runat="server" Display="None" Operator="GreaterThanEqual" Type="Date" ControlToValidate="txt_issueenddate" ControlToCompare="txt_issuestartdate" ErrorMessage="Issued End Date must greater than or equal to Issued Start Date">*</asp:comparevalidator>&nbsp;
            ...
            <td class="emptycol" colspan="6">
                <asp:datagrid id="dtgItem" runat="server" OnSortCommand="SortCommand_Click" OnPageIndexChanged="MyDataGrid_Page" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundColumn SortExpression="IRSM_IRS_APPROVED_DATE" DataField="IRSM_IRS_APPROVED_DATE" HeaderText="MRS Issued Date">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </asp:BoundColumn>
			...
			<tr>
				<td class="emptycol" colspan="4"><asp:button id="cmdMassAck" runat="server" Width="147px" CssClass="button" Text="Mass Acknowledge"></asp:button>&nbsp;
				</td>
			</tr>
        </table>
