...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MRSListing.aspx.vb" Inherits="eProcure.MRSListing" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>MRSListing</title>
		...
		function checkStatus(checked)
		{
			...
			oform.chkNew.checked=checked;
			oform.chkIssued.checked=checked;
			//oform.chkParIssued.checked=checked;
			oform.chkAck.checked=checked;
			oform.chkAutoAck.checked=checked;
		...
		{
			checkChildG(id,"dtgMRSList_ctl02_chkAll","chkSelection");
		}
	...
	<body onload="document.forms[0].txtMRSNo.focus();">
		<form id="Form1" method="post" runat="server">
 		<%  Response.Write(Session("w_MRSListing_tabs"))%>
              ...
              <tr>
				...
				<tr>
					...
					<td class="tablecol" width="20%" ><strong><asp:Label ID="Label1" runat="server" Text="Issue To :"></asp:Label></strong></td>
					<td class="Tableinput" width="34%" colspan="2"><asp:textbox id="txtIssueTo" runat="server" CssClass="txtbox"></asp:textbox></td>
					<td class="tablecol" width="15%"></td>
				</tr>
				<tr>
					<td class="tablecol" width="23%" >&nbsp;<strong><asp:Label ID="Label4" runat="server" Text="Department :"></asp:Label></strong></td>
					<td class="Tableinput" width="20%">
						<asp:textbox id="txtDept" runat="server" CssClass="txtbox"></asp:textbox></td>
				    <td class="tablecol" width="12%"></td>
					<td class="tablecol" width="20%" ><strong><asp:Label ID="Label5" runat="server" Text="Account Code :"></asp:Label></strong></td>
				...
				<tr>
					...
					<td	class="Tableinput"><asp:textbox id="txtIssueDateFr" runat="server" Width="80px" CssClass="txtbox" contentEditable="false" ></asp:textbox><a onclick="popCalendar('txtIssueDateFr');" href="javascript:;"><%Response.Write(CalPicture) %></a><input id="hidIssueDateS" style="width: 32px; HEIGHT: 22px" type="hidden" size="1" name="hidIssueDateS"
				...
				<tr>
					<td class="tableCOL" >&nbsp;<strong>MRS Status :</strong></td>
					<td class="Tableinput" colspan="4"><asp:checkbox id="chkNew" Text="New" Runat="server"></asp:checkbox>
					    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:checkbox id="chkIssued" Text="Issued" Runat="server"></asp:checkbox>
					    &nbsp;&nbsp;<asp:checkbox id="chkParIssued" Text="Partial Issued" Runat="server" Visible="false"></asp:checkbox>
					    &nbsp;<asp:checkbox id="chkAck" Text="Acknowledged" Runat="server"></asp:checkbox></td>
				    <td class="tablecol" colspan="3" align="right"></td>
				</tr>
				<tr>
					<td class="tableCOL" ></td>
					<td class="Tableinput" colspan="3"><asp:checkbox id="chkAutoAck" Text="Auto-Acknowledged" Runat="server"></asp:checkbox>
				    ...
				    <td class="tablecol" colspan="4" align="right"><asp:button id="cmdSearch" runat="server" CssClass="button" Text="Search"></asp:button>&nbsp;
							...
							<tr>
								<td colspan="5"><asp:datagrid id="dtgMRSList" runat="server" OnSortCommand="SortCommand_Click">
										<Columns>
											...
											<asp:TemplateColumn SortExpression="IRD_IR_NO" HeaderText="IR Number">
