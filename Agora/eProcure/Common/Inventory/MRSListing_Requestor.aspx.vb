...
Public Class MRSListing_Requestor
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objInv.GetReqMRSList(txtMRSNo.Text, txtAccCode.Text, txtIssueTo.Text, txtDept.Text, txtDateFr.Text, txtDateTo.Text, txtIssueDateFr.Text, txtIssueDateTo.Text, aryRemarks)
    ...
    Private Sub dtgMRSList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgMRSList.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            lnkMRSNo.NavigateUrl = dDispatcher.direct("Inventory", "MRSDetail.aspx", "caller=MRSListing_Requestor&pageid=" & strPageId & "&index=" & dv("IRSM_IRS_INDEX") & "&MRSNo=" & dv("IRSM_IRS_NO"))
            ...
            If Not IsDBNull(dv("IRD_IR_NO")) Then
                ...
                lnkIRNo.NavigateUrl = dDispatcher.direct("Inventory", "InventoryReqInfo.aspx", "caller=MRSListing_Requestor&pageid=" & strPageId & "&IRNo=" & dv("IRD_IR_NO"))
