...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReturnInwardAckDetail.aspx.vb" Inherits="eProcure.ReturnInwardAckDetail" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Return Inward Ack Detail</title>
	...
	<body class="body" runat="server">
        ...
        <%  Response.Write(Session("w_ReturnInwardAckDetail_tabs"))%>
            <TABLE class="alltable" id="TABLE2" cellSpacing="0" cellPadding="0" border="0" style="width: 100%">
                ...
                <tr >
				    <td class="tablecol" width="8%" align="left" style="height: 19px">&nbsp;<strong><asp:label id="Label9" runat="server" >RI No</asp:label></strong>&nbsp;:</td>
				    <td class="tablecol" width="10%" style="height: 19px"><asp:label id="lblRINo" runat="server" Width="100%"></asp:label></td>
				    <td class="tablecol" align="left" style="height: 19px">&nbsp;<strong><asp:label id="Label1" runat="server" >Status</asp:label></strong>&nbsp;:</td>
				    <td class="tablecol" style="height: 19px"><asp:label id="lblStatus" runat="server" Width="100%"></asp:label></td>
		    ...
		    <table class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0">		 				
				...
				<TR>
					<TD class="emptycol" colSpan="2"><asp:button id="cmdAck" runat="server" Width="100px" CssClass="button" Text="Acknowledge"></asp:button>&nbsp;&nbsp;&nbsp;<asp:button id="cmdRej" runat="server" Width="100px" CssClass="button" Text="Reject"></asp:button>&nbsp;&nbsp;&nbsp;
					</TD>
				</TR>	
				<TR>
