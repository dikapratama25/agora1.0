...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReturnInwardAckListing.aspx.vb" Inherits="eProcure.ReturnInwardAckListing" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Return Inward Ack Listing</title>
	...
	<body class="body" runat="server">
        ...
        <%  Response.Write(Session("w_ReturnInwardAckListing_tabs"))%>
               <TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0" width="100%">
				...
				<TR>
	                <TD colSpan="6">
		                <asp:label id="lblAction" runat="server"  CssClass="lblInfo" Text="Fill in the search criteria and click Search button to list the relevant RI. Click the RI No. to go to raise Return Inward page."></asp:label>
	                </TD>
                </TR>
                <tr>
				...
				<TR >
					<TD class="tableCOL" width="15%" >&nbsp;<STRONG>RI No.</STRONG> :</td>
					<td class="tableCOL" width= "25%" ><asp:textbox id="txtRINo" runat="server" CssClass="TXTBOX"></asp:textbox></TD>
					<td class="tableCOL" width= "5%" ></td>
					<td class="tableCOL" width= "15%" >	<STRONG>MRS Number&nbsp;</STRONG>: </td>
					<td class="tableCOL" width= "25%" ><asp:textbox id="txtMRSNo" runat="server" width="200px" CssClass="TXTBOX"></asp:textbox></td>
			...
			<TABLE class="AllTable" id="tblSearchResult" width="100%" cellSpacing="0" cellPadding="0"
				...
				<TR>
					<td colspan="5" style="width: 100%; height: 214px;">
                        ...
                        <asp:Button ID="cmdPrint" runat="server" CssClass="button" Text="Print" Visible="False" /></TD>
				</TR>
			</TABLE>
		</form>
	</body>
