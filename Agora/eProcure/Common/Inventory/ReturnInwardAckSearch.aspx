...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReturnInwardAckSearch.aspx.vb" Inherits="eProcure.ReturnInwardAckSearch" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Return Inward Ack Search</title>
	...
	<body class="body" runat="server">
        ...
        <%  Response.Write(Session("w_ReturnInwardAckSearch_tabs"))%>
               <TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0" width="100%">
				...
				<TR width="100%">
					...
					<td class="TableInput" colspan="4"><asp:checkbox id="chkAcknowledged" Text="Acknowledged" Runat="server"></asp:checkbox>
					    &nbsp;&nbsp;&nbsp;&nbsp;<asp:checkbox id="chkRejected" Text="Rejected" Runat="server"></asp:checkbox></td></td>
		            <td class="tableCOL" width= "15%" align="right">
