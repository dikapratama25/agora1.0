...
Public Class ReturnInwardAckSearch
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        If strStatus = "" Then
            strStatus = RIStatus.Acknowledged & "," & _
             RIStatus.Rejected
        End If

        ds = objInventory.RIList(txtRINo.Text, txtMRSNo.Text, txt_startdate.Text, txt_enddate.Text, strStatus, "sk")
    ...
    Private Sub dtg_RIList_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_RIList.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            lnkRINo.NavigateUrl = dDispatcher.direct("Inventory", "ReturnInwardDetail.aspx", "pageid=" & strPageId & "&RI_NO=" & dv("IRIM_RI_NO") & "&frm=RIAckSearch")

            Dim lnkMRSNo As HyperLink
            lnkMRSNo = e.Item.Cells(EnumRIView.icMRSNo).FindControl("lnkMRSNo")
            lnkMRSNo.Text = dv("IRIM_IR_NO")

            lnkMRSNo.NavigateUrl = dDispatcher.direct("Inventory", "MRSDetail.aspx", "pageid=" & strPageId & "&MRSNo=" & dv("IRIM_IR_NO") & "&caller=RIAckSearch")
        End If
    End Sub
    ...
    Private Sub GenerateTab()
        ...
        End If
        Session("w_ReturnInwardAckSearch_tabs") = "<div class=""t_entity""><ul>" & _
