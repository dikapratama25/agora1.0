...
Public Class SearchMRS_AO
    ...
    Protected Overrides Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("urlreferer") = "SearchMRS_AO"
    End Sub
    ...
    Private Sub GenerateTab()
        ...
        Session("w_MRS_AO_tabs") = "<div class=""t_entity""><ul>" & _
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objInv.GetMRSApprList(txtMRSNumber.Text, txtAccCode.Text, txtReqName.Text, txtIssue.Text, txtDepartment.Text, txt_startdate.Text, txt_enddate.Text)
    ...
    Private Sub dtgItem_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgItem.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            lnkCode.NavigateUrl = "" & dDispatcher.direct("Inventory", "MRSApprDetail.aspx", "PageID=" & strPageId & "&MRSNo=" & dv("IRSM_IRS_NO") & "&index=" & dv("IRSM_IRS_INDEX") & "")
    ...
    Private Sub cmdMassApp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMassApp.Click
        ...
        objInv.MassApprovalMRS(strAryMRSIndex, strMsg)
