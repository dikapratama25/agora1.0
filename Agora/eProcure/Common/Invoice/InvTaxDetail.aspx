<%@ Page Language="vb" AutoEventWireup="false" Codebehind="InvTaxDetail.aspx.vb" Inherits="eProcure.InvTaxDetail" %>
...
<html>
	<head>
        ...
        function focusControl(total, invtax, shipamt, taxamt, grandtotal) 
		{					
        ...
        function calculateGrandTotal(total, invtax, shipamt, taxamt, grandtotal)
	    {	
	        Form1.hid1.value = total;		
		    Form1.hid2.value = invtax;
		    Form1.hid3.value = shipamt;
				...
				<tr>
					<td><asp:datagrid id="dtg_invDetail" runat="server" AutoGenerateColumns="False">
							<Columns>
								...
								<asp:BoundColumn HeaderText="SST Rate">
				...
				<tr>
				    <td>
				        <table cellspacing="0" cellpadding="0" border="0" runat="server">
				            <tr>
				                <td>&nbsp;<strong>Vendor Invoice No.<asp:label id="Label5" runat="server" CssClass="errormsg">*</asp:label> :</strong></td>
				                <td><asp:textbox id="txtRef" Runat="server" Width="250px" MaxLength="30" CssClass="txtbox"></asp:textbox></td>
				            </tr> 
				            <tr>
							...
							<tr valign="top">
								...
								<td><input class="button" id="File1" style="WIDTH: 400px; HEIGHT: 18px" type="file" size="17"
											name="uploadedFile" runat="server"/>&nbsp;<asp:button id="cmdUpload" runat="server" CssClass="button" CausesValidation="False" Text="Upload"></asp:button><asp:label id="lblFile" Visible="False" Runat="server"></asp:label></td>
							</tr>
							<tr valign="top">
							...
							<tr valign="top">
							    ...
							    <td style="HEIGHT: 19px"><asp:panel id="pnlAttach" runat="server"></asp:panel></td>
							</tr> 
							<tr>
								<td class="emptycol" colspan="2" style="height: 19px"></td>
							</tr>
