...
Public Class Add_PO_Catalogue_Item
...
#End Region
    ...
    Private Sub cmd_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Save.Click
        ...
        If Not Session("ProdList") Is Nothing Then
            If Session("ProdList")(0).ToString <> "&nbsp;" Then
        ...
        If validateGrid() Then 'Jules 2018.08.01
            ...
            For Each dgItemFF In dtg_freeform.Items
                ...
                If txt_desc.Text <> "" Then
                    aryProdCode.Add(New String() {"", txt_desc.Text, ddl_uom.SelectedItem.Text, "0", "0"}) 'Zulham Oct 2, 2013
                End If
            Next
            'Else
            'cmd_Save.Attributes.Add("onclick", "return CheckAtLeastOne('chkSelection','Save');")
