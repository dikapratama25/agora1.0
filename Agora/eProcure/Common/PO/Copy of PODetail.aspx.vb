...
Imports eProcure.Component_Ext
Imports System.Data
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents hidDivPRNo As System.Web.UI.HtmlControls.HtmlGenericControl
    ...
    Public Enum EnumPOListStk
        ...
        icRecQty = 10 '9
        icRejQty = 11 '10
        icPast1stMthUsage = 12
        icPast2ndMthUsage = 13
        icPast3rdMthUsage = 14
        icPast3MthAve = 15
        icCurrMthQty = 16
        icNext1stMthQty = 17
        icNext2ndMthQty = 18
...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Dim tempdate As Date = objDb.GetVal("SELECT POM_SUBMIT_DATE FROM PO_MSTR WHERE POM_PO_NO = '" & Request(Trim("PO_No")) & "' AND POM_B_COY_ID = '" & Request(Trim("BCoyID")) & "'")
        ...
        If Session("PRNo") <> "" Then
            Me.hidDivPRNo.Style("display") = "inline"
    ...
    Private Sub dtg_POListStock_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_POListStock.ItemCreated
        ...
        If e.Item.ItemType = ListItemType.Header Then
            ...
            For i = 0 To aryTempList.Count - 1
                strMonth = objpo_ext.get_month(CInt(aryTempList(i)(0)))
                If i = 0 Then
                    e.Item.Cells(EnumPOListStk.icNext1stMthQty).Text = strMonth & " Usage"
                ElseIf i = 1 Then
                    e.Item.Cells(EnumPOListStk.icNext2ndMthQty).Text = strMonth & " Usage"
                ElseIf i = 2 Then
                    e.Item.Cells(EnumPOListStk.icNext3rdMthQty).Text = strMonth & " Usage"
                End If
            Next
        End If
    ...
    Private Sub dtg_doc_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_doc.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Common.parseNull(dv("GM_GRN_NO")) <> "" Then
                ...
                e.Item.Cells(EnumDoc.icGRNNo).Text = "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewGRN.aspx", "pageid=" & strPageId & "&GRNNo=" & Common.parseNull(dv("GM_GRN_NO")) & "&PONo=" & Request(Trim("PO_No")) & "&DONo=" & dv("DOM_DO_NO") & "&side=v&BCoyID=" & Common.parseNull(dv("GM_B_COY_ID"))) & "')""><font color=#0000ff>" & _
                Common.parseNull(dv("GM_GRN_NO")) & "</font></A>"
            Else
    ...
    Private Sub PreviewPO()
        ...
        Try
            ...
            myConnectionString = System.Configuration.ConfigurationSettings.AppSettings.Get("Path") & ";" '"server=10.228.201.110;UID=root;pwd=managedservices;database=eProcure;"
