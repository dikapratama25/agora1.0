...
Public Class POApprDetail
    ...
    Public Enum EnumPO
        ...
        'Jules 2018.05.15 - PAMB Scrum 2 & 3
        icGift
        icFundType
        icPersonCode
        icProjectCode
...
#End Region
    ...
    Private Sub renderPRDetail()
        ...
        If ViewState("GstPO") = True Then
            AddRow(intSubTotalCol, "SST Amount", CDbl(Format(dblTotalGst, "#0.00")), True)
    ...
    Sub AddRow(ByVal intCell As Integer, ByVal strLabel As String, ByVal dblTotal As Double, ByVal blnShowGST As Boolean)
        ...
        row.Cells(0).ColumnSpan = intCell - 13 '8 'Jules 2018.05.16 - PAMB Scrum 3
        row.Cells(1).ColumnSpan = intCell - 2 '3 '2 'Jules 2018.05.16 - PAMB Scrum 3
        Dim Asset As New PurchaseOrder_Buyer
        If Asset.AssetGroupMstr = False Then
            row.Cells(1).ColumnSpan = intCell - 3 '4 'Jules 2018.05.16 - PAMB Scrum 3
        End If
        row.Cells(1).Text = strLabel
        row.Cells(1).Font.Bold = True
        row.Cells(1).HorizontalAlign = HorizontalAlign.Right
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        If ViewState("BCM") <= 0 Then
            Me.dtgPOList.Columns(EnumPO.icBCM).Visible = False
        Else
            Me.dtgPOList.Columns(EnumPO.icBCM).Visible = True
        End If
    ...
    Private Sub dtgPOList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPOList.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Common.parseNull(dv("POD_B_CATEGORY_CODE")) = "" Then
                e.Item.Cells(EnumPO.icCategoryCode).Text = "N/A"
            End If
            'End modification.
        End If
    End Sub
    ...
    Private Sub cmdUpload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUpload.Click
        If File1.Value <> "" Then
            ...
            'Jules 2018.09.13 - Increase length from 46 t0 200.
