<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="POBatchUpload.aspx.vb" Inherits="eProcure.POBatchUpload" %>

<!DOCTYPE HTML PUBLIC "-//W3C//Dtd HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>PO Batch Upload</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table class="alltable" id="Table5" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="header"><asp:label id="Label3" runat="server" CssClass="header">Batch Upload of PO Details</asp:label></td>
				</tr>
				...
				<tr>
					...
					<asp:label id="lblTitle" runat="server">PO Info.</asp:label>
					</td>
				</tr>
			
			    <tr>
			        <td class="tablecol" style="width:35%;" colspan="3"><strong>&nbsp;
			        <asp:Label ID="Label1" runat="server" Text="PO No. :"  CssClass="lbl" Font-Bold="True"></asp:Label></strong>&nbsp;
			        <asp:Label ID="lblPONo" runat="server"  CssClass="lbl"></asp:Label>
			        </td>				  
				  
                </tr>
                 <tr>
				    <td class="tablecol" colspan="3"><strong>&nbsp;
				    <asp:Label ID="Label2" runat="server" Text="Vendor :" CssClass="lbl" Font-Bold="True" ></asp:Label></strong>&nbsp;
		...
		<table class="alltable" id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="tableheader" colspan="3">&nbsp;<asp:label id="lblHeader" runat="server">PO Detail Upload</asp:label></td>							
				</tr>
				...
				<tr>
					<td class="emptycol" colspan="2">Download PO Detail Upload template - 
						<asp:linkbutton id="cmdDownloadTemplate" Runat="server">POTemplate.xls [43KB]</asp:linkbutton>
					</td>
				</tr>	
				...
				<tr>
					<td><asp:button id="cmdUpload" runat="server" CssClass="button" Text="Upload"></asp:button>
                        <asp:Button ID="cmdClose" runat="server" CssClass="button" Text="Close" /></td>
				</tr>				
				<tr>
					<td class="emptycol">&nbsp;&nbsp;</td>
				</tr>
				...
				<tr>
				    <td class="emptycol" colspan="2"><ul class="errormsg" id="vldsum" runat="server"></ul>
				</td>
				</tr>
			</table>
