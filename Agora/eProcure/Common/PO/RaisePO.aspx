<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RaisePO.aspx.vb" Inherits="eProcure.RaisePO" %>
...
//				var i, j, strControl, cntCtl;
				...
				//ctlAmount.value = ParseFloat(Quantity * UnitPrice).toFixed(2);
				//decAmt = (Quantity * UnitPrice).toFixed(2);	
				ctlAmount.value = (Quantity * UnitPrice).toFixed(2);	
							
				ctlTax = document.getElementById(tax);
				//2015-06-22: CH: Rounding issue (Prod issue)
				//ctlTax.value = ParseFloat(ctlAmount.value  * TaxPercent / 100).toFixed(2);
			...
			function calculateGrandTotal()
			{
                ...
                var exRate = 0;
                exRate = Form1.hidExchangeRate.value;

                if (exRate > 0) {
                    var sGrandtotalMYR = eval(sGrandtotal * exRate);
                    Form1.hidBaseAmt.value = sGrandtotalMYR;
                    document.getElementById('sGrandTotalMYR').innerHTML = addCommas(sGrandtotalMYR.toFixed(2), 2);                    
                }
                else {
                    Form1.hidBaseAmt.value = sGrandtotal;
                    document.getElementById('sGrandTotalMYR').innerHTML = addCommas(sGrandtotal.toFixed(2), 2);
                }
                //End modification.				
			}
			...
			<table class="alltable" id="table3" cellspacing="0" cellpadding="0" border="0">
					...
					<td><asp:datagrid id="dtgShopping" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="dtgShopping_Page"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="GSTRate" HeaderText="SST Rate">
									...
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
									<ItemTemplate>
									    <asp:DropDownList id="cboGSTRate" Width="100px" CssClass="ddl" Runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboGSTRate_SelectedIndexChanged"></asp:DropDownList>
				...
				<tr><td style="width:100%;"><div style="float:right;">
				    <table>
				        ...
				        <tr><td id="GSTLabel" runat="server" style="text-align:right; font-weight:bold;">SST Amount :</td><td><div id="sTax" name="sTax" style="text-align:right;" >0.00</div></td></tr>
                        ...
                        <%--Jules 2018.10.19 - U00069--%>
                        <tr id="trBaseAmt" runat="server" visible="false"><td style="text-align:right; font-weight:bold;">Base Amount (MYR) :</td><td><div id="sGrandTotalMYR" style="text-align:right; font-weight:bold;">0.00</div></td></tr>
                        <%--End modification--%>
				    </table>
				</div></td></tr>
				<tr>
					<td class="emptycol" style="HEIGHT: 5px"><input class="txtbox" id="hidTotal" style="WIDTH: 43px; HEIGHT: 18px" type="hidden" size="1"
                            ...
                            <input id="hidExchangeRate" type="hidden" name="hidExchangeRate" value="0" runat="server" /> <%--Jules 2018.10.19 - U00069--%>
                            <input id="hidBaseAmt" type="hidden" name="hidBaseAmt" value="0" runat="server" /> <%--Jules 2018.10.19 - U00069--%>
					</td>
				</tr>
			</table>
