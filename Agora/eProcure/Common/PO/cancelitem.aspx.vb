...
#End Region
    ...
    Public Enum EnumPOCanl
        ...
        icWaranty = 7 '6
        icOrderQty = 8 '7 '5
        icOrderQty1 = 9 '8 '6 'if without this column, the Receive Qty will not appear
        icRecQty = 10 '9 '7
        icRejQty = 11 '10 '8
        icOutstanding = 12 '11 '9
        icQtyCanl = 13 '12 '10
        icRemarks = 14 '13 '11
    End Enum
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'cmd_submit.Attributes.Add("onClick", "return ")

        Dim Asset As New PurchaseOrder_Buyer
        If Asset.AssetGroupMstr = False Then
            dtg_POList.Columns(EnumPOCanl.icAssetCode).Visible = False
        End If
    End Sub
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        'End If
        Me.dtg_POList.Columns(7).Visible = True
    End Function
    ...
    Sub cancel_qty(ByVal meth As String)
        ...
        Dim strBACan As String
        'Joon (13 Sept 2011) - Check whether the BA is allow to access the PO Cancellation Request screen
        If Session("POType") = "AllPO" Then
            strBACan = objCompany.GetBACanPOMode(Session("CompanyId"))
            If strBACan = "N" Then
                If objUsers.IsBuyerAdmin(Session("UserID")) Then
                    Common.NetMsgbox(Me, "'Buyer Admin Cancel POs' option is currently set to Off.", MsgBoxStyle.Information)
                    Exit Sub
                End If
            End If
        End If
        ...
        ElseIf meth = 2 Then 'CLICK "QTY TO CANCEL"
            ...
            For Each dgitem In Me.dtg_POList.Items
                ...
                If meth = 1 Then
                dtr("qty_cancel") = dgitem.Cells(10).Text
        ...
        'End If
        If Not objpo.update_cancellation(ds, CR_NO, strCancelType, strMsg) Then
            ViewState("cr_no") = CR_NO
    ...
    Private Sub GenerateTab()
        ...
        If Session("POType") = "AllPO" Then
            Session("w_POCancel_tabs") = "<div class=""t_entity""><ul>" &
                                    ...
                                    "<li><div class=""space""></div></li>" &
                                    "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("PO", "POViewB2Cancel.aspx", "type=Listing&pageid=" & strPageId) & """><span>Purchase Order Cancellation</span></a></li>" &
                                    "<li><div class=""space""></div></li>" &
                                    "</ul><div></div></div>"
        Else
