...
Public Class Add_Buyer_Catalogue_Item
    ...
    Protected WithEvents vldsum As System.Web.UI.HtmlControls.HtmlGenericControl 'Jules 2018.08.01
...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        If cboCatalogueBuyer.SelectedItem.Text <> "---Select---" Then
            ds = objBUYERCAT.getBuyerCatItems1(cboCatalogueBuyer.SelectedItem.Value, strCommodity, txt_item_desc.Text, True, txtItemCode.Text, aryItemType)
        ...
        Else
            ...
            Else
                strItem = "0"
            End If
            ds = objBUYERCAT.getBuyerCatItemsByCombo1(strItem, strCommodity, txt_item_desc.Text, True, txtItemCode.Text, aryItemType)
    ...
    Private Sub cmd_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Save.Click
        ...
        If rd1.SelectedValue = "FREE" Then
            If validateGrid() Then 'Jules 2018.08.01
                For Each dgItemFF In dtg_freeform.Items
                    ...
                    If txt_desc.Text <> "" Then
                        ...
                        aryProdCode.Add(New String() {"", txt_desc.Text, ddl_uom.SelectedItem.Text, txtCommodityFree.Text, ""})
                    End If
                Next
            End If
        Else
            ...
            For i = 0 To dtg_Cat.Items.Count() - 1
                ...
                If chkItem.Checked Then
                    If i = 0 Then 'keep track of the 1st row that is checked
                        aryProdCode.Add(New String() {dtg_Cat.Items(i).Cells(2).Text, "", "", "", ""})
        ...
        If vldsum.InnerHtml = "" Then 'Jules 2018.08.01
    ...
    Private Sub dtg_freeform_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_freeform.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            'Jules 2018.08.07
            Dim txt_commodity As TextBox
            txt_commodity = e.Item.FindControl("txtCommodityFree")
            If txt_commodity.Text = "" AndAlso HttpContext.Current.Session("CompanyId").ToString.ToLower = "pamb" Then
                Dim objDB As New EAD.DBCom
                txt_commodity.Text = objDB.GetVal("SELECT CT_NAME FROM COMMODITY_TYPE WHERE CT_ID = '1'")
            End If
            'End modification.
        End If
    End Sub
    ...
    Private Function validateGrid() As Boolean
        ...
        For Each dgItemFF In dtg_freeform.Items
            ...
            txt_desc = dgItemFF.FindControl("txt_desc")
            If txt_desc.Text <> "" Then
                If txt_desc.Text.Contains("<") OrElse txt_desc.Text.Contains(">") Then
                    vldsum.InnerHtml &= "<li>[Line " & itemCount & "]</li> Item Name contains invalid character '<' or '>'.<br>"
                End If
            End If
        Next
