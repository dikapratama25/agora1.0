...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            dsApprovalList = objPR.getAppovalList("A", CDbl(ViewState("prcost")), "PR", True)
    ...
    Private Function Bindgrid() As String
        ...
        'Zulham 03082018 - PAMB
        dsAO = objPR.getAOList(cboApproval.SelectedItem.Value, "PR")
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        If cboApproval.SelectedItem.Value <> "" Then
            ...
            cmdSubmit.Visible = False
            intMsg = objPR.submitPR(ViewState("prid"), PRStatus.Submitted, Nothing, dtAO, ViewState("msg"), "true", False)
            Select Case intMsg
                ...
                Case WheelMsgNum.Save
                    ...
                    blnExceed = objBudget.checkBCM(ViewState("prid"), dtBCMChk, strBCM)

                    Dim strConfirm As String
                    If ViewState("msg") = "1" And blnExceed = True Then
                        strConfirm = "PR value is more than the Operating Budget Amount."
                    Else
                        strConfirm = ""
                    End If

                    If Session("urlreferer") = "BuyerCatSearch" Then
                        Common.NetMsgbox(Me, "Purchase Request Number " & ViewState("prid") & " has been submitted." & """ & vbCrLf & """ & strConfirm & "", dDispatcher.direct("Search", "BuyerCatSearch.aspx", "pageid=" & strPageId))
                    ElseIf Session("urlreferer") = "ConCatSearch" Then
                        Common.NetMsgbox(Me, "Purchase Request Number " & ViewState("prid") & " has been submitted." & """& vbCrLf & """ & strConfirm & "", dDispatcher.direct("Search", "ContractCatSearch.aspx", "pageid=" & strPageId))
                    ElseIf Session("urlreferer") = "PRAll" Then
                        Common.NetMsgbox(Me, "Purchase Request Number " & ViewState("prid") & " has been submitted." & """& vbCrLf & """ & strConfirm & "", dDispatcher.direct("PR", "SearchPR_All.aspx", "pageid=" & strPageId))
                    ElseIf Session("urlreferer") = "Dashboard" Then
                        Common.NetMsgbox(Me, "Purchase Request Number " & ViewState("prid") & " has been submitted." & """& vbCrLf & """ & strConfirm & "", dDispatcher.direct("Dashboard", "AllDashBoard.aspx", "pageid=" & strPageId))
                    End If
            End Select
