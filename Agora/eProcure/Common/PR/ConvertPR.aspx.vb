...
#End Region
    ...
    Private Sub cmdPO_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdPO.Click
        ...
        If multiplePR = True Then
            strPO = objPR.CreatePO(strPRNo, ViewState("PRIndex"), "", strSqlAry, Session("UserId"), strPRItem, True, PRList)
        Else
            strPO = objPR.CreatePO(strPRNo, ViewState("PRIndex"), "", strSqlAry, Session("UserId"), strPRItem, False)
        End If
    ...
    Private Sub cmdRFQ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdRFQ.Click
        ...
        If multiplePR = True Then
            strRFQ = objPR.CreateRFQMulti(strPRNo, ViewState("PRIndex"), "", strSqlAry, Session("UserId"), strPRItem, True, PRList)
        Else
            strRFQ = objPR.CreateRFQ(strPRNo, ViewState("PRIndex"), "", strSqlAry, Session("UserId"), strPRItem)
        End If
