<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PRApprDetail.aspx.vb" Inherits="eProcure.PRApprDetail" %>
				...
				<tr>
					<td><asp:datagrid id="dtgPRList" runat="server" AutoGenerateColumns="False">
							<Columns>
								...
								<asp:BoundColumn HeaderText="SST Tax Code (Purchase) (L6)">
									<HeaderStyle Width="3%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
