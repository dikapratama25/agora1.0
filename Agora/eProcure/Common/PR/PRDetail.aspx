<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PRDetail.aspx.vb" Inherits="eProcure.PRDetail" %>
				    ...
				    <table class="alltable" id="Table12" border="0" width="100%" cellspacing="0" cellpadding="0" >
				        <tr>
							...
							<Columns>
								...
								<asp:BoundColumn DataField="PRD_GST_INPUT_TAX_CODE" HeaderText="SST Tax Code (Purchase) (L6)">
									<HeaderStyle Width="3%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
