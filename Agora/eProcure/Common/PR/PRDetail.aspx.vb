...
Public Class PRDetail
    ...
    Dim dblTmpSubTotal, dblTmpGrandTotal As Double
...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf Session("urlreferer") = "POViewB2" Or Request.QueryString("caller") = "POViewB2" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("PO", "POViewB2.aspx", "pageid=" & strPageId)

        ElseIf Request.QueryString("caller") = "SearchPO_AO" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
        ...
        ElseIf Request.QueryString("caller") = "SearchPO_All" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("PO", "SearchPO_All.aspx", "pageid=" & strPageId)

        ElseIf Request.QueryString("caller") = "ConvertPRList" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("PR", "ConvertPRListing.aspx", "pageid=" & strPageId)

        ElseIf Request.QueryString("caller") = "ConvertPR" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = True ' yAP 2012-Aug14: Case1643
            lblRemarkCR.Visible = True ' yAP 2012-Aug14: Case1643
            txtRemarkCR.Visible = True ' yAP 2012-Aug14: Case1643
            lblerrormsg.Visible = True ' yAP 2012-Aug14: Case1643
            lnkBack.NavigateUrl = dDispatcher.direct("PR", "ConvertPR.aspx", "pageid=" & strPageId)

        ElseIf Session("urlreferer") = "POViewTrx" Or Request.QueryString("caller") = "POViewTrx" Then 'PO screen
        ...
        ElseIf Session("urlreferer") = "POViewB2Cancel" Or Request.QueryString("caller") = "POViewB2Cancel" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("PO", "POViewB2Cancel.aspx", "type=Listing&pageid=" & strPageId)
        ...
        ElseIf Session("urlreferer") = "PRCancelByPO" Then  'Purchase Request Cancellation screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("PR", "SearchPR_Cancellation_ByPO.aspx", "pageid=" & strPageId)
        ...
        End If
        If Request.QueryString("Frm") = "transtracking2" Then
            lblAction.Visible = False
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
            lblerrormsg.Visible = False
            lnkBack.NavigateUrl = dDispatcher.direct("Tracking", "TransTracking.aspx", "coytype=buyer&pageid=" & strPageId)
        End If
        If Request.QueryString("caller") = "InvTracking" Then
            lblAction.Visible = False
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
        ...
        If Left(Request.QueryString("status"), 4) = "Held" Or Left(Me.lblStatus.Text, 4) = "Held" Then
            Me.cmdDup.Visible = False
        End If
        'Yik Foong
        ...
        '2015/10/30 CH: Add-on button to view PR pdf
        Me.cmdPreview.Attributes.Add("onclick", "PopWindow('" & dDispatcher.direct("Report", "PreviewPR.aspx", "PR_No=" & Request(Trim("PRNO")) & "&PR_Index=" & Request(Trim("index"))) & "')")
    ...
    Private Sub renderPRHeader()
        ...
        If dtHeader.Rows.Count > 0 Then
            Session(dtCreateDte) = Common.parseNull(dtHeader.Rows(0)("PRM_CREATED_DATE"))
            ...
            If Common.parseNull(dtHeader.Rows(0)("PRM_URGENT")) = "1" Then
                lblPR.Text = Session("lblPRNo") + " (Urgent)"
            Else
                lblPR.Text = Session("lblPRNo")
            End If
            ...
            If Session("urlreferer") = "PRAll" Then
                ...
                Select Case Common.parseNull(dtHeader.Rows(0)("STATUS_DESC"))
                    Case "Draft"
                        Me.lblStatus.Text = "Draft"
                    Case "Submitted", "Pending Approval"
                        Me.lblStatus.Text = "Submitted for approval"
                    Case "Held By"
                        Me.lblStatus.Text = "Held By " & Common.parseNull(dtHeader.Rows(0)("NAME"))
                    Case "Approved"
                        Me.lblStatus.Text = "Approved by management"
                    Case "Accepted"
                        Me.lblStatus.Text = "Accepted by vendor"
                    Case "Cancelled", "Cancelled By"
                        'strFixRole = objUserRole.get_UserFixedRoleByParameter(Common.parseNull(dtHeader.Rows(0)("PRM_COY_ID")), Common.parseNull(dtHeader.Rows(0)("PRM_STATUS_CHANGED_BY")))
                        'Me.lblStatus.Text = "Cancelled by " & strFixRole
                        Me.lblStatus.Text = "Cancelled By (" & Common.parseNull(dtHeader.Rows(0)("NAME")) & ")"
                ...
                If Request.QueryString("status") = "Sourcing" Then
                    Me.lblStatus.Text = "Sourcing"
                End If
            ElseIf Session("urlreferer") = "PRCancelByPO" Then
                Select Case Common.parseNull(dtHeader.Rows(0)("STATUS_DESC"))
                    Case "Cancelled By"
                        'strFixRole = objUserRole.get_UserFixedRoleByParameter(Common.parseNull(dtHeader.Rows(0)("PRM_COY_ID")), Common.parseNull(dtHeader.Rows(0)("PRM_STATUS_CHANGED_BY")))
                        'Me.lblStatus.Text = "Cancelled by " & strFixRole
            ...
            ElseIf Session("urlreferer") = "PRRej" Then
                Select Case Common.parseNull(dtHeader.Rows(0)("STATUS_DESC"))
                    Case "Rejected By"
                        Me.lblStatus.Text = "Rejected by management"
                    Case "Converted to PO"
                        Me.lblStatus.Text = "Converted to PO"
                    Case "Approved"
                        Me.lblStatus.Text = "Approved by management"
                    Case Else
                        Me.lblStatus.Text = Request.QueryString("status")
            ...
            If ViewState("GstPR") = True And Not IsDBNull(dtHeader.Rows(0)("PRM_PR_DATE")) Then
    ...
    Private Sub renderPRDetail()
        ...
        If dsAllInfo.Tables("PR_DETAILS").Rows.Count > 0 Then
            Session("SubTotal") = CDbl(Format(dblSubTotal, "#0.00"))
            Session("TotalGst") = CDbl(Format(dblTotalGst, "#0.00"))
            Session("GrandTotal") = CDbl(Format(dblGrandTotal, "#0.00"))
    ...
    Sub AddRow(ByVal strLabel As String, ByVal dblTotal As Double)
        ...
        row.Cells(0).ColumnSpan = intCell - 6
        row.Cells(1).ColumnSpan = intCell - 10 ' 6 '4 '3 'Jules 2018.05.16 - PAMB Scrum 3
        Dim Asset As New PurchaseOrder_Buyer
        If Asset.AssetGroupMstr = False Then
            row.Cells(1).ColumnSpan = intCell - 11 '7 '5 'Jules 2018.05.16 - PAMB Scrum 3
        End If
        row.Cells(1).Text = strLabel
        row.Cells(1).Font.Bold = True
        row.Cells(1).HorizontalAlign = HorizontalAlign.Right
    ...
    Private Sub dtgPRList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPRList.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            'Jules 2018.07.31 
            If Common.parseNull(dv("PRD_B_CATEGORY_CODE")) = "" Then
                e.Item.Cells(EnumPR.icCategoryCode).Text = "N/A"
            End If
            'End modification.
        End If
    End Sub
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        If txtRemarkCR.Text = "" Then
            ...
            AddRow("Sub Total", Session("SubTotal"))
            If ViewState("GstPR") = True Then
                AddRow("SST Amount", Session("TotalGst"))
            Else
                AddRow("Tax", Session("TotalGst"))
            End If
            AddRow("Grand Total ", Session("GrandTotal"))
        Else
            Dim objPR As New PurchaseReq2
            Dim strMsg As String

            If Request.QueryString("caller") = "ConvertPR" Then 'PO screen

                Dim strDoc_No As String = objDB.GetVal("SELECT IFNULL(CAST(GROUP_CONCAT(PRD_CONVERT_TO_DOC) AS CHAR(2000)),'') AS PRD_CONVERT_TO_DOC FROM PR_DETAILS WHERE PRD_COY_ID = '" & HttpContext.Current.Session("CompanyId") & "' AND PRD_PR_NO = '" & Session("lblPRNo") & "' AND PRD_CONVERT_TO_DOC IS NOT NULL ")
                If Common.parseNull(strDoc_No) <> "" Then
                    'Common.NetMsgbox(Me, "Cancellation is not allowed, some line items have been converted.", MsgBoxStyle.Information)
                    Common.NetMsgbox(Me, objGlobal.GetErrorMessage("00335"), MsgBoxStyle.Information)
                    Exit Sub
                End If

                strMsg = objPR.CancelPR(Session("lblPRNo"), ViewState("PRIndex"), ViewState("CurrentAppSeq"), txtRemarkCR.Text, True)
                Common.NetMsgbox(Me, strMsg, dDispatcher.direct("PR", "ConvertPR.aspx", "pageid=" & strPageId), MsgBoxStyle.Exclamation)
            Else
                strMsg = objPR.CancelPR(Session("lblPRNo"), ViewState("PRIndex"), ViewState("CurrentAppSeq"), txtRemarkCR.Text)
    ...
    Private Function checkMandatory(ByRef strMsg As String) As Boolean
        ...
        If Session(dtCreateDte) < CDate("01-12-2011") Then
            strMsg = "Cannot duplicate from PR that was created before 1 Dec 2011."
        Else
            If intBCM > 0 Then
    ...
    Private Sub cmdDup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDup.Click
        ...
        If checkMandatory(strMsg1) Then
            strMsg = objPR.DuplicatePR1(Session("lblPRNo"), ViewState("PRIndex"))
            If strMsg <> "" Then
    ...
    Private Sub GenerateTab()
        ...
        End If
        If Session("urlreferer") = "PRAll" Or Session("urlreferer") = "Dashboard" Then
            If Request.QueryString("Frm") = "transtracking2" Then
                Session("w_SearchPR_tabs") = ""

            ElseIf Request.QueryString("caller") = "SearchPO_AO" Then
            ...
            ElseIf Request.QueryString("caller") = "SearchPO_All" Then
                Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                         "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Session("urlreferer") = "PRCancel" Then
            Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                        "<li><div class=""space""></div></li>" & _
                                        "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("PR", "RaisePR.aspx", "pageid=" & strPageId & "&type=new&mode=bc&frm=bc") & """><span>Purchase Request</span></a></li>" & _
                                        "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Session("urlreferer") = "POViewB2" Or Request.QueryString("caller") = "POViewB2" Then
            If Request.QueryString("Frm") = "transtracking2" Then
                Session("w_SearchPR_tabs") = ""
            Else
                'Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                ...
                Dim _compType = objDB.GetVal("SELECT CM_COY_TYPE FROM sso.company_mstr WHERE cm_coy_id = '" & HttpContext.Current.Session("CompanyId") & "'")
                ...
                If Session("POType") = "AllPO" Then
                    Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                            ...
                                            "</ul><div></div></div>"
                Else
                    If showFFPO.ToString.ToUpper = "Y" And (_userRole.ToString.ToUpper.Contains("PURCHASING MANAGER") Or _userRole.ToString.ToUpper = "PURCHASING OFFICER") And _compType.ToString.ToUpper = "BUYER" Then
                        Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                             "<li><div class=""space""></div></li>" & _
                             "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("PO", "POViewB2.aspx", "pageid=" & strPageId) & """><span>Purchase Order</span></a></li>" & _
                             "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Request.QueryString("caller") = "ConvertPRList" Then
            Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                         "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Request.QueryString("caller") = "ConvertPR" Then
            Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                         "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Session("urlreferer") = "POViewTrx" Or Request.QueryString("caller") = "POViewTrx" Then
                Session("w_SearchPR_tabs") = ""

        ElseIf Session("urlreferer") = "POViewB2Cancel" Or Request.QueryString("caller") = "POViewB2Cancel" Then
            'Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
            '                            "<li><div class=""space""></div></li>" & _
        ...
        ElseIf Request.QueryString("caller") = "InvTracking" Then
            Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                    "<li><div class=""space""></div></li>" & _
                                        ...
                                        "<li><div class=""space""></div></li>" & _
                                        "</ul><div></div></div>"
        ElseIf Request.QueryString("Frm") = "transtracking2" Then
                Session("w_SearchPR_tabs") = ""
            End If
    ...
    'Private Sub dtgPRList_Page(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dtgPRList.PageIndexChanged
