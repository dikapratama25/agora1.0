<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PRDetailTransTracking.aspx.vb" Inherits="eProcure.PRDetailTransTracking" %>
				    ...
				    <table class="alltable" id="Table12" border="0" width="100%" cellSpacing="0" cellPadding="0" >
				        <TR>
							...
							<Columns>
								...
								<asp:BoundColumn DataField="PRD_GST_INPUT_TAX_CODE" HeaderText="SST Tax Code (Purchase)">
									<HeaderStyle Width="3%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
