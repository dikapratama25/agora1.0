...
Public Class SearchPR_Cancellation_ByPO
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("urlreferer") = "PRCancelByPO"
    ...
    Private Sub GenerateTab()
        ...
        "<li><div class=""space""></div></li>" & _
                     ...
                     "<li><div class=""space""></div></li>" & _
                     "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("PR", "SearchPR_Cancellation_ByPO.aspx", "pageid=" & strPageId) & """><span>Cancelled PR</span></a></li>" & _
                     "<li><div class=""space""></div></li>" & _
                     "</ul><div></div></div>"
    End Sub
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objPR.SearchPRCancelListByPO(txtPRNo.Text, txtDateFr.Text, txtDateTo.Text, "NonCont")
