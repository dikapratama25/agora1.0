<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ViewPR_All.aspx.vb" Inherits="eProcure.ViewPR_All" %>
								...
								<td class="tablecol" colspan="6">
									<TABLE class="AllTable" id="Table2" cellSpacing="0" cellPadding="0" border="0" runat="server" width="100%">
										...
										<tr class="tablecol">
										    ...
										    <td class="tablecol" ><asp:checkbox id="chkHold" Text="Held" Runat="server"></asp:checkbox></td>
