<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProductDetail.aspx.vb" Inherits="eProcure.PProductDetail" %>
					...
					<td class="emptycol">
						<table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<tr valign="top">
								...
								<td class="TableInput" id="tdImage" width="25%" rowspan="13" runat="server">&nbsp;
						    ...
						    <tr valign="top">
								<td class="tablecol" >&nbsp;<STRONG>Account Code </STRONG>
									:</td>
								<td class="TableInput"><asp:label id="lblAccCode" runat="server"></asp:label></td>
						</tr>
						    <tr valign="top">
								<td class="tablecol" >&nbsp;<STRONG>Category Code </STRONG>
									:</td>
	            ...
	            <table class="AllTable" id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0">
					...
					<td><asp:datagrid id="dtgContractInfo" runat="server" AutoGenerateColumns="false"  BorderStyle="None">
							<Columns>
								...
								<asp:BoundColumn DataField="GST_RATE"  HeaderText="SST Rate"  HeaderStyle-HorizontalAlign="Right">
									<HeaderStyle Width="11%" Font-Bold="true"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
							</Columns>
