...
Public Class Add_Catalogue_Item
    ...
    Private Function validateInputs() As Boolean
        ...
        For b = 0 To dtg_freeform.Items.Count() - 1
            ...
            If txt_desc.Text <> "" And txt_desc.Text.Length > 500 Then
                ...
                'Jules 2018.08.01
            ElseIf txt_desc.Text <> "" And (txt_desc.Text.Contains("<") OrElse txt_desc.Text.Contains(">")) Then
                strMsg &= "<ul type='disc'><li>Item " & Val(b) + 1 & " Item Description contains invalid character '<' or '>'.</li></ul>"
                check = False
            End If
        Next
