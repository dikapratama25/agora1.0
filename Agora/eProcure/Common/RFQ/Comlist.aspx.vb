...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pPage As Integer = -1, Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objrfq.rfq_venlist(list_no, rfq_name, rfq_id)
    ...
    Private Sub dtg_vendor_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_vendor.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If (Not IsDBNull(Common.parseNull(dv("CM_EMAIL")))) And Common.parseNull(Common.parseNull(dv("CM_EMAIL"))) <> "" Then
                If stradds = "" Then
                    stradds = "" & Common.parseNull(dv("CM_EMAIL")) & ""
                Else
                    stradds = stradds & "<br>" & Common.parseNull(dv("CM_EMAIL")) & ""
                End If
            End If

            If (Not IsDBNull(dv("CM_PHONE"))) And Common.parseNull(dv("CM_PHONE")) <> "" Then
                If stradds = "" Then
                    stradds = "Tel: " & Common.parseNull(dv("CM_PHONE")) & ""
                Else
                    stradds = stradds & "<br>Tel: " & Common.parseNull(dv("CM_PHONE")) & ""
                End If
            End If
