...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Rfq_num = Request.QueryString("Rfq_num")
        lblTitle.Text = "RFQ"
        ...
        Select Case strType
            Case "1"
                ...
                Dim objPR As New PR
                Dim dsItem As New DataSet
                dsItem = objPR.getRPVendorItemList(Rfq_num)
                lbl_Rfq_num.Text = "RFQ Number : <b>" & Rfq_num & "</b> has been successfully created"
                'lnkBack.NavigateUrl = "RFQ_List.aspx?rfq_no=" & Rfq_num & "&edit=1"
                lnkBack.NavigateUrl = dDispatcher.direct("RFQ", "RFQ_List.aspx", "rfq_no=" & Rfq_num & "&edit=1&pageid=" & strPageId & " ")
            Case "2"
                ...
                lbl_Rfq_num.Text = "RFQ Number : <b>" & Rfq_num & "</b> has already been sent to the selected Vendors."
            ...
            Case "3"
                ...
                lnkBack.NavigateUrl = dDispatcher.direct("RFQ", "RFQ_List.aspx", "rfq_no=" & Request(Trim("rfq_no")) & "&edit=2&pageid=" & strPageId & " ")
            ...
            Case "4"
                ...
                trHeader.Visible = False
                trItem.Visible = False
                lbl_Rfq_num.Text = "The RFQ Number : <b>" & Rfq_num & "</b> has been successfully sent to the selected buyers. "
            ...
            Case "5"
                ...
                trHeader.Visible = False
                trItem.Visible = False
                lbl_Rfq_num.Text = "The RFQ Number : <b>" & Rfq_num & "</b> fail to update.Please contact your administrator."
                'lnkBack.NavigateUrl = "VendorRFQList.aspx?rfq_no=" & Request(Trim("rfq_no")) & "&edit=2"
                lnkBack.NavigateUrl = dDispatcher.direct("RFQ", "RFQ_List.aspx", "rfq_no=" & Request(Trim("rfq_no")) & "&edit=2&pageid=" & strPageId & " ")
            Case "6"
                ' trExistHeader.Visible = False
