...
#End Region
    ...
    Private Function ConstructColPrice(ByVal lRFQId As Long, ByVal sCompanyId As String, ByVal iLineNo As Int16, ByRef strPrice As String, ByVal intCoId As Integer) As String
        ...
        sCol = "<td id=""r" & iLineNo & "_c" & intCoId & """ style=""text-align:right; "" >" & strPrice & "</td><input name=""RRD_GST" & iLineNo & """ id=""RRD_GST" & iLineNo & """ type=""hidden"" value=""" & dt.Rows(0)("RRD_GST") & """ />"
    ...
    Private Function ConstructTableRank() As String
        ...
        ConstructTableRank = "<table border=""1"" class=""grid"" style=""margin-top:10px; width:100%; border-collapse:collapse; line-height:20px; "" >" & _
                                ...
                                "<tr class=""GridHeader"" style=""font-weight:bold;""><td width=""4%"" ></td><td width=""5%"">Rank</td><td width=""56%"">Vendor Name</td><td width=""20%"">Quotation Number</td><td width=""15%"" style=""text-align:right;"">Total Value</td></tr>" & _
                                sTable & _
