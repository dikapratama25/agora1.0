...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If strFrm = "RFQSearch" Or strFrm = "RFQ_Outstg_List" Or strFrm = "RFQ_List" Or strFrm = "RFQ_Quote" Or strFrm = "VendorRFQListExp" Or strFrm = "ConvertPRList" Then
            GenerateTab()
        End If
        ...
        If objDb.Exist("SELECT '*' FROM RFQ_MSTR WHERE RM_RFQ_ID = '" & ViewState("RFQ_ID") & "' AND (RM_DEL_CODE <> '' AND RM_DEL_CODE IS NOT NULL)") Then
            tr_delterm.Style("display") = ""
            dtg_rfqdetail.Columns(RfqEnum.ItemType).Visible = True
        Else
            tr_delterm.Style("display") = "none"
            dtg_rfqdetail.Columns(RfqEnum.ItemType).Visible = False
        End If
        ...
        Me.lbl_dt.Text = objread.del_code
    ...
    Private Sub dtg_rfqdetail_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_rfqdetail.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If IsDBNull(dv("RD_ITEM_TYPE")) Then
                e.Item.Cells(RfqEnum.Warranty).Text = ""
            Else
                If dv("RD_ITEM_TYPE") = "SP" Then
                    e.Item.Cells(RfqEnum.ItemType).Text = "Spot"
                ElseIf dv("RD_ITEM_TYPE") = "ST" Then
                    e.Item.Cells(RfqEnum.ItemType).Text = "Stock"
                ElseIf dv("RD_ITEM_TYPE") = "MI" Then
                    e.Item.Cells(RfqEnum.ItemType).Text = "MRO"
                End If
            End If
        End If
    End Sub
    ...
    Private Sub GenerateTab()
        ...
        ElseIf strFrm = "VendorRFQListExp" Then
            Session("w_RFQ_tabs") = "<div class=""t_entity""><ul>" & _
            "<li><div class=""space""></div></li>" & _
                                "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("RFQ", "VendorRFQList.aspx", "pageid=" & strPageId) & """><span>Outstanding RFQ</span></a></li>" & _
                                "<li><div class=""space""></div></li>" & _
                                "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("RFQ", "VendorRFQListExp.aspx", "pageid=" & strPageId) & """><span>Expired / Rejected RFQ</span></a></li>" & _
                                "<li><div class=""space""></div></li>" & _
