<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UnitPriceMaster.aspx.vb" Inherits="eProcure.UnitPriceQuotation" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>UnitPriceQuotation</title>
	...
	<body class="body">
		<form id="Form1" method="post" runat="server">
			...
			<tr>
				<td class="tablecol" colspan="4" style="height: 19px; border:0; width:20%;" ><strong><asp:label id="lblItem" runat="server">Selected Item:</asp:label></strong>&nbsp;
				<asp:label id="lblItemName" runat="server"></asp:label><asp:Label ID="hidItem" runat="server" Visible="false"></asp:Label>
				<asp:Label ID="hiditemline" runat="server" Visible="false"></asp:Label></td>						
			</tr>
			<tr>
