...
Public Class VendorList
    ...
    'Protected WithEvents lbl_List_No As System.Web.UI.WebControls.Label
    'Protected WithEvents lbl_no As System.Web.UI.WebControls.Label
    ...
    'Dim bindcreaterfq2 As New Create_RFQ2
...
#End Region
    ...
    Private Sub dtg_vendor_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dtg_vendor.PageIndexChanged
        ...
        If txtVendorName.Text = "" And ViewState("search") <> "" Then
            Bindgrid(True, ViewState("search"), True)
        Else
            Bindgrid(True, txtVendorName.Text)
        End If
