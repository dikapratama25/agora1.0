...
Public Class PreviewCR
    ...
    Private Sub PreviewCR()
        ...
        Try
            ...
            localreport.ReportPath = dispatcher.direct("Report", "PreviewCR-FTN.rdlc", "Report") ' appPath & "PO\PreviewCR-FTN.rdlc"
            ...
            Dim strFileName As String = "CR_" & Request.QueryString(Trim("cr_no")) & "_" & Session("CompanyID") & "_" & Session("UserId") & ".pdf"
