...
Partial Public Class PreviewRIAckListing1
    ...
    Private Sub PreviewRIAckListing()
        ...
        Try
            ...
            With cmd
                ...
                .CommandText = "SELECT IRIM_RI_NO, IRIM_RI_DATE, SUM(IRID_QTY) AS TQTY, IRIM_RI_REJECT_REMARK, " &
                     ...
                     "WHERE M.IRIM_RI_COY_ID = D.IRID_RI_COY_ID AND M.IRIM_RI_NO = D.IRID_RI_NO AND M.IRIM_RI_COY_ID =@prmCoyID AND IRIM_RI_STATUS='1'"
                ...
                If strStartDate <> "" Then
                    .CommandText &= " AND IRIM_RI_DATE >=" & Common.ConvertDate(strStartDate) & ""
                End If

                If strEndDate <> "" Then
                    .CommandText &= " AND IRIM_RI_DATE <=" & Common.ConvertDate(strEndDate & " 23:59:59.000") & ""
                End If
                ...
                .CommandText &= " GROUP BY IRIM_RI_NO, IRIM_RI_DATE, IRIM_RI_STATUS, IRIM_IR_NO "
            ...
            Dim rptDataSource As New Microsoft.Reporting.WebForms.ReportDataSource("PreviewRIAckListing_DataSetRIAckListing", ds.Tables(0))
            Dim localreport As New LocalReport
            localreport.DataSources.Clear()
            localreport.DataSources.Add(rptDataSource)
            'localreport.ReportPath = appPath & "Report\PreviewWriteOffDetail.rdlc"
            localreport.ReportPath = dispatcher.direct("Report", "PreviewRIAckListing.rdlc", "Report")
