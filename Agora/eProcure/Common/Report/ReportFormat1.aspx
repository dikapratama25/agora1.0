<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReportFormat1.aspx.vb" Inherits="eProcure.ReportFormat1" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD class="tablecol" colspan="1" width="10%">&nbsp;<STRONG>Report Type						</STRONG>&nbsp;:
					</TD>
				...
				<tr>
					<td colspan="2"><asp:button id="cmdSubmit" runat="server" Text="Submit" CssClass="button"></asp:button>&nbsp;<INPUT class="button" id="cmdClear" type="button" value="Clear" onclick="ValidatorReset();" runat="server"></td>
				</tr>
				<TR>
					<TD colspan="2"><BR>
