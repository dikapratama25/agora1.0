...
#End Region
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        ...
        'crParam.Add("CompanyIDParam", Session("CompanyID")) ' cboCompy.SelectedValue)
        ...
        Select Case UCase(ViewState("type"))
            Case "PR"
                If optPr_Po_No.Checked = True Then
                    strReportName = "PurchaseRequisitionDetailLogByPRPO.rpt"
                Else
                    strReportName = "PurchaseRequisitionDetailLogByPRStatus.rpt"
                End If
        End Select
        ...
        Me.ClientScript.RegisterStartupScript(GetType(ReportFormat11), rndKey.Next.ToString, jscript)
    End Sub
