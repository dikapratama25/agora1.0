<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReportFormat12.aspx.vb" Inherits="eProcure.ReportFormat12" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD class="tablecol" colspan="1" width="10%">&nbsp;<STRONG>
							<asp:label id="Label2" runat="server" Font-Bold="True">End Date</asp:label>
				...
				<TR>
					<TD class="tablecol" colspan="1" width="12%">&nbsp;<STRONG>
						<asp:label id="Label1" runat="server" Font-Bold="True">Report Type</asp:label></STRONG>&nbsp;:
					</TD>
