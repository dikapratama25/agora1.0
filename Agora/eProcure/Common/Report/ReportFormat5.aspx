<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReportFormat5.aspx.vb" Inherits="eProcure.ReportFormat5"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD class="tablecol" width="20%">&nbsp;<STRONG>Currency</STRONG><asp:label id="Label1" runat="server" CssClass="errormsg">*</asp:label><STRONG>&nbsp;</STRONG>:<STRONG>
						</STRONG>
					</TD>
					<TD class="TableInput" width="80%" colSpan="1">&nbsp;
						<asp:dropdownlist id="cboCurrency" runat="server" CssClass="txtbox" Width="128px"></asp:dropdownlist><asp:requiredfieldvalidator id="ValCur" runat="server" ErrorMessage="Currency rate is required." ControlToValidate="cboCurrency"
