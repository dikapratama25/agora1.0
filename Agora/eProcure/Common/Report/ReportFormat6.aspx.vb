...
#End Region
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        ...
        Select Case UCase(viewstate("type"))
            'Case "INVSUMM"
            '    strReportName = "allcompInvoiceSummaryReport2.rpt"
        End Select

        Session("Param") = crParam

        reportURL = "../Report/ReportViewer.aspx?rpt=" & strReportName & "&rptType=" & cboReportType.SelectedIndex
        ...
        Me.ClientScript.RegisterStartupScript(GetType(ReportFormat6), rndKey.Next.ToString, jscript)
    End Sub
    'Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
    '    Dim crParam As New Hashtable
