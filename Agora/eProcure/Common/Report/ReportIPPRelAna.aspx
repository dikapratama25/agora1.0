<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportIPPRelAna.aspx.vb" Inherits="eProcure.ReportIPPRelAna" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html>
	<head>
		<title>ReportIPPRelAna</title>
		...
		<form id="Form1" method="post" runat="server">
			<table class="alltable" id="Table4" cellspacing="0" cellpadding="0" border="0">
				...
				<tr id="tr1" runat="server" style="display:none">
					<td class="tablecol">&nbsp;<strong>Category</strong><strong>&nbsp;</strong>:<strong>
						</strong>
					</td>
					<td class="TableInput" style="HEIGHT: 17px" colspan="1">&nbsp;
						<asp:dropdownlist id="cboEntity" runat="server" CssClass="txtbox" Width="128px">
                        </asp:dropdownlist></td>
				</tr>
				<tr id="tr2" runat="server" style="display:none">
					<td class="tablecol">&nbsp;<strong>GL Code</strong><asp:label id="Label5" runat="server" CssClass="errormsg">*</asp:label><strong>&nbsp;</strong>:
					</td>
					<td class="TableInput" style="HEIGHT: 17px" colspan="1">&nbsp;
						<asp:dropdownlist id="cboGLCode" runat="server" CssClass="txtbox" Width="128px">
                        </asp:dropdownlist><asp:requiredfieldvalidator id="ValGLCode" runat="server" ErrorMessage="GL Code is required." ControlToValidate="cboGLCode"
