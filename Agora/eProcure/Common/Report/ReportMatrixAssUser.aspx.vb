...
Public Class ReportMatrixAssUser
...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ViewState("valUserID") = Request.QueryString("UserID")
            ViewState("valUserName") = Request.QueryString("UserName")
            lblUserName.Text = ViewState("valUserName") 'User Name
            lblUserId.Text = ViewState("valUserID") 'User ID

            'Display data for both list box
            SearchData(ViewState("valUserID"))
            selectedData(ViewState("valUserID"))
    ...
    Public Function selectedData(ByVal val As String)
        ...
        lstBox2.Items.Clear()
        dvSelectlUser = objrpt.BindListBox_ReportMatrixSelectedReportData(val)

        lstBox2.DataSource = dvSelectlUser
        lstBox2.DataTextField = "RM_REPORT_NAME"
        lstBox2.DataValueField = "RM_REPORT_INDEX"
        lstBox2.DataBind()
    ...
    Public Function SearchData(ByVal val As String)
        ...
        lstbox1.Items.Clear()
        dvAvailUser = objrpt.BindListBox_ReportMatrixSearchReportData(val)

        lstbox1.DataSource = dvAvailUser
        lstbox1.DataTextField = "RM_REPORT_NAME"
        lstbox1.DataValueField = "RM_REPORT_INDEX"
        lstbox1.DataBind()
        cmdAdd1.Enabled = True
        cmdAdd2.Enabled = True
    End Function
    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        ...
        objrpt.DelReportMatrixAsg(ViewState("valUserID"), "u")
        For Each li In lstBox2.Items
            objrpt.AddReportMatrixAsg(li.Value, ViewState("valUserID"))
        Next
