...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strRptType = Request.QueryString("type")
        blnPaging = False
    ...
    Private Function Bindgrid(Optional ByVal pPage As Integer = -1, Optional ByVal pSorted As Boolean = False) As String
        ...
        'Jules 2018.08.21 - Get all reports user has access to.
        'If strRptType = "T" Then
        '    ds = objReport.getReportType(Session("CompanyID"), "T")
        'ElseIf strRptType = "O" Then
        '    ds = objReport.getReportType(Session("CompanyID"), "O")
        'Else
