...
Public Class SubDetiNote_GLCodeSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SubDetiNote-GLCodeSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_deptIndex() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSubDetiNote_GLCodeSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubDetiNote_GLCodeSummary = New SubDetiNote_GLCodeSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
