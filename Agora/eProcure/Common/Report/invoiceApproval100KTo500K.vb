...
Public Class invoiceApproval100KTo500K
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoiceApproval100KTo500K.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceApproval100KTo500K
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceApproval100KTo500K = New invoiceApproval100KTo500K
        rpt.Site = Me.Site
        Return rpt
    End Function
