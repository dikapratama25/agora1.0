...
Public Class invoiceApproval20KTo100K
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoiceApproval20KTo100K.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceApproval20KTo100K
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceApproval20KTo100K = New invoiceApproval20KTo100K
        rpt.Site = Me.Site
        Return rpt
    End Function
