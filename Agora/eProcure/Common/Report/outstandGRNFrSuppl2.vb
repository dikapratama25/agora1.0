...
Public Class outstandGRNFrSuppl2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "outstandGRNFrSuppl2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedoutstandGRNFrSuppl2
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outstandGRNFrSuppl2 = New outstandGRNFrSuppl2
        rpt.Site = Me.Site
        Return rpt
    End Function
