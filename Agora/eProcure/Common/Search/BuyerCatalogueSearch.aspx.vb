...
Public Class BuyerCatalogueSearch
    ...
    Private Function Bindgrid(Optional ByVal pPage As Integer = -1, Optional ByVal pSorted As Boolean = False) As String
        ...
        If cboCatalogueBuyer.SelectedItem.Text <> "---Select---" Then
            ds = objBUYERCAT.getBuyerCatItems(cboCatalogueBuyer.SelectedItem.Value, txtItemCode.Text, aryItemType, strCommodity, txtItemName.Text, True, txtVendorName.Text)
        ...
        Else
            ...
            Else
                strItem = "0"
            End If
            ds = objBUYERCAT.getBuyerCatItemsByCombo(strItem, txtItemCode.Text, aryItemType, strCommodity, txtItemName.Text, True, txtVendorName.Text)
    ...
    Private Sub cmdRFQ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdRFQ.Click
        ...
        For i = 0 To dtgItem.Items.Count() - 1
            ...
            If chkItem.Checked Then
                ...
                Dim strPrefer = IIf((dtgItem.Items(i).Cells(EnumList.icPreferCode).Text = "" Or dtgItem.Items(i).Cells(EnumList.icPreferCode).Text = "&nbsp;"), "", dtgItem.Items(i).Cells(EnumList.icPreferCode).Text)
                Dim str1st = IIf((dtgItem.Items(i).Cells(EnumList.ic1stCode).Text = "" Or dtgItem.Items(i).Cells(EnumList.ic1stCode).Text = "&nbsp;"), "", dtgItem.Items(i).Cells(EnumList.ic1stCode).Text)
                Dim str2nd = IIf((dtgItem.Items(i).Cells(EnumList.ic2ndCode).Text = "" Or dtgItem.Items(i).Cells(EnumList.ic2ndCode).Text = "&nbsp;"), "", dtgItem.Items(i).Cells(EnumList.ic2ndCode).Text)
                Dim str3rd = IIf((dtgItem.Items(i).Cells(EnumList.ic3rdCode).Text = "" Or dtgItem.Items(i).Cells(EnumList.ic3rdCode).Text = "&nbsp;"), "", dtgItem.Items(i).Cells(EnumList.ic3rdCode).Text)
