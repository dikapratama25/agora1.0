<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContractCatSearch.aspx.vb" Inherits="eProcure.ContractCatSearch" %>
					...
					<td class="emptycol" colspan="6">
					    <asp:datagrid id="dtgItem" runat="server" OnSortCommand="SortCommand_Click" OnPageIndexChanged="MyDataGrid_Page" AutoGenerateColumns="False">
						    <Columns>
							    ...
							    <asp:BoundColumn DataField="CDI_GST_TAX_CODE" SortExpression="CDI_GST_TAX_CODE" HeaderText="SST Tax Code (Purchase)">
								    <HeaderStyle Width="6%" HorizontalAlign="Left" ></HeaderStyle>
								    <ItemStyle HorizontalAlign="Left"></ItemStyle>
							    </asp:BoundColumn>
