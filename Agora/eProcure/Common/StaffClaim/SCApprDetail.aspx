<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCApprDetail.aspx.vb" Inherits="eProcure.SCApprDetail" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>SCApprDetail</title>
        ...
        {	
	        ...
	        ans=confirm("Are you sure that you want to reject this Staff Claim ?");
	        //alert(ans);
	        //return false;	
	        if (ans){		
	            document.getElementById("cmdRejectSC").style.display= "none";
	            document.getElementById("cmdAppSC").style.display= "none";	
		        return result;
		        }
	        else
	            document.getElementById("cmdRejectSC").style.display= "";
	            document.getElementById("cmdAppSC").style.display= "";
		        return false;
        }
        function confirmApprove(action)
        {	
	        //result=resetSummary(1,0);	
	        ans=confirm("Are you sure that you want to " + action + " this Staff Claim ?");
	        //alert(ans);
	        //return false;	
	        if (ans){		
	            document.getElementById("cmdAppSC").style.display= "none";
	...
	<body ms_positioning="GridLayout">
        ...
        <%  Response.Write(Session("w_Staff_Claim_tabs"))%>
			    ...
			    <tr id="trInfo" runat="server">
				    <td colspan="5">
					    <asp:label id="lblAction" runat="server"  CssClass="lblInfo"
						    Text="Click the Approve SC button to approve the Staff Claim or Reject SC button to reject the Staff Claim."></asp:label>
				    </td>
			    </tr>
			    <tr>
				    <td class="linespacing2" colspan="5" ></td>
			...
			<table class="alltable" id="Table2" cellspacing="0"width="100%"  cellpadding="0" border="0">
			    <tr>
    	    ...
    	    <table class="AllTable" id="tblApproval" cellspacing="0" cellpadding="0" border="0" runat="server">
				...
				<tr id="trButton" runat="server">
					<td colspan="2"><asp:button id="cmdAppSC" runat="server" Width="100px" CssClass="button" Text="Approve SC"></asp:button><asp:button id="cmdRejectSC" runat="server" Width="100px" CssClass="button" Text="Reject SC"></asp:button><input class="button" id="cmdClear" onclick="document.forms(0).txtRemark.value=''" type="button" 
						value="Clear" name="cmdClear" runat="server"/></td>
				</tr>
				<tr id="trMessage" runat="server">
					<td colspan="2"><asp:label id="lblMsg" Runat="server" CssClass="ErrorMsg"></asp:label></td>
				</tr>
				<tr>
					<td class="emptycol" colspan="2"></td>
				</tr>
