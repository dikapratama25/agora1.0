<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCApprovalSetup.aspx.vb" Inherits="eProcure.SCApprovalSetup" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
	<head>
		<title>SCApprovalSetup</title>
	...
	<body onload="" ms_positioning="GridLayout">
        ...
        <%  Response.Write(Session("w_Staff_Claim_tabs"))%>
			...
			<tr>
				...
				<tr>
					<td align="left" colspan="2" >
						<asp:label id="lblAction" runat="server"  CssClass="lblInfo" Text="Please select the approval workflow from the approval list and submit the Staff Claim."></asp:label>
            ...
            <tr>
				...
				<tr valign="top">
					<td class="tablecol" align="left" width="20%" nowrap>&nbsp;<strong>Staff Claim
							No.</strong>&nbsp;:</td>
					<td class="TableInput" width="80%"><asp:label id="lblSC" runat="server" Width="290px"></asp:label></td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top" runat="server" id="trConsolidator" visible="false">
