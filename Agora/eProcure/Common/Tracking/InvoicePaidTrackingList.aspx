<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvoicePaidTrackingList.aspx.vb" Inherits="eProcure.InvoicePaidTrackingList" %>
...
<head>
    <title>Invoice Tracking</title>
		...
		function Reset(){
           ...
           oform.txtDateTo.value = Date.today().toString('dd/MM/yyyy');//currentTime.getDate() + "/" + (currentTime.getMonth() + 1) + "/" + currentTime.getFullYear();
...
oform.txtDateFr.value = Date.today().addMonths(-6).toString('dd/MM/yyyy');
		...
		function validateinput(oSrc, args)
			{
				//debugger;
				if ((Form1.txtDocNo.value != '') || (Form1.txtDateFr.value != '') || (Form1.txtDateTo.value != '') || (Form1.txtVendorName.value != '')) {
			...
			<table class="alltable" id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">				
				...
				<tr>
				    <td colspan="5">
					    ...
					    Text="Fill in the search criteria and click Search button to list the relevant paid Invoice."
					    ></asp:label>
				...
				<tr class="tablecol">
					...
					<td width="25%"><asp:textbox id="txtDocNo" runat="server" MaxLength="50" Width="150px" CssClass="txtbox"></asp:textbox></td>
					<td noWrap width="15%">&nbsp;<strong>Vendor Name</strong> :</td>
					<td width="45%"><asp:textbox id="txtVendorName" runat="server" MaxLength="50" Width="150px" CssClass="txtbox"></asp:textbox></td>
					<td>&nbsp;</td>
				</tr>				
				<tr class="tablecol" >
				    <td width="20%">&nbsp;<strong>Document Type</strong> :</td>
				    <td>
                        <asp:DropDownList ID="ddldocType" CssClass="ddl" Width="150px" runat="server">
                    ...
                    <td><asp:DropDownList ID="ddlCur" CssClass="ddl" Width="150px" runat="server"></asp:DropDownList></td>
                    <td></td>
                 </tr>
                 <tr class="tablecol">
					...
					<td><asp:textbox id="txtDateTo" runat="server" Width="125px" CssClass="txtbox" contentEditable="false" ></asp:textbox><a onclick="popCalendar('txtDateTo');" href="javascript:;"><%response.write(CalImage) %></a>
					</td>
				...
				<tr>
					<td class="emptycol" colspan="5"><asp:datagrid id="dtgInvoice" runat="server" OnSortCommand="SortCommand_Click">
							<Columns>
								...
								<asp:BoundColumn DataField="POM_BUYER_NAME" SortExpression="POM_BUYER_NAME"  readonly="True"    HeaderText="Purchaser">
								...
								<asp:TemplateColumn HeaderText="Approval Remarks">
									<HeaderStyle Width="10%" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left"></HeaderStyle>
									<ItemStyle Wrap="true" HorizontalAlign="Left" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
									<ItemTemplate>
