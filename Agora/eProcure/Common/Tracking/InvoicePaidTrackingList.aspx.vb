...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            App.FillCodeTable(ddlCur, CodeTable.Currency)
    ...
    Function bindgridINV() As String
        ...
        'Zulham 13072018 - PAMB
        ds = objTrac.getInvoiceTracking_NoDocMatch(Common.Parse(txtDocNo.Text.Replace("\", "\\\\")), txtVendorName.Text, "", "", ViewState("status"), ViewState("IPPstatus"), ViewState("invfrom"), ddldocType.SelectedItem.Value, txtDateFr.Text, txtDateTo.Text, , ddlCur.SelectedItem.Value)
    ...
    Private Sub dtgInvoice_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgInvoice.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            lnkDocNo.NavigateUrl = dDispatcher.direct("Tracking", "InvoiceDetails.aspx", "Frm=InvoicePaidTrackingList" & "&pageid=" & strPageId & "&role=" & ViewState("role") & "&INVNO=" & Common.parseNull(dv("IM_INVOICE_NO")) & "&vcomid=" & Common.parseNull(dv("IM_S_COY_ID")) & "&folder=" & Getfoldertype() & "&status=" & Common.parseNull(dv("IM_INVOICE_STATUS")))
            ...
            '' ''strTemp &= "<a href=" & dDispatcher.direct("PO", "PODetail.aspx", "Frm=InvoicePaidTrackingList" & "&caller=buyer" & "&PO_INDEX=" & dv("IM_PO_INDEX") & "&role=" & ViewState("role") & "&PO_NO=" & dv("POM_PO_NO") & "&BCoyID=" & Session("CompanyID") & "&side=other" & "&filetype=2" & "&pageid=" & strPageId) & ">" & dv("POM_PO_NO") & "</a><BR>"
            ...
            ' '' ''strTemp &= "<a href=../GRN/GRNDetails.aspx?Frm=InvoicePaidTrackingList&GRNNo=" & dv("CDM_GRN_NO") & "&BCoyID=" & Session("CompanyID") & "&type=other&pageid=" & strPageId & ">" & dv("CDM_GRN_NO") & "</a><BR>"
            ...
            Select Case cboFolder.SelectedItem.Value 'Selected value will always be 4, ie. paid
                Case "1" ' new
                ...
                Case "4" ' payment
                    ...
                    e.Item.Cells(EnumInv.icBuyer).Visible = False
            ...
            If dv("DOC_TYPE") = "IPP" Then
                e.Item.Cells(EnumInv.icPayTerm).Text = dv("IM_PAYMENT_TERM")
                lnkDocNo.NavigateUrl = dDispatcher.direct("IPP", "IPPApprovalDetail.aspx", "mode=read&pagefrm=paid&DocumentNo=" & dv("IM_INVOICE_NO") & "&index=" & dv("IM_INVOICE_INDEX"))
            ...
            'Zulham 21112018
            Select Case e.Item.Cells(EnumInv.icPayTerm).Text
                Case "IBG"
        ...
        ElseIf e.Item.ItemType = ListItemType.Header Then
            Select Case cboFolder.SelectedItem.Value
                Case "1", "2", "3"
                    e.Item.Cells(EnumInv.icPayTerm).Visible = False
                    e.Item.Cells(EnumInv.icAppDate).Visible = False
                Case "4" 'Will only be this folder
                    e.Item.Cells(EnumInv.icChk).Visible = False
                    e.Item.Cells(EnumInv.icBuyer).Visible = False
                Case "5"
            End Select
        ...
        ElseIf ViewState("role") = "4" Then 'FO & FM role
            ...
            Else
                ...
                "<li><div class=""space""></div></li>" & _
                                    ...
                                    "<li><div class=""space""></div></li>" & _
                                    "<li><a class=""t_entity_btn_selected"" href=""#""><span>Paid Invoice</span></a></li>" & _
                                    "<li><div class=""space""></div></li>" & _
                                    "</ul><div></div></div>"
            End If
            ...
            If blnIPPUserGroup = True Then
                Session("w_InvTracking_tabs") = "<div class=""t_entity""><ul>" & _
                            "<li><div class=""space""></div></li>" & _
                                                ...
                                                "<li><div class=""space""></div></li>" & _
                                                "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("Tracking", "InvoicePaidTrackingList.aspx", "ipp=y&pageid=" & strPageId) & """><span>Paid Invoice</span></a></li>" & _
                                                "<li><div class=""space""></div></li>" & _
