<%@ Page Language="vb" AutoEventWireup="false" Codebehind="adddept.aspx.vb" Inherits="eProcure.adddeptFTN" %>
				...
				<TR>
					<TD vAlign="middle" align="left">
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td colSpan="2"><asp:datagrid id="dtgAO" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="dtgAO_Page">
										<Columns>
