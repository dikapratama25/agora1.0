...
Public Class BIMBatchUploadFTN
...
#End Region
                    ...
                    If CheckCurVer(strVersion) = True Then
                        If Not ds Is Nothing Then
                            ...
                            If ViewState("GSTCOD") = True Then
                                ...
                                dg.DataBind()
                                tr_dg.Style("style") = ""
                                tr_dg2.Style("style") = "none"
                            Else
                                dg2.DataSource = ds.Tables(0)
                                dg2.DataBind()
                                tr_dg2.Style("style") = ""
                                tr_dg.Style("style") = "none"
                            End If
    ...
    Public Function ActionValidation(ByRef row As DataRow, ByVal a As myCollection, Optional ByVal pstrConnStr As String = Nothing) As Boolean
        ...
        'For Each row As DataRow In ds.Tables(0).Rows '.Select(sSelect, "", DataViewRowState.CurrentRows)
        Dim objExProduct As New ExcelBIMProduct
    ...
    Private Function UpdateProduct(ByRef pds As DataSet, ByVal pRules As myCollection)
        ...
        For Each drItem In pds.Tables(0).Rows
            ...
            'Stage 3 Bug fix (GST-0028) - 13/07/2015 - CH
    ...
    Private Function bindProduct(ByRef pProdDetails As ExcelBIMProduct) As DataSet
        ...
        dtr("AccCode") = Common.parseNull(pProdDetails.AccCode)
        dtr("UOM") = Common.Parse(pProdDetails.UOM)
        dtr("CatCode") = "" 'Common.Parse(pProdDetails.Category)
    ...
    Private Function GetProductDetails(ByVal iRow As Integer, ByVal pdr As DataRow) As ExcelBIMProduct
        Dim objExcel As New ExcelBIMProduct
        ...
        With objExcel
            ...
            objExcel.RefNo = IIf(IsDBNull(pdr.Item("F8")), "", pdr.Item("F8"))
            objExcel.QC = IIf(IsDBNull(pdr.Item("F9")), "", pdr.Item("F9"))
            objExcel.AccCode = IIf(IsDBNull(pdr.Item("F10")), "", pdr.Item("F10"))
            objExcel.OrderQtyMin = IIf(IsDBNull(pdr.Item("F11")), 0, pdr.Item("F11"))
            objExcel.OrderQtyMax = IIf(IsDBNull(pdr.Item("F12")), 0, pdr.Item("F12"))
            objExcel.SafetyLevelMin = IIf(IsDBNull(pdr.Item("F13")), 0, pdr.Item("F13"))
            objExcel.MaxInvQty = IIf(IsDBNull(pdr.Item("F14")), 0, pdr.Item("F14"))
            objExcel.Brand = IIf(IsDBNull(pdr.Item("F15")), "", pdr.Item("F15"))
            objExcel.ManuName = IIf(IsDBNull(pdr.Item("F16")), "", pdr.Item("F16"))
            objExcel.DrawingNo = IIf(IsDBNull(pdr.Item("F17")), "", pdr.Item("F17"))
            objExcel.Model = IIf(IsDBNull(pdr.Item("F18")), "", pdr.Item("F18"))
            objExcel.GrossWeight = IIf(IsDBNull(pdr.Item("F19")), "", pdr.Item("F19"))
            objExcel.NetWeight = IIf(IsDBNull(pdr.Item("F20")), "", pdr.Item("F20"))
            objExcel.Length = IIf(IsDBNull(pdr.Item("F21")), "", pdr.Item("F21"))
            objExcel.VerNo = IIf(IsDBNull(pdr.Item("F22")), "", pdr.Item("F22"))
            objExcel.PackSpec = IIf(IsDBNull(pdr.Item("F23")), "", pdr.Item("F23"))
            objExcel.Width = IIf(IsDBNull(pdr.Item("F24")), "", pdr.Item("F24"))
            objExcel.ColorInfo = IIf(IsDBNull(pdr.Item("F25")), "", pdr.Item("F25"))
            objExcel.Volume = IIf(IsDBNull(pdr.Item("F26")), "", pdr.Item("F26"))
            objExcel.HSCode = IIf(IsDBNull(pdr.Item("F27")), "", pdr.Item("F27"))
            objExcel.Height = IIf(IsDBNull(pdr.Item("F28")), "", pdr.Item("F28"))
            objExcel.Remarks = IIf(IsDBNull(pdr.Item("F29")), "", pdr.Item("F29"))
            objExcel.PreferredVen = IIf(IsDBNull(pdr.Item("F30")), "", pdr.Item("F30"))
            objExcel.Ven1st = IIf(IsDBNull(pdr.Item("F31")), "", pdr.Item("F31"))
            objExcel.Ven2nd = IIf(IsDBNull(pdr.Item("F32")), "", pdr.Item("F32"))
            objExcel.Ven3rd = IIf(IsDBNull(pdr.Item("F33")), "", pdr.Item("F33"))
            If ViewState("GSTCOD") = True Then
                objExcel.PreferredVenGST = ""
                objExcel.Ven1stGST = ""
                objExcel.Ven2ndGST = ""
                objExcel.Ven3rdGST = ""
                objExcel.PreferredVenLead = IIf(IsDBNull(pdr.Item("F34")), "", pdr.Item("F34"))
                objExcel.Ven1stLead = IIf(IsDBNull(pdr.Item("F35")), "", pdr.Item("F35"))
                objExcel.Ven2ndLead = IIf(IsDBNull(pdr.Item("F36")), "", pdr.Item("F36"))
                objExcel.Ven3rdLead = IIf(IsDBNull(pdr.Item("F37")), "", pdr.Item("F37"))
                objExcel.PreferredVenItemCode = IIf(IsDBNull(pdr.Item("F38")), "", pdr.Item("F38"))
                objExcel.Ven1stItemCode = IIf(IsDBNull(pdr.Item("F39")), "", pdr.Item("F39"))
                objExcel.Ven2ndItemCode = IIf(IsDBNull(pdr.Item("F40")), "", pdr.Item("F40"))
                objExcel.Ven3rdItemCode = IIf(IsDBNull(pdr.Item("F41")), "", pdr.Item("F41"))
                objExcel.Action = IIf(IsDBNull(pdr.Item("F42")), "", pdr.Item("F42"))
            Else
                objExcel.PreferredVenGST = IIf(IsDBNull(pdr.Item("F34")), "", pdr.Item("F34"))
                objExcel.Ven1stGST = IIf(IsDBNull(pdr.Item("F35")), "", pdr.Item("F35"))
                objExcel.Ven2ndGST = IIf(IsDBNull(pdr.Item("F36")), "", pdr.Item("F36"))
                objExcel.Ven3rdGST = IIf(IsDBNull(pdr.Item("F37")), "", pdr.Item("F37"))
                objExcel.PreferredVenLead = IIf(IsDBNull(pdr.Item("F38")), "", pdr.Item("F38"))
                objExcel.Ven1stLead = IIf(IsDBNull(pdr.Item("F39")), "", pdr.Item("F39"))
                objExcel.Ven2ndLead = IIf(IsDBNull(pdr.Item("F40")), "", pdr.Item("F40"))
                objExcel.Ven3rdLead = IIf(IsDBNull(pdr.Item("F41")), "", pdr.Item("F41"))
                objExcel.PreferredVenItemCode = IIf(IsDBNull(pdr.Item("F42")), "", pdr.Item("F42"))
                objExcel.Ven1stItemCode = IIf(IsDBNull(pdr.Item("F43")), "", pdr.Item("F43"))
                objExcel.Ven2ndItemCode = IIf(IsDBNull(pdr.Item("F44")), "", pdr.Item("F44"))
                objExcel.Ven3rdItemCode = IIf(IsDBNull(pdr.Item("F45")), "", pdr.Item("F45"))
                objExcel.Action = IIf(IsDBNull(pdr.Item("F46")), "", pdr.Item("F46"))
            End If
        End With
        Return objExcel
        'End If
    ...
    Private Sub cmdDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownload.Click
        ...
        ds = pro.Download_ProductExcel(Session("CompanyId"))
        objEx.Writecell(ds, strDestPath & strFileName)
        objEx.ProtectWorkSheet_ItemUpload(strDestPath & strFileName, , False)
