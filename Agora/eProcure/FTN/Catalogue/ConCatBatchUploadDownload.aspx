<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConCatBatchUploadDownload.aspx.vb" Inherits="eProcure.ConCatBatchUploadDownloadFTN" %>
					...
					<td class="emptycol" colspan="2">
					    <asp:datagrid id="dg" Runat="server">
							<Columns>
								...
								<asp:BoundColumn DataField="F7" HeaderText="GST Rate (%)">
									<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="F8" HeaderText="GST Tax Code">
									<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
								</asp:BoundColumn>
