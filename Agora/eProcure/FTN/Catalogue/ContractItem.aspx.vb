...
#End Region
    ...
    Private Sub dtgCatalogue_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgCatalogue.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            If Common.parseNull(e.Item.Cells(EnumCat.iGST).Text) = "" Or e.Item.Cells(EnumCat.iGST).Text = "&nbsp;" Then
            Else
                e.Item.Cells(EnumCat.iGST).Text = Format(CDbl(e.Item.Cells(EnumCat.iGST).Text), "##0")
            End If
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        For Each dgItem In dtgCatalogue.Items
            ...
            If chkItem.Checked Then
                ...
                'dtr("ProductCode") = dgItem.Cells(8).Text
                dtr("ProductCode") = dgItem.Cells(10).Text 'Jules
