...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InventoryReqList.aspx.vb" Inherits="eProcure.InventoryReqListFTN" %>
...
<body class="body" MS_POSITIONING="GridLayout">
    ...
    <%  Response.Write(Session("w_InventoryReq_tabs"))%>
        <TABLE class="alltable" id="Tab1" cellspacing="0" cellpadding="0" width="100%">
            ...
            <Columns>
            <asp:TemplateColumn SortExpression="IT_TRANS_REF_NO" HeaderText="IR Number" >
				<ItemTemplate>
					<asp:HyperLink Runat="server" ID="lnkCode"></asp:HyperLink>
				</ItemTemplate>
			</asp:TemplateColumn>
								
            <asp:BoundColumn SortExpression="IT_TRANS_DATE" DataField="IT_TRANS_DATE" HeaderText="IR Date" DataFormatString="&quot;dd/mm/yyyy&quot;"></asp:BoundColumn>
            <asp:BoundColumn SortExpression="IT_ADDITION_INFO" DataField="IT_ADDITION_INFO" HeaderText="Issue To"></asp:BoundColumn>
            <asp:BoundColumn SortExpression="IT_ADDITION_INFO1" DataField="IT_ADDITION_INFO1" HeaderText="Department"></asp:BoundColumn>
