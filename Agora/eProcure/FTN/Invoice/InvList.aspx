<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvList.aspx.vb" Inherits="eProcure.InvList1" %>
							...
							<tr>
								...
								<asp:datagrid id="dtg_InvList" runat="server" CssClass="grid" AutoGenerateColumns="False" OnSortCommand="SortCommand_Click"
										...
										<Columns>
											...
											<asp:BoundColumn SortExpression="POM_BILLING_METHOD" HeaderText="Invoice On" Visible="False">
											...
											<asp:BoundColumn Visible="False" DataField="CDM_GRN_NO"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="CDM_DO_No"></asp:BoundColumn>
