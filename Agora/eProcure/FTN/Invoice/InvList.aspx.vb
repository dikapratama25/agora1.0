...
#End Region
            ...
            For Each dgitem In Me.dtg_InvList.Items
                ...
                If chk.Checked Then
                    ...
                    Else
                        ...
                        strGRNNo = Replace(dgitem.Cells(EnumInvList.IcGRNV).Text, "&nbsp;", "")
                        strDONo = Replace(dgitem.Cells(EnumInvList.icDOV).Text, "&nbsp;", "")
                    End If
    ...
    Private Sub Submit()
        ...
        Dim txt_remark, txt_ShipAmt As TextBox
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Common.parseNull(dv("POM_BILLING_METHOD")) = "GRN" Then
                ...
                If objinv.get_invInfo(objval) Then
                    ...
                    e.Item.Cells(EnumInvList.icGRN).Text = "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewGRN.aspx", "pageid=" & strPageId & "&GRNNo=" & Common.parseNull(dv("CDM_GRN_NO")) & "&PONo=" & Common.parseNull(dv("POM_PO_NO")) & "&DONo=" & Common.parseNull(dv("CDM_DO_No")) & "&side=v&BCoyID=" & Common.parseNull(dv("POM_B_COY_ID"))) & "')""><font color=#0000ff>" & _
                        Common.parseNull(dv("CDM_GRN_NO")) & "</font></A> Invoiced Created On " & objval.create_on & ""
                ...
                e.Item.Cells(EnumInvList.icDO).Text = "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewDO.aspx", "pageid=" & strPageId & "&DONO=" & dv("CDM_DO_No") & "&SCoyID=" & Session("CompanyID") & "&PO_NO=" & dv("POM_PO_NO")) & "')"" ><font color=#0000ff>" & Common.parseNull(dv("CDM_DO_No")) & "</font></A>"

                'If Not IsDBNull(objinv.get_grnprice(dv("POM_PO_NO"), dv("POM_B_COY_ID"), dv("POM_PO_INDEX"), Common.parseNull(dv("CDM_GRN_NO")))) Then
                e.Item.Cells(EnumInvList.icRemainAmt).Text = Format(objinv.get_grnprice(dv("POM_PO_NO"), dv("POM_B_COY_ID"), dv("POM_PO_INDEX"), Common.parseNull(dv("CDM_GRN_NO"))), "#,##0.00")
            ...
            ElseIf Common.parseNull(dv("POM_BILLING_METHOD")) = "DO" Then
                If objinv.get_invInfo(objval) Then
                    ...
                    e.Item.Cells(EnumInvList.icDO).Text = "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewDO.aspx", "pageid=" & strPageId & "&DONO=" & dv("CDM_DO_No") & "&SCoyID=" & Session("CompanyID") & "&PO_NO=" & dv("POM_PO_NO")) & "')"" ><font color=#0000ff>" & Common.parseNull(dv("CDM_DO_No")) & "</font></A></A>  Invoiced Created On " & objval.create_on & ""
                ...
                e.Item.Cells(EnumInvList.icRemainAmt).Text = Format(objinv.get_DOprice(Common.parseNull(dv("CDM_DO_No")), dv("POM_B_COY_ID"), dv("POM_PO_INDEX")), "#,##0.00")
                e.Item.Cells(EnumInvList.icDOV).Text = Common.parseNull(dv("CDM_DO_No"))
            End If
    ...
    Private Sub dtg_inv2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_inv2.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Common.parseNull(dv("bill_meth")) = "GRN" Then
                ...
                e.Item.Cells(EnumInv2.icDoc).Text = "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewPO.aspx", "pageid=" & strPageId & "&PO_No=" & Common.parseNull(dv("po_no")) & "&BCoyID=" & dv("POM_B_COY_ID") & "&side=v')""") & "  ><font color=#0000ff>" & dv("po_no") & "</font></A><br>" & _
                                        "<A href=""#"" onclick=""PopWindow('" & dDispatcher.direct("Report", "PreviewDO.aspx", "pageid=" & strPageId & "&DONo=" & dv("do_no") & "&SCoyID=" & Session("CompanyID") & "&PO_NO=" & dv("po_no")) & "')"" ><font color=#0000ff>" & dv("do_no") & "</font></A><br>" & _
            ...
            If dblShip < 0 Then txtShip.Text = 0
    ...
    Private Sub dtg_inv2_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dtg_inv2.ItemCommand
        If e.CommandName = "Select" Then
            ...
            Dim strBillMethod, strDocNo, strBillDoc, strShipAmt As String
            ...
            Response.Redirect(dDispatcher.direct("Invoice", "InvDetail.aspx", "pageid=" & strPageId & "&bill_meth=" & strBillMethod & "&doc=" & strDocNo & "&bcomid=" & e.Item.Cells(EnumInv2.icCoyId).Text & "&billdoc=" & Server.UrlEncode(strBillDoc) & "&shipamt=" & strShipAmt & "&poidx=" & e.Item.Cells(EnumInv2.icPoIdx).Text))
