...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            dsApprovalList = objPR.getAppovalList("A", CDbl(ViewState("pocost")), "PO", False)
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        ...
        If cboApproval.SelectedItem.Value <> "" Then
            ...
            intMsg = objPO.submitPO(ViewState("poid"), dtAO, , True, False)
            Select Case intMsg
                ...
                Case WheelMsgNum.Save
                    ...
                    If Session("urlreferer") = "RFQComSummary" Then
                        Common.NetMsgbox(Me, "Purchase Order Number " & ViewState("poid") & " has been submitted.", Session("urlrefererForRFQ"))
                    ElseIf Request.QueryString("Frm") = "Dashboard" Then
                        Common.NetMsgbox(Me, "Purchase Order Number " & ViewState("poid") & " has been submitted.", dDispatcher.direct("Dashboard", Request.QueryString("dpage") & ".aspx", "type=tab&pageid=" & strPageId))
                    ElseIf Session("urlreferer") = "BuyerCatalogueSearch" Then
                        Common.NetMsgbox(Me, "Purchase Order Number " & ViewState("poid") & " has been submitted.", dDispatcher.direct("Search", Session("urlreferer") & ".aspx", "type=tab&pageid=" & strPageId))
                    ElseIf Session("urlreferer") = "ConCatSearch" Then
                        Common.NetMsgbox(Me, "Purchase Order Number " & ViewState("poid") & " has been submitted.", dDispatcher.direct("Search", "ContractCatSearch.aspx", "pageid=" & strPageId))
                    Else
                        Common.NetMsgbox(Me, "Purchase Order Number " & ViewState("poid") & " has been submitted.", dDispatcher.direct("PO", Session("urlreferer") & ".aspx", "type=tab&pageid=" & strPageId))
