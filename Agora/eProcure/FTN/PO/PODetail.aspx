<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PODetail.aspx.vb" Inherits="eProcure.PODetailFTN" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <%  Response.Write(Session("w_PODetail_tabs"))%>
			...
			<TABLE class="alltable" id="Table13" cellSpacing="0" cellPadding="0" border="0" runat="server">
				...
				<TR vAlign="top">
				    <TD class="tablecol"><STRONG>&nbsp;<asp:label id="lblExtRemark" text="External Remarks" runat="server"></asp:label></STRONG> :</TD>
				    <TD class="tableinput" vAlign="top" colSpan="3">&nbsp;<asp:label id="lblRemarks" runat="server"></asp:label></TD>
				    <TD class="tableinput"></TD>
				</TR>
				<TR vAlign="top">
				...
				<TR>
					<TD><asp:datagrid id="dtg_POList" runat="server" OnSortCommand="SortCommand_Click" OnPageIndexChanged="dtg_POList_Page"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="POD_TAX_VALUE" SortExpression="POD_TAX_VALUE" HeaderText="GST Amount">
									<HeaderStyle HorizontalAlign="right" Width="8%"></HeaderStyle>
									<ItemStyle HorizontalAlign="right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="POD_GST_INPUT_TAX_CODE" SortExpression="POD_GST_INPUT_TAX_CODE" HeaderText="GST Tax Code (Purchase)">
