...
#Region " Web Form Designer Generated Code "
    ...
    Public Enum EnumPOList
        ...
        icGstRate = 5
        icGstAmt = 6
        icGstTaxCode = 7 'Stage 3 Enhancement (GST-0010) - 22/07/2015 - CH
        icExtDate = 8 '4
        icMPQ = 9 '5
        icWaranty = 10 '6
        icOrderQty = 11 '7
...
#End Region
        ...
        If Not IsPostBack Then
            ...
            Select Case Session("side")
                Case "otherv", "other", "others"
                    ...
                    'Stage 3 (Enhancement) (GST-0006) - 22/07/2015 - CH
            ...
            Me.lblShipTo.Text = Replace(objpo.get_delivery_add_multiline(Request(Trim("BCoyID")), Request(Trim("PO_No")), False), "<BR>", "<BR>&nbsp;") & "<BR>&nbsp;" 'Replace(objval.buyer_adds, "<BR>", "<BR>&nbsp;")
            ...
            Me.lblRemarks.Text = objval.remarks
    ...
    Private Function Bindgrid(ByVal dgid As DataGrid, ByVal turn As String, Optional ByVal pSorted As Boolean = False) As String
        ...
        Else
            ...
            Me.dtg_apprflow.Columns(2).Visible = False
        End If
        ...
        'Me.dtg_POList.Columns(5).Visible = False
        'Me.dtg_POList.Columns(6).Visible = False
        Me.dtg_POList.Columns(EnumPOList.icMPQ).Visible = False
        Me.dtg_POList.Columns(EnumPOList.icWaranty).Visible = False

        If strCaller = "POVIEWB" Then
            'Me.dtg_POList.Columns(9).Visible = False
            'Me.dtg_POList.Columns(10).Visible = False
    ...
    Private Sub dtg_POList_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtg_POList.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Session("side") = "v" Or Session("side") = "otherv" Then
                ...
                If objGST.chkGSTCOD And objGST.chkGST <> "" Then
                    e.Item.Cells(EnumPOList.icPOLine).Text = "<A href=""" & dDispatcher.direct("PO", "POLineListing.aspx", "pageid=" & strPageId & "&lineval=" & e.Item.Cells(0).Text & "&PO_NO=" & dv("POD_PO_NO") & "&po_line=" & dv("POD_PO_LINE") & "&side=v&GST=1&BCoyID=" & Request(Trim("BCoyID") & "")) & " "" ><font color=#0000ff>" & e.Item.Cells(0).Text & "</font></A>"
                Else
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If Common.parseNull(dv("DOM_DO_NO")) <> "" Then
                ...
                If Session("side") = "b" Or Session("side") = "others" Or Session("side") = "u" Or (Session("side") = "other" And Request.QueryString("caller") = "buyer") Or (Session("side") = "other" And Request.QueryString("caller") = "") Then
                    ...
                    'e.Item.Cells(EnumDoc.icDONo).Text = "<A href=""#"" onclick=""PopWindow('../DO/DODetails.aspx?caller=buyer&poidx=" & Session("po_index") & "&pageid=" & strPageId & "&DONO=" & dv("DOM_DO_NO") & "&SCoyID=" & dv("DOM_S_COY_ID") & "')"" ><font color=#0000ff>" & Common.parseNull(dv("DOM_DO_NO")) & "</font></A>"
    ...
    Private Sub cmd_ack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_ack.Click
        ...
        strsql = objpo.update_ack(ds, False)
        cmd_ack.Visible = False
    ...
    Sub setControlProp(ByVal strType As String)
        ...
        ElseIf strType = "1" Then 'PO CR Detail
            ...
            Me.hiddiv.Style("display") = "inline"
