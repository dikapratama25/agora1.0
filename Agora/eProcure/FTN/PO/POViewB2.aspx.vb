...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objPO.VIEW_POList(strStatus, strFulfilment, "b", Me.txt_vendor.Text, Me.txt_po_no.Text, Me.txt_startdate.Text, Me.txt_enddate.Text)
        'End If
            ...
            Case Else
                ...
                If IsBA = True Then 'Buyer Admin fixed role
                    strStatus = POStatus_new.Accepted & "," & POStatus_new.Approved & "," & POStatus_new.Cancelled & "," & POStatus_new.CancelledBy & "," & POStatus_new.Close & "," & _
                                ...
                                POStatus_new.RejectedBy & "," & POStatus_new.Submitted & "," & POStatus_new.Void
