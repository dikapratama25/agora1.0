...
#End Region
    ...
    Private Sub renderPRHeader()
        ...
        If dtHeader.Rows.Count > 0 Then
            ...
            lblInternalRemark.Text = Common.parseNull(dtHeader.Rows(0)("PRM_INTERNAL_REMARK"), "nil")
            ...
            lblPRRemark.Text = Common.parseNull(dtHeader.Rows(0)("PRM_External_Remark"), "nil")
    ...
    Private Sub renderPRApprFlow()
        Dim objPR As New PurchaseReq2
        ds = objPR.getApprFlow(ViewState("PRIndex"))
        objPR = Nothing
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        If Session("Env") = "FTN" Then
            Me.dtgPRList.Columns(3).Visible = False
            Me.dtgPRList.Columns(4).Visible = False
            Me.dtgPRList.Columns(5).Visible = False
            Me.dtgPRList.Columns(19).Visible = False
        Else
            Me.dtgPRList.Columns(3).Visible = True
            Me.dtgPRList.Columns(4).Visible = True
            Me.dtgPRList.Columns(5).Visible = True
            Me.dtgPRList.Columns(19).Visible = True
        End If
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        Else
            ...
            objPR = Nothing
            Common.NetMsgbox(Me, strMsg, dDispatcher.direct("PO", "SearchPR_All.aspx", "caller=BUYER&pageid=" & strPageId), MsgBoxStyle.Exclamation)
        End If
    End Sub
    ...
    Private Sub cmdDup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDup.Click
        ...
        If checkMandatory(strMsg1) Then
            strMsg = objPR.DuplicatePR(lblPR.Text, ViewState("PRIndex"))
            If strMsg <> "" Then
                Common.NetMsgbox(Me, strMsg, dDispatcher.direct("PO", "SearchPR_All.aspx", "caller=BUYER&pageid=" & strPageId), MsgBoxStyle.Exclamation)
