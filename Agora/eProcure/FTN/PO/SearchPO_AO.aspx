<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchPO_AO.aspx.vb" Inherits="eProcure.SearchPO_AOFTN" %>
 		...
 		<%  Response.Write(Session("w_SearchPOAO_tabs"))%>
              <TABLE class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0" width="100%">
				<TR id="tdAO" style="VISIBILITY: visible" runat="server">
					<TD class="emptycol"><STRONG>&nbsp;Approve/Endorse By</STRONG>&nbsp;:&nbsp;
						<asp:dropdownlist id="cboAO" Width="200px" Runat="server" CssClass="ddl" AutoPostBack="True"></asp:dropdownlist></TD>
				</TR>
				<TR>
				...
				<tr>
							...
							<TR>
								<TD class="tablecol" width="15%" >&nbsp;<STRONG><asp:Label ID="Label11" runat="server" Text="PO No. :"></asp:Label></STRONG></TD>
							...
							<TR>
								<TD><asp:datagrid id="dtgPOList" runat="server" OnSortCommand="SortCommand_Click" DataKeyField="POM_PO_INDEX">
										<Columns>
											...
											<asp:BoundColumn DataField="POM_STATUS_CHANGED_ON" SortExpression="POM_STATUS_CHANGED_ON" HeaderText="Submitted Date">
												<HeaderStyle Width="15%"></HeaderStyle>
