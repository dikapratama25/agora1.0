...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        ds = objPO.getPOListForApproval(txtPONo.Text, txtVendor.Text, txtDateFr.Text, txtDateTo.Text, strReliefOn, , POStatus_new.Submitted)
    ...
    Private Sub cmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        ...
        ViewState("SortExpression") = "POM_STATUS_CHANGED_ON"
        Bindgrid(True)
    End Sub
    ...
    Private Sub dtgPOList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPOList.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            e.Item.Cells(EnumPO.icSubmitDate).Text = Common.FormatWheelDate(WheelDateFormat.LongDate, dv("POM_STATUS_CHANGED_ON"))
