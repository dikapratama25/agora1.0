...
#End Region
    ...
    Private Function Bindgrid(Optional ByVal pSorted As Boolean = False) As String
        ...
        'If strCaller = "AO" Then
        ds = objPO.getPOListForApproval(txtPONo.Text, txtVendor.Text, txtDateFr.Text, txtDateTo.Text, "", "app", "", strAOAction, strInclude)
        'ElseIf strCaller = "BUYER" Then
    ...
    Private Sub GenerateTab()
        ...
        "<li><div class=""space""></div></li>" & _
                     ...
                     "<li><div class=""space""></div></li>" & _
                     "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("PO", "SearchPO_AO.aspx", "pageid=" & strPageId) & """><span>Approved / Rejected Listing</span></a></li>" & _
                     "<li><div class=""space""></div></li>" & _
                     "</ul><div></div></div>"
    End Sub
End Class
