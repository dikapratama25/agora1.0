<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConvertPR.aspx.vb" Inherits="eProcure.ConvertPRFTN" %>
		...
		<form id="Form1" method="post" runat="server">
 		<%  Response.Write(Session("w_ConvertPR_tabs"))%>
            ...
            <TR>
	            ...
	            <TD class="TableCol" colspan="5" style="width: 30%"><asp:textbox id="txtCommodity" runat="server" CssClass="txtbox"></asp:textbox><input type="hidden" id="hidCommodity" runat="server" />
            ...
            <tr>
                ...
                <TD	 class="tablecol"><asp:textbox id="txtDateFr" runat="server" Width="80px" CssClass="txtbox" contentEditable="false" ></asp:textbox><A onclick="popCalendar('txtDateFr');" href="javascript:;"><%Response.Write(CalPicture) %></td>
                ...
                <TD	 class="tablecol"><asp:textbox id="txtDateTo" runat="server" Width="80px" CssClass="txtbox" contentEditable="false" ></asp:textbox><A onclick="popCalendar('txtDateTo');" href="javascript:;"><%Response.Write(CalPicture) %></A>
