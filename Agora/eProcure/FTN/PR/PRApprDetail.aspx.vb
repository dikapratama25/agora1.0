...
#End Region
    ...
    Private Sub renderPRHeader()
        ...
        If dtHeader.Rows.Count > 0 Then
            ...
            If objGST.chkGSTCOD() And dtHeader.Rows(0)("PRM_CREATED_DATE") >= CDate(strGSTCOD) Then
    ...
    Sub AddRow(ByVal intCell As Integer, ByVal strLabel As String, ByVal dblTotal As Double, ByVal blnShowGST As Boolean)
        ...
        row.Cells(1).ColumnSpan = intCell - 2
    ...
    Private Sub dtgPRList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPRList.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            Dim objGST As New GST
            'If Common.parseNull(dv("PRD_GST_RATE")) = "N/A" Then
            '    e.Item.Cells(EnumPR.icGSTRate).Text = "N/A"
            'Else
            '    e.Item.Cells(EnumPR.icGSTRate).Text = objGST.getGSTRateDescriptionbyRate(Common.parseNull(dv("PRD_GST_RATE"), 0))
            'End If
            If Common.parseNull(dv("GST_RATE")) <> "" Then
                e.Item.Cells(EnumPR.icGSTRate).Text = dv("GST_RATE")
            Else
                e.Item.Cells(EnumPR.icGSTRate).Text = "N/A"
            End If
    ...
    Private Sub cmdAppPR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAppPR.Click
        ...
        End If
        If chk = True Then
            strMsg = objPR.ApprovePR(Session("lblPRNo"), ViewState("PRIndex"), ViewState("CurrentAppSeq"), ViewState("ISHighestLevel"), ViewState("Consolidator"), strRemark, ViewState("Requestor"), Request.QueryString("relief"), ViewState("ApprType"), "", "APP")
