...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf Session("urlreferer") = "POViewB2" Then 'PO screen
        ...
        ElseIf Session("urlreferer") = "POViewB2Cancel" Then 'PO screen
            cmdDup.Visible = False
            cmdCancel.Visible = False
            lblRemarkCR.Visible = False
            txtRemarkCR.Visible = False
        ...
        If dtHeader.Rows.Count > 0 Then
            ...
            If Session("urlreferer") = "PRAll" Then
                ...
                Select Case Common.parseNull(dtHeader.Rows(0)("STATUS_DESC"))
                    ...
                    Case "Submitted", "Pending Approval", "Held By"
            ...
            If Not IsDBNull(dtHeader.Rows(0)("PRM_SUBMIT_DATE")) Then
                ...
                If dtHeader.Rows(0)("PRM_SUBMIT_DATE") <= CDate(System.Configuration.ConfigurationManager.AppSettings.Get("GstCutOffDate")) Then
                    blnGST = False
                End If
            Else
                'lblPRDate.Text = "nil"
            ...
            If blnGST = True And Not IsDBNull(dtHeader.Rows(0)("PRM_PR_DATE")) Then
    ...
    Private Sub dtgPRList_ItemCreated(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPRList.ItemCreated
        If e.Item.ItemType = ListItemType.Header Then
            ...
            Else
                e.Item.Cells(EnumPR.icTax).Text = "Tax"
            End If
        End If
    ...
    Private Sub dtgPRList_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgPRList.ItemDataBound
        ...
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If strPRType = "CC" Then  'Contract Catalogue PR
                ...
                End If
                Dim objGST As New GST
                'e.Item.Cells(EnumPR.icGSTRAte).Text = Common.parseNull(dv("PRD_GST_RATE"), "N/A")
            Else
            ...
            e.Item.Cells(EnumPR.icGSTRAte).Text = Common.parseNull(dv("GST_RATE"), "N/A")
    ...
    Private Sub GenerateTab()
        ...
        ElseIf Session("urlreferer") = "POViewB2Cancel" Then
            Session("w_SearchPR_tabs") = "<div class=""t_entity""><ul>" & _
                                        "<li><div class=""space""></div></li>" & _
