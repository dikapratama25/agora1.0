<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PRDetailTransTracking.aspx.vb" Inherits="eProcure.PRDetailTransTrackingFTN" %>
				    ...
				    <table class="alltable" id="Table12" border="0" width="100%" cellSpacing="0" cellPadding="0" >
				        <TR>
							...
							<Columns>
								...
								<%--Jules 2014.0.30 GST Enhancement--%>
								...
								<%--Jules 2014.0.30 GST Enhancement end--%>
