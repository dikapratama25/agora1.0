<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RaisePR.aspx.vb" Inherits="eProcure.RaisePRFTN" %>
						...
						<TD class="tablecol" vAlign="middle" align="left">
							<TABLE class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0">
								...
								<TR vAlign="top">
									...
									<TD class="tablecol" width="25%" colSpan="2"><asp:textbox id="txtAttention" runat="server" CssClass="txtbox" Width="200px" MaxLength="50"></asp:textbox></TD>
								</TR>
								<TR vAlign="top">
								...
								<TR vAlign="top">
									...
									<TD class="tablecol" width="25%"><asp:textbox id="txtInternal" runat="server" CssClass="listtxtbox" Width="100%" MaxLength="1000"
											Rows="2" TextMode="MultiLine"></asp:textbox></TD>
									<TD class="tablecol">&nbsp;<strong>External Remarks</strong>&nbsp;:</TD>
									<TD class="tablecol" width="25%" colSpan="2"><asp:textbox id="txtExternal" runat="server" CssClass="listtxtbox" Width="100%" MaxLength="1000"
											Rows="2" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								
								<TR vAlign="top">
									<TD class="tablecol" style="HEIGHT: 17px">&nbsp;<STRONG>External Attachment</STRONG>&nbsp;:</TD>
									<TD class="tablecol" style="HEIGHT: 22px" width="25%" colSpan="5" rowSpan="2"><INPUT class="button" id="File1" style="WIDTH: 222px; HEIGHT: 18px" type="file" size="17"
								...
								<TR vAlign="top" id = "Extra1" runat="server" >
									<TD class="tablecol" colSpan="4">&nbsp;If you do not want "Custom Fields" or 
			...
			<table class="alltable" id="Table3" cellSpacing="0" cellPadding="0" border="0">
				<tr>
					<td class="emptycol"><asp:datagrid id="dtgShopping" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="dtgShopping_Page"
							...
							<Columns>
								...
								<%--Jules 2014.07.21 GST Enhancement begin--%>							
                                ...
                                <asp:TemplateColumn SortExpression="GST" HeaderText="GST Amount">
									...
									<ItemTemplate>
										...
										<asp:TextBox id="txtGSTAmt" CssClass="numerictxtbox" Runat="server"  readonly="true"  Width="45px" >0.00</asp:TextBox>
								...
								<%--Jules 2014.07.21 GST Enhancement end--%>
				...
				<tr><td class="emptycol" style="width:100%;"><div style="float:right;">
				    <table>
				        ...
				        <tr id="trGSTAmt" runat="Server"><td class="emptycol" style="text-align:right; font-weight:bold; color:Black;"><asp:Label id="lblTax" runat="server"></asp:Label> :</td><td class="emptycol"><div id="sTax" name="sTax" style="text-align:right; color:Black;" >0.00</div></td></tr>
				        <tr><td class="emptycol" colspan="2"><hr /></td></tr>
