<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchPR_All.aspx.vb" Inherits="eProcure.SearchPR_AllFTN" %>
					...
					<td class="emptycol">
						<TABLE class="alltable" id="Table4" cellSpacing="0" cellPadding="0" border="0">
							...
							<tr class="tablecol">
								...
								<td width="15%"><asp:checkbox id="chkSource" Text="Sourcing" Runat="server"></asp:checkbox></td>
