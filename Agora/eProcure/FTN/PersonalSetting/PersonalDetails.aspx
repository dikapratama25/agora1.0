<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PersonalDetails.aspx.vb" Inherits="eProcure.PersonalDetailsFTN" %>
			...
			<tr>
				...
				<tr class="tablecol">
					...
					<td><asp:textbox id="txtPhone" runat="server" Width="210px" CssClass="txtbox" MaxLength="50"></asp:textbox>&nbsp;
						<asp:regularexpressionvalidator id="revPhone" runat="server" ControlToValidate="txtPhone" ErrorMessage="Invalid Phone."
							Display="None" ValidationExpression="^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$"></asp:regularexpressionvalidator></td>
				</tr>
				<tr class="tablecol">
				...
				<tr vAlign="top">
					<td class="emptycol" colspan="2"><INPUT class="txtbox" id="hidDeptID" style="WIDTH: 43px; HEIGHT: 18px" type="hidden" size="1"
							...
							name="hidPOAppLimit" runat="server"><INPUT class="txtbox" id="hidPOAppLimit" style="WIDTH: 43px; HEIGHT: 18px" type="hidden"
