...
#End Region
    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.cmdView.Attributes.Add("onclick", "PopWindow('" & dDispatcher.direct("Report", "PreviewQuotation.aspx", "SCoyID=" & ViewState("VCoyID") & "&BCoyID=" & ViewState("BCoyID") & "&quo_no=" & ViewState("QuoNo") & "&rfq_no=" & ViewState("RFQNo")) & "')")
    End Sub
    ...
    Sub AddRow(ByVal intCell As Integer, ByVal strLabel As String, ByVal check As Boolean)
        ...
        If strLabel = "Sub Total" Then
            ...
            txtTotal.Width = System.Web.UI.WebControls.Unit.Pixel(80)
        ...
        ElseIf strLabel = "GST Amount" Or strLabel = "Tax" Then
            If check = True Then
                ...
                txtTax.Width = System.Web.UI.WebControls.Unit.Pixel(80)
        ...
        ElseIf strLabel = "Grand Total" Then
            ...
            txtGrandTotal.Width = System.Web.UI.WebControls.Unit.Pixel(80)
    ...
    Private Function Bindgrid(Optional ByVal pPage As Integer = -1, Optional ByVal pSorted As Boolean = False) As String
        ...
        '    Me.dg_viewitem.Columns(11).Visible = False
        'Else
        '    Me.dg_viewitem.Columns(11).Visible = True
        'End If

        If Not blnGST Then
            Me.dg_viewitem.Columns(7).Visible = False
        End If
        Me.dg_viewitem.Columns(12).Visible = False
    End Function
    ...
    Private Sub dg_viewitem_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dg_viewitem.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            objGST.getGSTInfobyRate(Common.parseNull(dv("RRD_GST_RATE")), strGSTPerc, strGSTID)
            Dim j As Decimal = 0
            If strGSTPerc <> "" Then
                Dim i As Integer = CType(strGSTPerc, Integer)
            ...
            Else
                lbl_tax.Text = Format(0, "###,###,##0.00")
            End If

            Dim lbl_GSTRate As Label
            lbl_GSTRate = e.Item.FindControl("lbl_GSTRate")
            lbl_GSTRate.Text = dv("GSTRATE") 'objGST.getGSTRateDescriptionbyRate(dv("RRD_GST_RATE"))        
    ...
    Private Sub GenerateTab()
        ...
        If strFrm = "RFQ_Quote" Then
            ...
            "<li><div class=""space""></div></li>" &
                             ...
                             "<li><div class=""space""></div></li>" &
                             "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("RFQ", "RFQ_Quote.aspx", "pageid=" & strPageId) & """><span>Quotation</span></a></li>" &
                             "<li><div class=""space""></div></li>" &
                             "</ul><div></div></div>"
        Else
            Session("w_RFQ_tabs") = "<div class=""t_entity""><ul>" &
            "<li><div class=""space""></div></li>" &
                                       ...
                                       "<li><div class=""space""></div></li>" &
                                        "<li><a class=""t_entity_btn"" href=""" & dDispatcher.direct("RFQ", "VendorRFQListExp.aspx", "pageid=" & strPageId) & """><span>Expired RFQ</span></a></li>" &
                                        "<li><div class=""space""></div></li>" &
                                       "<li><a class=""t_entity_btn_selected"" href=""" & dDispatcher.direct("RFQ", "RFQSearch.aspx", "pageid=" & strPageId) & """><span>Quotation Listing</span></a></li>" &
                                       "<li><div class=""space""></div></li>" &
                                       "</ul><div></div></div><br/>"
        End If
