...
Public Class PreviewInvoice1FTN
    ...
    Private Sub PreviewInvoice()
        ...
        Try
            ...
            strSQL = "SELECT IM_GST_INVOICE FROM INVOICE_MSTR WHERE IM_INVOICE_NO = '" & Common.Parse(Request.QueryString("INVNO")) & "' " & _
            ...
            If strTaxInv = "Y" Then
                localreport.ReportPath = dispatcher.direct("Report", "PreviewTaxINVOICE-FTN_ftn.rdlc", "FTNReport") ' appPath & "Invoice\PreviewINVOICE-FTN.rdlc"                
            Else
                localreport.ReportPath = dispatcher.direct("Report", "PreviewINVOICE-FTN_ftn.rdlc", "FTNReport")
            End If
            'localreport.ReportPath = dispatcher.direct("Report", "PreviewINVOICE-FTN_ftn.rdlc", "FTNReport")
