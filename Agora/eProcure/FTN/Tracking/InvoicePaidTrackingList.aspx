<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvoicePaidTrackingList.aspx.vb" Inherits="eProcure.InvoicePaidTrackingListFTN" %>
    ...
    <%  Response.Write(Session("w_InvTracking_tabs"))%>
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">				
				...
				<TR class="tablecol">
					...
					<TD><asp:button id="cmdSearch" runat="server" CssClass="button" Text="Search"></asp:button>&nbsp;<INPUT class="button" id="Button2" onclick="Reset();" type="button" value="Clear" name="cmdClear"></TD>
				</TR>				
