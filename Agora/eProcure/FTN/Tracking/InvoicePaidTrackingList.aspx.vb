...
Partial Public Class InvoicePaidTrackingListFTN
    ...
    Private Function bindInv(ByVal strType As String, ByVal blnSend As Boolean, ByVal blnFMMassAppr As Boolean)
        ...
        For Each dtr In dtItem.Rows
            If strType = "2" Or strType = "3" Or strType = "4" Then
                ...
                Dim strMsg As String = objTrac.ApproveInvoice(Common.Parse(dtr("InvNo")), Common.Parse(dtr("Vendor")), IIf(strType = "2", "FO", "FM"), dtr("FinRemark"), False, blnHighestLevel, False)
