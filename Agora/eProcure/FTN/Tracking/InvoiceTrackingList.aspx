<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvoiceTrackingList.aspx.vb" Inherits="eProcure.InvoiceTrackingListFTN" %>
			...
			<table class="alltable" id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
				    <td colspan="5">
					    ...
					    Text="Fill in the search criteria and click Search button to list the relevant new Invoice. Select the invoice and click the Verify button to submit for approval."
					    ></asp:label>
				...
				<tr class="tablecol">
					...
					<td align="left" colspan="2" style="height: 23px"><asp:dropdownlist id="cboFolder" runat="server" CssClass="txtbox" AutoPostBack="True" Visible="False"></asp:dropdownlist></td>
				...
				<tr>
					<td class="emptycol" colspan="5"><asp:datagrid id="dtgInvoice" runat="server" OnSortCommand="SortCommand_Click">
							<Columns>
							    ...
							    <asp:BoundColumn Visible="False" HeaderText="GST Inv" DataField="IM_GST_INVOICE"></asp:BoundColumn>
							</Columns>
						</asp:datagrid></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="emptycol" colspan="4">
						...
						<asp:button id="cmdApprove" runat="server" Width="96px" CssClass="button" Text="Approve"
							CausesValidation="False"></asp:button>
