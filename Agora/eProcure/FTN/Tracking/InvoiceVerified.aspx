<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvoiceVerified.aspx.vb" Inherits="eProcure.InvoiceVerifiedFTN" %>
			...
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="emptycol" colSpan="4">
						...
						<asp:button id="cmdMark" runat="server" Width="80px" CssClass="button" Text="Original Mark As Paid" CausesValidation="False"></asp:button>
