<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchBItem.aspx.vb" Inherits="eProcure.SearchBItemSEH" %>
	...
	<body class="body">
		...
		<%  Response.Write(Session("w_BIM_tabs"))%>
			...
			<table class="alltable" id="Table2" cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<tr class="tablecol">
 					<td class="tablecol"  nowrap>
                        <strong>&nbsp;<asp:Label ID="Label5" runat="server" Text=" Vendor Code : "></asp:Label></strong></td>
					<td class="tablecol" nowrap><asp:textbox id="txtVenCode" width="100%" runat="server" CssClass="txtbox" ></asp:textbox></td>
					<td class="tablecol" colspan="2" nowrap style="height: 20px;">
					</td>
					<td class="tablecol" align="right"></td>
				</tr>
