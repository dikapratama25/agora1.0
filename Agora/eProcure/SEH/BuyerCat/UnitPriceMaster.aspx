<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UnitPriceMaster.aspx.vb" Inherits="eProcure.UnitPriceMasterSEH" %>
...
<html>
	...
	<body class="body">
		<form id="Form1" method="post" runat="server">
			...
			<tr>
				<td class="tablecol" colspan="4" style="height: 19px; border:0; width:20%;" ><strong><asp:label id="lblItem" runat="server">Selected Vendor:</asp:label></strong>&nbsp;
				<asp:label id="lblVendor" runat="server"></asp:label><asp:Label ID="hidVendor" runat="server" Visible="false"></asp:Label>
				<asp:Label ID="hidvline" runat="server" Visible="false"></asp:Label></td>						
			</tr>
			<tr>
