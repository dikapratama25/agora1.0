<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AddContractItem.aspx.vb" Inherits="eProcure.AddContractItem_SEH" %>
					...
					<td class="emptycol" colspan="5">
					    <asp:datagrid id="dtgCatalogue" runat="server" AutoGenerateColumns="False" OnSortCommand="SortCommand_Click">
							<Columns>
								...
								<asp:TemplateColumn HeaderText="GST Tax Code">
