<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InvTransHistory.aspx.vb" Inherits="eProcure.InvTransHistorySEH" %>
	...
	<body class="body" MS_POSITIONING="GridLayout">
        ...
        <%  Response.Write(Session("w_User_tabs"))%>
			<table class="alltable" id="Table1" cellSpacing="0" cellPadding="0" width="50%">          	
			    ...
			    <TR class="tablecol">
				    <TD class="TableCol" style="height: 19px" width="20%"><strong><asp:Label ID="Label1" runat="server" Text="Item Code :" CssClass="lbl"></asp:Label></strong></TD>
				    <TD class="TableCol"  width="30%" style="height: 19px"><asp:Label ID="lblItemCode" runat="server" CssClass="lbl" Font-Bold="false"></asp:Label></TD>

				    <TD class="TableCol" style="height: 19px" width="20%"><strong><asp:Label ID="Label2" runat="server" Text="Item Name :" CssClass="lbl"></asp:Label></strong></TD>
				    <TD class="TableCol" width="30%" style="height: 19px"><asp:Label ID="lblItemName" runat="server" CssClass="lbl" Font-Bold="false"></asp:Label></TD>
			    </TR>
			    <TR class="tablecol">
                ...
                <tr class="tablecol">
                    <td class="TableCol" style="height: 18px" width="20%"><strong><asp:Label ID="Label7" runat="server" CssClass="lbl" Text="Lot No :"></asp:Label></td>
                    <td class="TableCol" width="30%"><asp:Label ID="lblLotNo" runat="server" CssClass="lbl" Font-Bold="False"></asp:Label></td>
