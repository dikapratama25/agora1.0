<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InventoryListing.aspx.vb" Inherits="eProcure.InventoryListingSEH" %>
	...
	<body class="body">
		...
		<%  Response.Write(Session("w_SearchInvListing_tabs"))%>
			...
			<tr class="tablecol">
				...
				<td class="TableCol" style="height: 18px; width: 236px;"><asp:dropdownlist id="ddl_Loc" runat="server" Width="180px" style="margin-bottom:1px;" CssClass="ddl" AutoPostBack="True"></asp:dropdownlist></td>
				<td class="TableCol" style="height: 18px" ></td>
                ...
                <td class="TableCol" style="height: 18px"><asp:dropdownlist id="ddl_SubLoc" runat="server" Width="180px" style="margin-bottom:1px;" CssClass="ddl" AutoPostBack="True"></asp:dropdownlist></td>				
				<td class="TableCol" style="height: 18px"></td>
			</tr>	
                <tr class="tablecol">
                <td class="TableCol" style="height: 18px"><strong><asp:Label ID="lblLot" runat="server" CssClass="lbl" Text="Lot No:"></asp:Label></td>     
                <td class="TableCol" style="height: 18px; width: 236px;"><asp:dropdownlist id="ddl_lot" runat="server" Width="180px" style="margin-bottom:1px;" CssClass="ddl" AutoPostBack="True"></asp:dropdownlist></td>
			...
			<tr class="tablecol">
				...
				<td class="TableCol" style="height: 18px; width: 236px;">
				    <asp:RadioButtonList ID="optSort" runat="server" BorderStyle="None" CssClass="rbtn" RepeatDirection="Horizontal" Width="264px">
                        <asp:ListItem Selected="True" Value="IM_ITEM_CODE">Item Code</asp:ListItem>
                        <asp:ListItem Value="LM_LOCATION">Location</asp:ListItem>
                        <asp:ListItem Value="DOL_LOT_NO">Lot No</asp:ListItem>
                    </asp:RadioButtonList>				    
			    </td>
					...
					<td class="EmptyCol" colspan="6" style="height: 152px">
					    <asp:datagrid id="dtgInv" runat="server" AutoGenerateColumns="False" OnSortCommand="SortCommand_Click">
					        <Columns>	
                                ...
                                <asp:BoundColumn HeaderText="Lot No" DataField="dol_Lot_no" SortExpression="dol_Lot_no">
                                    <HeaderStyle HorizontalAlign="Right" Width="10%"></HeaderStyle>
							        <ItemStyle HorizontalAlign="Left"></ItemStyle>
							        </asp:BoundColumn>
						        <asp:BoundColumn DataField="IL_LOT_QTY" HeaderText="Lot Qty" SortExpression="IL_lot_qty">
							        <HeaderStyle HorizontalAlign="Right" Width="10%"></HeaderStyle>
							        <ItemStyle HorizontalAlign="Right"></ItemStyle>
						        </asp:BoundColumn>
						        <asp:BoundColumn HeaderText="Ongoing Qty" SortExpression="IL_IQC_QTY">
							        <HeaderStyle HorizontalAlign="Right" Width="10%"></HeaderStyle>
							        <ItemStyle HorizontalAlign="Right"></ItemStyle>
						        </asp:BoundColumn>									      							        
						        ...
						        <asp:BoundColumn Visible="False" DataField="IM_IQC_IND"></asp:BoundColumn>
					        </Columns>
				        </asp:datagrid></td>
				</tr>
				<tr>
