<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExceedBCMPO.aspx.vb" Inherits="eProcure.ExceedBCMPOSEH" %>
	...
	<body onload="" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD class="emptycol" colSpan="2"><font size="1"><asp:Label id="lblRemarkHeader" runat="server"></asp:Label></font></TD>
				</TR>
				<TR>
