    ...
    Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If Not blnExceed Then
                ...
                Response.Redirect(dDispatcher.direct("PO", "POApprovalSetup.aspx", "msg=0&pageid=" & strPageId & "&poid=" & ViewState("poid") & "&pocost=" & dblPoCost & "&dept=" & strDept_Code & "&prindex=" & strPR_Index & "&currency=" & ViewState("currency") & "&Frm=" & Request.QueryString("Frm")))
            Else
                If strBCM = "2" Then ' advisory mode
                    ...
                    Response.Redirect(dDispatcher.direct("PO", "POApprovalSetup.aspx", "msg=1&pageid=" & strPageId & "&poid=" & ViewState("poid") & "&pocost=" & dblPoCost & "&dept=" & strDept_Code & "&prindex=" & strPR_Index & "&currency=" & ViewState("currency") & "&Frm=" & Request.QueryString("Frm")))
                Else ' absolute mode
                    Dim objPR As New PR
