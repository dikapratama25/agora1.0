<%@ Page Language="vb" AutoEventWireup="false" Codebehind="POApprDetail.aspx.vb" Inherits="eProcure.POApprDetail_SEH" %>
...
//		        }
				...
				<td class="linespacing2" colspan="4"></td>
						...
						<table class="alltable" id="Table4" cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<tr valign="top">
								...
								<td class="Tableinput"><asp:label id="lblBillAddr" Runat="server"></asp:label></td>
								<td class="tablecol"></td>
								<td class="tablecol" >&nbsp;<strong><asp:Label ID="lbl_DT" runat="server" Text="Delivery Term :"></asp:Label></strong></td>
								<td class="Tableinput" ><asp:label id="lblDelTerm" Runat="server"></asp:label></td>
							</tr>
							<tr valign="top">
								<td class="tablecol" valign="top" >&nbsp;<strong>Internal Remarks</strong>&nbsp;:</td>
								<td class="Tableinput"><asp:label id="lblInternalRemark"  Runat="server"></asp:label></td>
								<td class="tablecol"></td>
								<td class="tablecol" >&nbsp;<strong><asp:Label ID="lbl_VC" runat="server" Text="Vendor Code :"></asp:Label></strong></td>
								<td class="Tableinput"><asp:label id="lblVenCode" Runat="server"></asp:label></td>
							</tr>
							<tr valign="top">
								...
								<td class="Tableinput" ><asp:label id="lblCurrency" Runat="server"></asp:label></td>
							</tr>
							<tr valign="top">
								<td class="tablecol" valign="top" >&nbsp;<strong>External Remarks</strong>&nbsp;:</td>
								<td class="Tableinput" colspan="4"><asp:label id="lblPORemark" Runat="server"></asp:label></td>
							</tr>
	...
	<tr>
			...
			<table class="AllTable" id="tblSearchResult" cellspacing="0" cellpadding="0" border="0"
				...
				<tr>
					<td><asp:datagrid id="dtgPOListStk" runat="server" AutoGenerateColumns="False">
							<Columns>
								<asp:BoundColumn DataField="POD_PO_LINE" HeaderText="Line">
									<HeaderStyle HorizontalAlign="Right" Width="3%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								...
								<asp:BoundColumn HeaderText="Lead Time (Days)">
									<HeaderStyle HorizontalAlign="right" Width="8%"></HeaderStyle>
									<ItemStyle HorizontalAlign="right"></ItemStyle>
								</asp:BoundColumn>
					...
					<td>
						<table class="AllTable" id="tblApproval" cellspacing="0" cellpadding="0" border="0" runat="server">
							...
							<tr>
					            ...
					            <td rowspan="2" width= "85%" ><asp:textbox id="txtRemark" width="500px" runat="server" CssClass="txtbox" MaxLength="3000" Height="37px" Rows="2" TextMode="MultiLine" ></asp:textbox></td>
				            </tr>
