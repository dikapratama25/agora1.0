<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConvertPR.aspx.vb" Inherits="eProcure.ConvertPR_SEH" %>
							...
							<tr>
								<td class="EmptyCol" colspan="5"><asp:datagrid id="dtgPRList" runat="server" OnSortCommand="SortCommand_Click">
										<Columns>
											...
											<asp:BoundColumn DataField="PRD_ITEM_TYPE" Visible="false" HeaderText="Item Type">
											</asp:BoundColumn>
											<asp:BoundColumn DataField="PM_OVERSEA" Visible="false" HeaderText="Oversea">
											</asp:BoundColumn>
											<asp:BoundColumn DataField="PRD_SOURCE" Visible="false" HeaderText="Source">
											</asp:BoundColumn>
											<asp:BoundColumn DataField="PRD_DEL_CODE" Visible="false" HeaderText="Delivery Term">
											</asp:BoundColumn>
