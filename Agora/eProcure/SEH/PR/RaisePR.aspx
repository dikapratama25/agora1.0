<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RaisePR.aspx.vb" Inherits="eProcure.RaisePRSEH" %>
						...
						<TD class="tablecol" vAlign="middle" align="left">
							<TABLE class="alltable" id="Table2" cellSpacing="0" cellPadding="0" border="0">
								...
								<TR vAlign="top">
									...
									<td class="tablecol">&nbsp;<strong>Currency</strong><asp:label id="Label7" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:</td>
									<td class="tablecol"><asp:dropdownlist id="cboCurr" runat="server" CssClass="ddl" AutoPostBack="True">
									    </asp:dropdownlist><asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server" Enabled="False" ControlToValidate="cboPayMethod" ErrorMessage="Payment Method is required " Display="None"></asp:requiredfieldvalidator></td>
								...
								<TR vAlign="top">
									...
									<TD class="tablecol"><asp:dropdownlist id="cboPayTerm" Width="96%" runat="server" CssClass="ddl" ></asp:dropdownlist>
									    <asp:requiredfieldvalidator id="revPaymentTerm" runat="server" Enabled="False" ControlToValidate="cboPayTerm" ErrorMessage="Payment Term is required " Display="None"></asp:requiredfieldvalidator></TD>
					                <TD class="tablecol">&nbsp;<strong>Payment&nbsp;Method</strong><asp:label id="Label3" runat="server" CssClass="errormsg">*</asp:label>&nbsp;:</TD>
									<TD class="tablecol"><asp:dropdownlist id="cboPayMethod" runat="server" CssClass="ddl" ></asp:dropdownlist>
									    <asp:requiredfieldvalidator id="revPaymentMethod" runat="server" Enabled="False" ControlToValidate="cboPayMethod" ErrorMessage="Payment Method is required " Display="None"></asp:requiredfieldvalidator></TD>
								    <TD class="tablecol" width="25%" ></TD>
								</TR>
								<TR vAlign="top">
									<TD class="tablecol">
									...
									<TD class="tablecol" width="25%" colSpan="2"><asp:textbox id="txtExternal" runat="server" CssClass="listtxtbox" Width="67%" MaxLength="1000"
											Rows="2" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
			...
			<table class="alltable" id="Table3" cellSpacing="0" cellPadding="0" border="0">
				<tr>
					<td class="emptycol"><asp:datagrid id="dtgShopping" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="dtgShopping_Page"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Delivery Term">
								    <HeaderStyle Width="15%"></HeaderStyle>
								    <ItemTemplate>
								        <asp:DropDownList id="ddlDelivery" runat="server" CssClass="ddl" Width="180px">
								        </asp:DropDownList>
								    </ItemTemplate>
								</asp:TemplateColumn>
				...
				<tr><td class="emptycol" style="width:100%;"><div style="float:right;">
				    <table>
				        ...
				        <tr><td id="GSTLabel" runat="server" class="emptycol" style="text-align:right; font-weight:bold; color:Black;">GST Amount :</td><td class="emptycol"><div id="sTax" name="sTax" style="text-align:right; color:Black;" >0.00</div></td></tr>
