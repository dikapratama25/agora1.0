...
Public Class PreviewStockCountSEH
    ...
    Private Sub PreviewStockCountList()
        ...
        Try
            ...
            With cmd
                ...
                .CommandText = "SELECT ID_INVENTORY_INDEX, IM_ITEM_CODE, IM_INVENTORY_NAME, SUM(IL_LOT_QTY) AS IL_LOT_QTY, DOL_LOT_NO, " _
                ...
                If Request.QueryString("SubLoc") <> "---Select---" Then
                    If Request.QueryString("SubLoc") = "" Then
                        .CommandText = .CommandText & " AND LM_SUB_LOCATION IS NULL"
                    Else
                        .CommandText = .CommandText & " AND LM_SUB_LOCATION ='" & Common.Parse(Request.QueryString("SubLoc")) & "'"
                    End If
                End If

                If Request.QueryString("Lot") <> "" And Request.QueryString("Lot") <> "---Select---" Then
                    .CommandText = .CommandText & " AND DOL_LOT_NO ='" & Common.Parse(Request.QueryString("Lot")) & "'"
                End If
                ...
                .CommandText = .CommandText & " GROUP BY ID_INVENTORY_INDEX, IM_ITEM_CODE, IM_INVENTORY_NAME, ID_LOCATION_INDEX, DOL_LOT_NO "
            ...
            Dim rptDataSource As New Microsoft.Reporting.WebForms.ReportDataSource("PreviewStockCounts_DataSetInventoryList", ds.Tables(0))
            Dim localreport As New LocalReport
            localreport.DataSources.Clear()
            localreport.DataSources.Add(rptDataSource)
            localreport.ReportPath = dispatcher.direct("Report", "PreviewInvStockCounts.rdlc", "Report") ' appPath & "DO\PreveiwDO-FTN.rdlc"
