<%@ Page Language="vb" AutoEventWireup="false" Codebehind="usUser.aspx.vb" Inherits="eProcure.usUserVen" %>
        ...
        <%  Response.Write(Session("w_User_tabs"))%>
			...
			<table class="alltable" id="Table3" cellSpacing="0" cellPadding="0" border="0">
				<tr class="tablecol" id="trMassAppr" runat="server" visible="false">
					...
					<TD>
					    <asp:checkbox id="chkMassAppr" Runat="server"></asp:checkbox>
					    <asp:Label id="lbl1" runat="server" Text="Mass Approval authorise approving officer to approve more than one PR/PO at a time"></asp:label><br />
					    <asp:checkbox id="chkInvMassAppr" Runat="server"></asp:checkbox>
					    <asp:Label id="lbl2" runat="server" Text="Mass Approval authorise approving officer to approve more than one Invoice at a time"></asp:label>
					</td>
					<td></td>
				</tr>
				<tr class="tablecol">
