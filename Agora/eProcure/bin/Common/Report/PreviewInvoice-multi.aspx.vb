...
Public Class PreviewInvoice1Multi
        ...
        Try
            ...
            With cmd
                ...
                .CommandText = "SELECT   INVOICE_DETAILS.ID_INVOICE_NO, INVOICE_DETAILS.ID_S_COY_ID, INVOICE_DETAILS.ID_INVOICE_LINE, " _
                            ...
                            & "(SELECT IFNULL(CONCAT(CDT_DEL_CODE, ' (', CDT_DEL_NAME, ')'),'') FROM COMPANY_DELIVERY_TERM WHERE CDT_DEL_CODE=PO_MSTR.POM_DEL_CODE AND CDT_COY_ID=PO_MSTR.POM_B_COY_ID) AS DeliveryTerm, " _
                            & "(SELECT   CODE_DESC " _
                            ...
                            & "(SELECT CAST(GROUP_CONCAT(ID_GST_RATE) AS CHAR(1000)) AS SSTType FROM invoice_details AS c WHERE id_invoice_no = INVOICE_MSTR.IM_INVOICE_NO AND id_s_coy_id IN ('vr1307','paper','paper')) AS SSTType " _
                            ...
                            & "WHERE   CONCAT(INVOICE_MSTR.IM_S_COY_ID,INVOICE_MSTR.IM_INVOICE_NO) IN (" & strVenInvNo & ") AND (INVOICE_MSTR.IM_B_COY_ID = @prmBCoyID) " _
                            & "ORDER BY INVOICE_MSTR.IM_S_COY_NAME ASC "
            End With
            ...
            localreport.ReportPath = dispatcher.direct("Report", "PreviewINVOICE-FTN-multi-SST.rdlc", "Report") ' appPath & "Invoice\PreviewINVOICE-FTN.rdlc"
