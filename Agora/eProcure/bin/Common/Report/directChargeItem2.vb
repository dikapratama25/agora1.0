...
Public Class directChargeItem2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eProcure.directChargeItem2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddirectChargeItem2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As directChargeItem2 = New directChargeItem2()
        rpt.Site = Me.Site
        Return rpt
    End Function
