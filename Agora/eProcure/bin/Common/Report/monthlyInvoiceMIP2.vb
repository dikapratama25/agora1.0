...
Public Class monthlyInvoiceMIP2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eProcure.monthlyInvoiceMIP2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmonthlyInvoiceMIP2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As monthlyInvoiceMIP2 = New monthlyInvoiceMIP2()
        rpt.Site = Me.Site
        Return rpt
    End Function
