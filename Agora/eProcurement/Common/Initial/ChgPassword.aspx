<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ChgPassword.aspx.vb" Inherits="eProcurement.ChgPassword" %>
		...
		<form id="form1" method="post" runat="server">
			<TABLE class="alltable" id="Table1" cellSpacing="0" cellPadding="0" border="0">
				...
				<tr>
					...
					<TD class="tableinput">&nbsp;
						<asp:textbox id="txtUserID" runat="server" CssClass="txtbox" Width="160px" Enabled="False" MaxLength="20"></asp:textbox></TD>
				</tr>
				<tr>
					<TD class="tablecol"><STRONG>&nbsp;<asp:Label id="lblPasswordType" runat="server"></asp:Label>
							Password</STRONG><span class="errormsg">*</span>&nbsp;:</TD>
					<TD class="tableinput">&nbsp;
			...
			<div id="tblQA" style="DISPLAY: none" runat="server"><br>
				<TABLE class="alltable" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<tr class="tablecol">
						...
						<TD class="tableinput">&nbsp;
							<asp:dropdownlist id="cboQuestion" runat="server" CssClass="txtbox" Width="250px"></asp:dropdownlist></TD>
					</tr>
					<tr class="tablecol">
