...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btClick As System.Web.UI.HtmlControls.HtmlInputButton
...
#End Region
    ...
    Private Sub btClick_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btClick.ServerClick
    ...
    Public Function ValidateFields(ByRef pErrMsg As String) As Boolean
        ...
        '    pErrMsg = pErrMsg & "<LI type=square>Challenge phrase is required."
        '    bTrue = False
        'End If
        ...
        If bTrue Then 'only check Database if all required field is filled in.
            ...
            Else 'If txtUserId.Text = "" Then
                If objUserDetails.Email = "" Then
                    ...
                    bTrue = False
                ElseIf UCase(objUserDetails.Email) <> UCase(txtEmail.Text) Then
                ...
                '    pErrMsg = pErrMsg & "<LI type=square>Incorrect answer for challenge phase."
                '    bTrue = False
                'End If
            End If
        End If
