...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lnkForgotPwd As System.Web.UI.WebControls.HyperLink
    Protected WithEvents lblMsg As System.Web.UI.WebControls.Label
    Protected WithEvents cmdOk As System.Web.UI.WebControls.ImageButton
    Protected WithEvents cmdClear As System.Web.UI.WebControls.ImageButton
    Protected WithEvents marq As System.Web.UI.HtmlControls.HtmlGenericControl
    Protected WithEvents lnkBrowser As System.Web.UI.WebControls.HyperLink
    Protected WithEvents lnkpubNotice As System.Web.UI.WebControls.HyperLink
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            marq.InnerText = "Kompakar eBiz Sdn Bhd © 2004 - " & Now.Year & " All Rights Reserved (.NET Version) . Best View with 1024 x 768 Resolution and Microsoft IE 6.0 SP1."
            marq.Style.Add("div", "background:transparent;font-family:Verdana,Arial,Helvetica,sans-serif;font-size:7.5pt;")
    ...
    Private Sub cmdClear_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles cmdClear.Click
        txtCompID.Text = ""
        txtUserID.Text = ""
        txtPassword.Text = ""
        lblMsg.Text = ""
    ...
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles cmdOk.Click
        ...
        If Page.IsValid = True And bError = False Then
            ...
            Else
                If sUser_ID <> "" Then
                    ...
                    Response.Redirect("default.aspx") 'tnc
                Else
