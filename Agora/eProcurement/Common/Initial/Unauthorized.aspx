<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Unauthorized.aspx.vb" Inherits="eProcurement.Unauthorized" %>
	...
	<BODY>
		<center>
			...
			<h4><FONT color="#000000">This Will Occur Because Of Either One Of The Following 
					Reason.</FONT></h4>
			<div>
				<FONT color="#000000">Your Session Login Has Expired. </FONT></div>
			<div>
